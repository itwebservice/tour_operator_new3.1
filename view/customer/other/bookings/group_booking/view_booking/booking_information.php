...
$sq_tour_name = mysqlQuery("select tour_name from tour_master where tour_id='$tour_id'");
$row_tour_name = mysqli_fetch_assoc($sq_tour_name);
$tour_name = $row_tour_name['tour_name'];

$sq_tour_group_name = mysqlQuery("select from_date,to_date from tour_groups where group_id='$tour_group_id'");

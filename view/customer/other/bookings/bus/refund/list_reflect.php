			...
			<table class="table table-bordered cust_table" id="tbl_refund_list" style="margin:20px 0 !important;">
				...
				<tbody>
					...
					while ($row_refund = mysqli_fetch_assoc($sq_refund)) {
						...
						$sq_entries = mysqli_fetch_assoc(mysqlQuery("select * from bus_booking_entries where booking_id='$row_refund[booking_id]'"));

						$v_voucher_no = get_bus_booking_refund_id($row_refund['refund_id'], $year);

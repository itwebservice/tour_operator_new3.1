			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<span class="main_block">
						...
						<?php
						$total_amount = currency_conversion($currency, $sq_visa_info['currency_code'], (float)($sq_visa_info['visa_total_cost']) + (float)($query['sumc']));
						?>
				...
				<table id="tbl_dynamic_visa_update" name="tbl_dynamic_visa_update" class="table table-bordered no-marg">
					...
					<tbody>
						...
						?>
								...
								<script>
									$("#birth_date<?= $offset . $count ?>_d, #expiry_date<?= $offset ?>1").datetimepicker({
										timepicker: false,
										format: 'd-m-Y'
									});
								</script>

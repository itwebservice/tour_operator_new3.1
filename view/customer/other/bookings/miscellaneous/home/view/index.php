...
$sq_paid_amount = mysqli_fetch_assoc(mysqlQuery("SELECT sum(payment_amount) as sum,sum(credit_charges) as sumc from miscellaneous_payment_master where misc_id='$sq_visa_info[misc_id]' and clearance_status!='Pending' and clearance_status!='Cancelled'"));

            ...
            <div class="row">
                <div class="panel-body text-center main_block">
                    ...
                    <label for="rd_id_proof" class="app_dual_button">
                        <input type="radio" id="rd_id_proof" name="rd_package_booking" onchange="package_booking_content_reflect()">
                        &nbsp;&nbsp;ID Proof
                    </label>
                </div>
            </div>
...
<script>
    function package_booking_content_reflect() {
        ...
        if (id == "rd_id_proof") {
            $.post('bookings/package_booking/id_proof/index.php', {}, function(data) {
                $('#div_package_booking_content').html(data);
            });
        }
    }

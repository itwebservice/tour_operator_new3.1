...
<div class="row">
	<div class="col-md-3">
		<select id="booking_idp1" name="booking_idp1" onchange="refund_list_reflect();" required style="width: 100%"> 
			...
			<?php 
				$sq_booking = mysqlQuery("select booking_id,booking_date,customer_id from package_tour_booking_master where booking_id in ( select booking_id from package_travelers_details where status='Cancel') and customer_id='$customer_id' and delete_status='0'");

			...
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<?php $sq_t_count = mysqli_num_rows(mysqlQuery("select * from package_train_master where booking_id='$booking_id' ")); 
						$sq_f_count = mysqli_num_rows(mysqlQuery("select * from package_plane_master where booking_id='$booking_id' ")); 
						$sq_c_count = mysqli_num_rows(mysqlQuery("select * from package_cruise_master where booking_id='$booking_id' ")); 

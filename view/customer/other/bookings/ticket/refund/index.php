		...
		<div class="row">
			<div class="col-md-3">
				<select name="ticket_id" id="ticket_id" style="width:100%" onchange="refund_report_reflect()">
			        ...
			        <?php 
			        $sq_ticket = mysqlQuery("select * from ticket_master where customer_id='$customer_id' and ticket_id in ( select ticket_id from ticket_master_entries where status='Cancel') and delete_status='0' order by ticket_id desc");

...
//Paid
$query = mysqli_fetch_assoc(mysqlQuery("SELECT sum(payment_amount) as sum,sum(credit_charges) as sumc from ticket_payment_master where ticket_id='$ticket_id' and clearance_status != 'Pending' and clearance_status != 'Cancelled'"));
$charge = $query['sumc'];

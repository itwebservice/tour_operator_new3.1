		...
		<div class="row">
			<div class="col-md-3">
				<select name="booking_id" id="booking_id" style="width:100%" onchange="refund_report_reflect()">
			        ...
			        <?php 
			        $sq_hotel = mysqlQuery("select * from hotel_booking_master where customer_id='$customer_id' and  booking_id in ( select booking_id from hotel_booking_entries where status='Cancel') and delete_status='0' order by booking_id desc");

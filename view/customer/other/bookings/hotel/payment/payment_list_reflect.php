...
<table class="table table-bordered table-hover bg_white cust_table" id="tbl_payment_list" style="margin:20px 0 !important;">
	...
	<tbody>
		...
		$sq_cancel_amount=0;
		$sq_paid_amount=0;
		$Total_payment=0; $total_paid = 0; $footer_cancel_total = 0; $footer_pending_total = 0;
		$bg;

...
<div class="header_bottom main_block">
    <div class="row mg_tp_10">
        <div class="col-md-12 text-right">
            <button class="btn btn-info btn-sm ico_left" id="addform_btn" onclick="save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Feedback</button> 
        </div>
    </div>
</div>
...
function save_modal()
{
    $('#addform_btn').prop('disabled',true);
    $('#addform_btn').button('loading');
    $.post('save_modal.php',{}, function(data){
        $('#div_modal').html(data);
        $('#addform_btn').prop('disabled',false);
        $('#addform_btn').button('reset');
    });
}

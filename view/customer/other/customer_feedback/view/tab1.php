            ...
            if($booking_type=="Group Booking"){ 
                ...
                $query =mysqli_fetch_assoc(mysqlQuery("select * from package_tour_booking_master where booking_id='$sq_feed[booking_id]' and delete_status='0'"));
                    ...
                    $yr = explode("-", $date);
                    $year = $yr[0];        
                    $booking_id = get_package_booking_id($sq_feed['booking_id'],$year);
                } ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd; min-height: 15px;">
            ...
            <span class="main_block">
                  ...
                  <?php echo "<label>Tour Type <em>:</em></label> ".$sq_feed['booking_type'].'('.$booking_id.')'; ?>
        ...
        <div class="col-md-6">
            <span class="main_block">
                  ...
                  <?php echo "<label>Tour Date <em>:</em></label> ".$tour_date; ?>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="profile_box main_block">
            ...
            <div class="row mg_tp_10 mg_bt_10">
              <div class="col-xs-12">
                <h5>3. Quality of Tranport Services</h5>
                <div class="col-xs-12">
            ...
            <div class="row mg_tp_10 mg_bt_10">
              <div class="col-xs-12">
                <h5>4. Quality of Accommodation Services?</h5>
                <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                  <div class="col-md-8 col-xs-12"><p>b) How would you rate your accommodations for Hygiene & Cleanliness?</p></div>
                  <div class="col-md-4 col-xs-12">
                    <h5 class="no-marg" style="margin-left: 10px !important;"><?= $sq_feed['hotel_clean'] ?></h5>
                  </div>
                </div>
                <div class="col-xs-12">
                  <div class="col-md-8 col-xs-12"><p>c) How was the quality & quantity of meal?</p></div>
                  <div class="col-md-4 col-xs-12">

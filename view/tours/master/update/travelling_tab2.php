        ...
        <div class="app_panel_content no-pad">
            ...
            <div class="row text-center mg_tp_20">
                <div class="col-md-12">
                    ...
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-info ico_right" id="btn_quotation_update">Next&nbsp;&nbsp;<i
        ...
        for (var i = 0; i < rowCount; i++) {
            ...
            if (row.cells[0].childNodes[0].checked) {
                ...
                if (plane_from_location1 == "") {
                    ...
                    $('.accordion_content').removeClass("indicator");
                    $('#tbl_package_tour_quotation_dynamic_plane_update').parent('div').closest(
                        '.accordion_content').addClass("indicator");
                    return false;
                }
        ...
        for (var i = 0; i < rowCount; i++) {
            ...
            if (row.cells[0].childNodes[0].checked) {
                ...
                if (route == "") {
                    ...
                    $('.accordion_content').removeClass("indicator");
                    $('#tbl_dynamic_cruise_update').parent('div').closest('.accordion_content').addClass(
                        "indicator");
                    return false;
                }

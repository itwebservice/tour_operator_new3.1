                                    ...
                                    <table style="width:100%" id="package_program_list" name="package_program_list"
                                        ...
                                        <tbody>
                                            ...
                                            if($sq_tours_count > 0){
                                                ...
                                                <td style="padding-left: 5px !important;"><input type="text" id="special_attaraction"  style="margin-top: 35px;" onchange="validate_spaces(this.id);" name="special_attaraction" class="form-control mg_bt_10" placeholder="Special Attraction" title="Special Attraction"></td>
                                                <td class="col-md-5 no-pad" style="padding-left: 5px !important;"><textarea id="day_program" name="day_program" style=" height:900px;" class="form-control mg_bt_10" title="Day-wise Program" rows="3" placeholder="*Day-wise Program" onchange="validate_spaces(this.id);"></textarea></td>
                                                <td class="col-md-1/2 no-pad" style="padding-left: 5px !important;"><input type="text" id="overnight_stay" style="margin-top: 35px;" name="overnight_stay" onchange="validate_spaces(this.id);" class="form-control mg_bt_10" placeholder="Overnight Stay" title="Overnight Stay"></td>
                                                <td class="col-md-1/2 no-pad" style="padding-left: 5px !important;"><select id="meal_plan" title="meal plan" style="margin-top: 35px;" name="meal_plan" class="form-control mg_bt_10" data-original-title="Meal Plan">
                                                        <?php get_mealplan_dropdown(); ?>
                                                        </select></td>
                                                <td class='col-md-1 pad_8'><button type="button" class="btn btn-info btn-iti btn-sm" style="margin-top: 35px;" id="itinerary<?php echo '1'; ?>" title="Add Itinerary" onClick="add_itinerary('dest_name2','special_attaraction','day_program','overnight_stay','Day-1')"><i class="fa fa-plus"></i></button>
                                                </td>
...
//     $(document).on("click", ".style_text_b, .style_text_u", function() {
//     // Get the wrapper (for bold or underline)
//     var wrapper = $(this).data("wrapper");
    
//     // Get the textarea element
//     var textarea = $(this).closest('td').find('.day_program')[0];  // Ensures we target the correct textarea
...
//     // Optional: Convert Markdown-style formatting to HTML outside the textarea (render it dynamically)
//     var text = textarea.value;
//     var content = text.replace(/\*\*(.*?)\*\*/g, '<b>$1</b>');  // Bold
//     content = content.replace(/__(.*?)__/g, '<u>$1</u>');  // Underline

//     // Show the formatted content somewhere else (e.g., in a preview area)
//     $('#formatted_preview').html(content);  // Make sure you have a div with id="formatted_preview"
// });

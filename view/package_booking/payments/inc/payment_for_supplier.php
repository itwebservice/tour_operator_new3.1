...
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="hotel_id" id="hotel_id" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="transport_agency_id" id="transport_agency_id" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id" id="vendor_id" title="Select Supplier" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="dmc_id" id="dmc_id" title="Select DMC" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id" id="vendor_id" title="Select Ticket Supplier" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id" id="vendor_id" title="Select Activity Supplier" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id" id="vendor_id" title="Select Insurance Supplier" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	...
	<select name="vendor_id" id="vendor_id" title="Select Other Supplier" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>
...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="cruise_id" id="cruise_id" style="width:100%" onchange="">
		<?php 
		if($vendor_type_id==""){
			?>

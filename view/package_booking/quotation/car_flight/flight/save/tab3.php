						...
						$('#vi_confirm_box').vi_confirm_box({
						    ...
						    callback: function(data1){
						        ...
						        if(data1=="yes"){
									...
									window.location.href = base_url+'view/package_booking/quotation/car_flight/flight/index.php';

	...
	<div class="row">
		<div class="col-md-6 mg_tp_10">
			<div class="profile_box main_block">
				...
				<div class="col-md-12">Price&nbsp; : <strong><?= number_format($gtoursprice_total,2) ?></strong></div>
				<div class="col-md-12">Tax&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <strong><?= number_format($gtourstax_total,2) ?></strong></div>
				<div class="col-md-12">Total&nbsp; : <strong><?= number_format($gtours_total,2) ?></strong></div>
			</div>
		</div>
	</div>
	<?php $grnd_total += $gtours_total; } ?>
	<?php
	$text = '';

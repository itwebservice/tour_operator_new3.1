...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="visa_id_dropdown_load(this.id,'visa_id_filter')" class="form-control" title="Customer" style="width:100%">

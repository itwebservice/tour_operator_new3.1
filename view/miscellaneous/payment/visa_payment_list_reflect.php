...
while($row_visa_payment = mysqli_fetch_assoc($sq_visa_payment)){
  ...
  $net_amt= $total_sale;
	...
	global $currency;
				...
				// currency conversion
			$currency_amount1 = currency_conversion($currency,$row_visa_payment['currency_code'],number_format($row_visa_payment['payment_amount']+$row_visa_payment['credit_charges'],2));
	if($row_visa_payment['currency_code'] !='0' && $currency != $row_visa_payment['currency_code']){
	...
	$temp_arr = array( "data" => array(
		...
		$payshow,
		number_format($row_visa_payment['payment_amount']+$row_visa_payment['credit_charges'],2).$currency_amount,

      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="payment_bank_old" name="payment_bank_old" value="<?= $sq_payment_info['bank_id'] ?>"> 
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs" style="margin-top:15px !important;">
                                <select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"  data-toggle="tooltip" required>
                                    <?php
                                    
                                

                                    if($sq_payment_info['currency_code'] ==''){
                                      $currency_code1 = $sq_visa['currency_code'];
                                    }
                                    else{
                                      $currency_code1= $sq_payment_info['currency_code'];
                                    }
...
$('#customer_id1, #visa_id1,#acurrency_code1').select2();

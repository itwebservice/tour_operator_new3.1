...
<form id="frm_basic_info">
	...
	<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
		...
		<div class="row mg_tp_20">
			...
			<div class="col-md-4">
				<input type="text" id="app_email_id" name="app_email_id" placeholder="Email ID" title="Email ID"
					value='<?= $sq_settings['app_email_id'] ?>' onchange="validate_email(this.id)">
				<small>Note : Please enter webmail Email ID. eg. info@example.com</small>
...
<script>
	...
	function img_delete(type) {
		...
		$.post('basic_info/remove_img.php', {
			type: type
		}, function(data) {

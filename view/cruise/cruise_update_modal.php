...
$sq_cruise_info = mysqli_fetch_assoc(mysqlQuery("select * from cruise_master where cruise_id='$cruise_id'"));
$vendor_name = addslashes($sq_cruise_info['company_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_cruise_info[mobile_no]' and vendor_type='Cruise Vendor'"));
...
<div class="modal fade" id="cruise_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
            <legend>Cruise Supplier Information</legend>
              ...
              <div class="row">                  
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <textarea type="text" id="cruise_address1" name="cruise_address1" class="form-control" placeholder="Address" onchange="validate_address(this.id);" rows="1"  title="Address"><?= $sq_cruise_info['cruise_address'] ?></textarea>
                  </div>
              </div>
            <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="supp_pan" name="supp_pan" onchange="validate_alphanumeric(this.id)" value="<?= $sq_cruise_info['pan_no']?>" placeholder="Personal Identification No(PIN)" title="Personal Identification No(PIN)" style="text-transform: uppercase;">
          </div> 
...
$('#state1').select2({
  dropdownParent: $("#cruise_update_modal")});

...
<div class="modal fade" id="cruise_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
          ...
          <form id="frm_cruise_save1">
            ...
            <legend>Cruise Supplier Information</legend>
              ...
              <div class="row">  
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <textarea id="cruise_address" name="cruise_address" onchange="validate_address(this.id);" placeholder="Address" class="form-control" title="Address" rows="1"></textarea>
                  </div>
              </div>
...
$('#state').select2({
  dropdownParent: $("#cruise_save_modal")});

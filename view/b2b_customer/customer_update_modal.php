...
$sq_credit = mysqli_fetch_assoc(mysqlQuery("select * from b2b_creditlimit_master where register_id='$register_id'"));
...
?>
<div class="modal fade" id="customer_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
          ...
          <div class="row mg_bt_10">
            <div class="col-sm-3 mg_bt_10_sm_xs">
              ...
              <?php } ?>
                  ...
                  <?php if($sq_customer['approval_status']!='Approved'){ ?><option value="Approved">Approved</option> <?php } ?>
                  <?php if($sq_customer['approval_status']!='Rejected'){ ?><option value="Rejected">Rejected</option> <?php } ?>
              </select>
            </div>
              ...
              <?php if($sq_customer['approval_status'] == 'Approved'){ ?>
                ...
                <div class="col-md-3 mg_tp_10">
                  <select name="bank_id" id="bank_id" title="Select Creditor Bank" data-toggle="tooltip" style="width:100%" class="form-control" disabled>
                    ...
                    $sq_bank = mysqli_fetch_assoc(mysqlQuery("select * from bank_master where bank_id='$sq_customer[bank_id]'"));  
                    ?>
  ...
  $(function(){
	$('#frm_customer_update').validate({
	  ...
	  submitHandler:function(form){
        ...
        if(payment_mode=="Credit Note"||payment_mode=="Advance"||payment_mode=="Credit Card"){

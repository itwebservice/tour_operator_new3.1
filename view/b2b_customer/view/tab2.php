		...
		<h3>Account Details</h3>
        	<div class="row">
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>IFSC/SWIFT Code <em>:</em></label> ".$query['b_ifsc_code']; ?>
		            </span>  
		        </div>
		    </div> 
	    </div>
		...
		<h3>Deposit Details</h3>
        	<div class="row">
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php $sq_bank = mysqli_fetch_assoc(mysqlQuery("select bank_name from bank_master where bank_id='$query[bank_id]'")); echo "<label>Creditor Bank <em>:</em></label>".$sq_bank['bank_name'] ?>
		            </span> 
		        </div>
		    </div> 
	    </div>

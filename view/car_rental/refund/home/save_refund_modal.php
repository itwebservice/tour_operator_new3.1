...
?>
<div class="modal fade" id="save_modal" data-backdrop="static" data-keyboard="false">
...
$(function(){
  $('#frm_refund_save').validate({
      ...
      submitHandler:function(form){
          ...
          if(Number(refund_amount) != 0 && Number(remianing_total) == 0){
          ...
          else if(typeof($("#ref_amt")) != "undefined" && (Number($("#ref_amt").val()) ==  Number($('#refund_amount_to_give').val()))){
            error_msg_alert("Refund Already Fully Paid"); return false;
          }

...
$currency_amount_3= '';
	...
	//**Basic Cost
	$basic_cost = (float)($row_car['total_cost']) - (float)($service_tax1) - (float)($row_car['cancel_amount']);
   ...
   $currency_amount2 = currency_conversion($currency,$row_car['currency_code'],$paid_amount);
	if($row_car['currency_code'] !='0' && $currency != $row_car['currency_code']){
	  ...
	  $currency_amount4 = currency_conversion($currency,$row_car['currency_code'],$total_bal);
	if($row_car['currency_code'] !='0' && $currency != $row_car['currency_code']){

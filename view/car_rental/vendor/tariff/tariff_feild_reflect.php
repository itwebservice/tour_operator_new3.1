...
<div class="panel panel-default panel-body app_panel_style">
    ...
    <table id="tbl_dynamic_car_rental_vehicle_local" name="tbl_dynamic_car_rental_vehicle_local" class="table table-bordered" style="width: 965px;">
        <tr>
            ...
            <td><select name="vehicle_name1" id="vehicle_name1" data-toggle="tooltip" title="Vehicle Name" class="form-control app_select2" style="width:200px;">
            ...
            <td class="hidden"><input type="text" id="seating_capacity" name="seating_capacity" placeholder="Seating Capacity" data-toggle="tooltip" title="Seating Capacity" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
            <td><input type="text" id="total_hrs" name="total_hrs" data-toggle="tooltip" placeholder="Total Hrs" title="Total Hrs" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
    ...
    <div class="row"><div class="col-md-12"><div class="table-responsive">
        <table id="tbl_dynamic_car_rental_vehicle_out" name="tbl_dynamic_car_rental_vehicle_out" class="table table-bordered" style="width: 2000px;">
            <tr>
                ...
                <td><input type="text" id="permit_charges" name="permit_charges" data-toggle="tooltip" placeholder="Permit Charges" title="Permit Charges" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
                <td><input type="text" id="toll_parking" name="toll_parking" data-toggle="tooltip" placeholder="Toll & Parking Charges" title="Toll & Parking Charges" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
                <td><input type="text" id="state_entry_pass" name="state_entry_pass" data-toggle="tooltip" placeholder="State Entry Charge" title="State Entry Charge" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
                <td><input type="text" id="other_charges" name="other_charges" data-toggle="tooltip" placeholder="Other Charges" title="Other Charges" class="form-control" onchange="validate_balance(this.id)" style="width:150px;"/></td>
            </tr>                                
        </table>
    </div></div></div>
</div>

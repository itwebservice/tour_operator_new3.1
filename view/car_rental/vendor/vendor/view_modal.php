      		...
      		<div class="modal-body profile_box_padding">
				  ...
				  <!-- Nav tabs -->
				  	...
				  	<ul class="nav nav-tabs" role="tablist">
				    	...
				    	<li role="presentation" class="active"><a href="#basic_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Vehicle Supplier Information</a></li>

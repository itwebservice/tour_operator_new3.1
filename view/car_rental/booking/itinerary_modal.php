        ...
        ?>
            ...
            <table style="width:100%" id="default_program_list" name="default_program_list" class="table mg_bt_0 table-bordered">
                ...
                while($row_itinerary = mysqli_fetch_assoc($sq_itinerary)){
                    ...
                    <td class="col-md-3 no-pad" style="padding-left: 5px !important;"><input type="text" id="special_attaraction<?= $count?>" onchange="validate_spaces(this.id);" name="special_attaraction" class="form-control" placeholder="*Special Attraction" title="Special Attraction" value="<?= $row_itinerary['special_attraction']?>"></td>
                    <td class="col-md-5 no-pad" style="padding-left: 5px !important;"><textarea id="day_program<?= $count?>" name="day_program" class="form-control" rows="2" placeholder="*Day-wise Program" onchange="validate_spaces(this.id);" title="Day-wise Program"><?=$row_itinerary['daywise_program']?></textarea></td>
                    <td class="col-md-2 no-pad" style="padding-left: 5px !important;"><input type="text" id="overnight_stay<?= $count?>" name="overnight_stay" onchange="validate_spaces(this.id);" class="form-control" placeholder="*Overnight Stay" title="Overnight Stay" value="<?=$row_itinerary['overnight_stay']?>"></td>
                    <td class="col-md-2 no-pad" style="padding-left: 5px !important;">
                        <select id="meal_plan<?= $count?>" name="meal_plan" class="form-control" title="Meal Plan">

...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="customer_booking_load('customer_id_filter', 'booking_id_filter')" class="form-control" title="Select Customer" style="width:100%">

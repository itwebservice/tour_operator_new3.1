...
$qry = mysqlQuery("select * from vendor_estimate inner join car_rental_booking on vendor_estimate.vendor_type_id = car_rental_booking.booking_id 
inner join customer_master on car_rental_booking.booking_id=customer_master.customer_id where vendor_type_id='$carId' and vendor_type='$vendorName' and vendor_estimate.delete_status='0'") or die('error');

...
$cruisemasterId = $_POST['cruise_id'];
$companyName = $_POST['vendor_name'];
$qry = mysqlQuery("select * from vendor_estimate where vendor_type_id='$cruisemasterId' and vendor_type='$companyName' and delete_status='0'")or die('error');

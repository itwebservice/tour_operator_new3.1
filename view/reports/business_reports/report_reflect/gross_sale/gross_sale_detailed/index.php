        ...
        <tbody>
            ...
            if($sq_group_count!="0" || $sq_group_pre_count!='0'){
                ...
                while($row=mysqli_fetch_assoc($sql_grp)){
                    ...
                    $sq_group = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from tourwise_traveler_details where financial_year_id='$financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $sq_group_pre = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from tourwise_traveler_details where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id' and tour_group_status!='Cancel'"));
                    $current_group_sale = $sq_group['net_total'];
                    $previous_group_sale = $sq_group_pre['net_total'];

                    $sq_group_month = mysqli_fetch_assoc(mysqlQuery("SELECT sum(net_total) as net_total
                    ...
                    $sq_group_month_pre = mysqli_fetch_assoc(mysqlQuery("SELECT sum(net_total) as net_total
           ...
           $pckg_ledger_arr = array();
            ...
            while($row=mysqli_fetch_assoc($sql_package)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
            $sq_package = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from package_tour_booking_master where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
            $sq_package_pre = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from package_tour_booking_master where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
    
            $current_package_sale = $sq_package['net_total'];
            $previous_package_sale = $sq_package_pre['net_total'];
    
            $sq_package_month = mysqli_fetch_assoc(mysqlQuery("SELECT sum(net_total) as net_total
            ...
            $sq_package_month_pre = mysqli_fetch_assoc(mysqlQuery("SELECT sum(net_total) as net_total
            ...
            while($row=mysqli_fetch_assoc($sql_hotel)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_hotel = mysqli_fetch_assoc(mysqlQuery("select sum(total_fee) as hotel_total from hotel_booking_master where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
                $sq_hotel_pre = mysqli_fetch_assoc(mysqlQuery("select sum(total_fee) as hotel_total from hotel_booking_master where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_bus)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                    $sq_bus = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as bus_total from bus_booking_master where financial_year_id='$financial_year_id'"));
                    $sq_bus_pre = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as bus_total from bus_booking_master where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_flight)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_flight = mysqli_fetch_assoc(mysqlQuery("select sum(ticket_total_cost) as flight_total from ticket_master where financial_year_id='$financial_year_id'"));
                $sq_flight_pre = mysqli_fetch_assoc(mysqlQuery("select sum(ticket_total_cost) as flight_total from ticket_master where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_flight)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_train = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from train_ticket_master where financial_year_id='$financial_year_id'"));
                $sq_train_pre = mysqli_fetch_assoc(mysqlQuery("select sum(net_total) as net_total from train_ticket_master where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_visa)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_visa = mysqli_fetch_assoc(mysqlQuery("select sum(visa_total_cost) as net_total from visa_master where financial_year_id='$financial_year_id'"));
                $sq_visa_pre = mysqli_fetch_assoc(mysqlQuery("select sum(visa_total_cost) as net_total from visa_master where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_car)){
                ...
                $sq_car = mysqli_fetch_assoc(mysqlQuery("select sum(total_fees) as net_total from car_rental_booking where financial_year_id='$financial_year_id'"));
                $sq_car_pre = mysqli_fetch_assoc(mysqlQuery("select sum(total_fees) as net_total from car_rental_booking where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_exc)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_exc = mysqli_fetch_assoc(mysqlQuery("select sum(exc_total_cost) as net_total from excursion_master where financial_year_id='$financial_year_id'"));
                $sq_exc_pre = mysqli_fetch_assoc(mysqlQuery("select sum(exc_total_cost) as net_total from excursion_master where financial_year_id='$pre_financial_year_id'"));
            ...
            while($row=mysqli_fetch_assoc($sql_misc)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
            $sq_misc = mysqli_fetch_assoc(mysqlQuery("select sum(misc_total_cost) as net_total from miscellaneous_master where financial_year_id='$financial_year_id'"));
            $sq_misc_pre = mysqli_fetch_assoc(mysqlQuery("select sum(misc_total_cost) as net_total from miscellaneous_master where financial_year_id='$pre_financial_year_id'"));
            ...
            $sql_forex = mysqlQuery("select * from forex_booking_master");
            while($row=mysqli_fetch_assoc($sql_forex)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                ...
                if($is_exist!=1){
                    ...
                    <?php } } }
            // <!-- Passport Booking -->
            $sq_passport_count = mysqli_num_rows(mysqlQuery("select * from passport_master where financial_year_id='$financial_year_id'"));
            $sq_passport_pre_count = mysqli_num_rows(mysqlQuery("select * from passport_master where financial_year_id='$pre_financial_year_id'"));
            ...
            $sql_passort = mysqlQuery("select * from passport_master");
            while($row=mysqli_fetch_assoc($sql_passort)){
                $customer_id = $row['customer_id'];
                $ledger_name = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
                $sq_passport = mysqli_fetch_assoc(mysqlQuery("select sum(passport_total_cost) as net_total from passport_master where financial_year_id='$financial_year_id'"));
                $sq_passport_pre = mysqli_fetch_assoc(mysqlQuery("select sum(passport_total_cost) as net_total from passport_master where financial_year_id='$pre_financial_year_id'"));

...
<div class="modal fade" id="other_expense_modal_s" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    		...
    		<div class="modal-header">
      		...
      		<div class="modal-body profile_box_padding">   	      		
				...
				<div class="row text-center mg_tp_20">
		      		<div class="col-md-12">
						<button class="btn btn-success btn-sm" id="group_expense_save" onclick="save_tour_estimate_expense()"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Save</button>
					</div>
		      	</div>
	    	</div>
		</div>
...
<script type="text/javascript">
	...
	{
        $('#group_expense_save').prop('disabled',true);
		...
		if(purchase_amount == ''){
			...
			$('#group_expense_save').prop('disabled',false);
			return false;			
		}
		$.ajax({
			type:'post',

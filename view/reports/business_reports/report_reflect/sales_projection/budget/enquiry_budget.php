...
$bud_strong_f1 = isset($_SESSION['bud_strong_f1']) ?  $_SESSION['bud_strong_f1'] : 0;
$bud_hot_f = $_SESSION['bud_hot_f'];
$bud_hot_f1 = isset($_SESSION['bud_hot_f1']) ? $_SESSION['bud_hot_f1'] : 0;
$bud_cold_f = $_SESSION['bud_cold_f'];
$bud_cold_f1 = isset($_SESSION['bud_cold_f1']) ? $_SESSION['bud_cold_f1'] : 0;
...
$bud_strong_ms = isset($_SESSION['bud_strong_ms']) ? $_SESSION['bud_strong_ms'] : 0;
$bud_hot_ms = isset($_SESSION['bud_hot_ms']) ? $_SESSION['bud_hot_ms'] : 0;
$bud_cold_ms = isset($_SESSION['bud_cold_ms']) ? $_SESSION['bud_cold_ms'] : 0;
...
$pro_s_f1 = isset($_SESSION['pro_s_f1']) ? $_SESSION['pro_s_f1'] : 0;
$pro_c_f = $_SESSION['pro_c_f'];
$pro_c_f1 = isset($_SESSION['pro_c_f1']) ? $_SESSION['pro_c_f1'] : 0;
$pro_h_f = $_SESSION['pro_h_f'] ;
$pro_h_f1 = isset($_SESSION['pro_h_f1']) ? $_SESSION['pro_h_f1'] : 0;
...
$pro_s_ms = isset($_SESSION['pro_s_ms']) ? $_SESSION['pro_s_ms'] : 0;
$pro_c_ms = isset($_SESSION['pro_c_ms']) ? $_SESSION['pro_c_ms'] : 0;
$pro_h_ms = isset($_SESSION['pro_h_ms']) ? $_SESSION['pro_h_ms'] : 0;
...
$bud_f = $bud_strong_f1 + $bud_cold_f1 + $bud_hot_f1;
...
<input type="hidden" id="bud_strong_f1" value="<?= $bud_f1 ?>">
...
<input type="hidden" id="pro_s_f1" value="<?= $pro_s_f1 ?>">
<input type="hidden" id="pro_h_f" value="<?= $pro_h_f ?>">
<input type="hidden" id="pro_h_f1" value="<?= $pro_h_f1 ?>">
<input type="hidden" id="pro_c_f" value="<?= $pro_c_f ?>">
<input type="hidden" id="pro_c_f1" value="<?= $pro_c_f1 ?>">
...
<input type="hidden" id="bud_strong_ms" value="<?= $bud_strong_ms ?>">
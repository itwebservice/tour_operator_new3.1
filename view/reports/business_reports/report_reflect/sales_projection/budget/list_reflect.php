...
$total_g = isset($_SESSION['total_g']) ? $_SESSION['total_g'] : 0;
$total_p = isset($_SESSION['total_p']) ? $_SESSION['total_p'] : 0;
$total_b = isset($_SESSION['total_b']) ? $_SESSION['total_b'] : 0;
$total_c = isset($_SESSION['total_c']) ? $_SESSION['total_c'] : 0;
$total_pp = isset($_SESSION['total_pp']) ? $_SESSION['total_pp'] : 0;
$total_h = isset($_SESSION['total_h']) ? $_SESSION['total_h'] : 0;
$total_v = isset($_SESSION['total_v']) ? $_SESSION['total_v'] : 0;
$total_t = isset($_SESSION['total_t']) ? $_SESSION['total_t'] : 0;
$total_f = isset($_SESSION['total_f']) ? $_SESSION['total_f'] : 0;
$total_f1 = isset($_SESSION['total_f1']) ? $_SESSION['total_f1'] : 0;
$total_ms = isset($_SESSION['total_ms']) ? $_SESSION['total_ms'] : 0;

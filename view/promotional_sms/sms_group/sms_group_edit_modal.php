...
$sq_sms_group_info = mysqli_fetch_assoc(mysqlQuery("select * from sms_group_master where sms_group_id='$sms_group_id'"));
?>
<div class="modal fade" id="sms_group_update_modal"  role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="hidden" id="sms_group_id" name="sms_group_id" value="<?= $sms_group_id ?>">
      	...
      	<div class="row">
      		<div class="col-md-6">
      			<input type="text" id="sms_group_name1" name="sms_group_name1"  onchange="validate_spaces(this.id); validate_specialChar(this.id);" value="<?= $sq_sms_group_info['sms_group_name'] ?>" placeholder="SMS Group Name" title="SMS Group Name">
      		</div>
      		<div class="col-md-6">

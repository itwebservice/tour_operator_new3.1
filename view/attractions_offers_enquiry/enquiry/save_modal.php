                ...
                <form id="frm_emquiry_save">
                    <div class="row mg_bt_20">
                        <div class="col-sm-4 col-sm-offset-4">
                            <select name="enquiry_type" id="enquiry_type" title="Enquiry For" title="Enquiry For"
                                data-toggle="tooltip" onchange="enquiry_fields_reflect()" class="form-control">
                    ...
                    <div class="row mg_tp_10">
                        ...
                        <div class="col-md-3 col-sm-6 mg_bt_10 hidden" id="user_dropdown">
                        </div>
                        <div class="col-md-3 col-sm-6 mg_bt_10">
                            <div class="row">
                                <div class="col-md-6" style="padding-right:0px;">
                                    <select name="country_code" id="country_code" title="Country Code"
                                        style="width:130px;" class="app_select2">
                                        <?= get_country_code(); ?>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <input type="number" class="form-control" id="txt_landline_no" onchange="mobile_validate(this.id);" name="txt_landline_no" placeholder="WhatsApp No" title="WhatsApp No" style="width: 150px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-6 mg_bt_10">
                            <input type="text" class="form-control" id="txt_email_id" name="txt_email_id"
                                placeholder="Email ID" title="Email ID">
                        </div>
                        <div class="col-md-2 col-sm-6 mg_bt_10">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
                        ...
                        <div class="row">
                            <div class="col-sm-4 mg_bt_10">
                                <input type="text" class="form-control" id="txt_enquiry_date" name="txt_enquiry_date"
                                    placeholder="*Enquiry Date" title="Enquiry Date"
                                    onchange="check_valid_date(this.id)" value="<?= date('d-m-Y') ?>">
                            </div>
                            <div class="col-sm-4 mg_bt_10">
                                <input type="text" class="form-control" id="txt_followup_date" name="txt_followup_date"
                                    placeholder="*Followup Date" title="Followup Date & Time"
                                    value="<?= date('d-m-Y H:i') ?>">
                            </div>
                            <div class="col-sm-4 mg_bt_10">
                                <select name="reference_id" id="reference_id" style="width:100%" title="Reference" class="app_select2"
                            ...
                            <div class="col-md-4 col-sm-6 mg_bt_10">
                                <select id="customer_dropdown" name="customer_dropdown" title="Customer"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 mg_bt_10_xs">
                                <select name="assigned_emp_id" id="assigned_emp_id" title="Allocate To" class="app_select2"
                                    style="width:100%">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" id="txt_enquiry_specification"
                                    onchange="validate_spaces(this.id);" name="txt_enquiry_specification"
                                    placeholder="Other Enquiry specification (If any)"
                                    title="Enquiry Specification"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center mg_tp_20">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-success" id="btn_enq_save"><i
        ...
        $('#frm_emquiry_save').validate({
            ...
            submitHandler: function(form, e) {
                ...
                var customer_name = $('#customer_dropdown').val();
                 ...
                 var destination_name =$('#tour_name').val();
                ...
                $.post(
                    ...
                    function(data) {
                        $.post(base_url + 'view/load_data/finance_date_validation.php', {
                            check_date: enquiry_date
                        }, function(data1) {
                            if (data1 !== 'valid') {
                                $('#btn_enq_save').button('reset');
                                error_msg_alert(
                                    "The Enquiry date does not match between selected Financial year."
                                );
                                return false;
                            } else {

...
<div class="row mg_bt_10">
	...
	<div class="col-md-4">
		...
		<select name="visa_country_name" id="visa_country_name" class="form-control app_select2" title="Visa Country Name" style="width:100%">
...
<?php
					...
					if($enq_save=='Save'){
						?>
						<script>
						$('select[name=visa_country_name]').select2({dropdownParent: $("#enquiry_save_modal")});
						</script>
						
						<?php } else{ ?>
							<script>
							$('select[name=visa_country_name]').select2({dropdownParent: $("#enquiry_edit_modal")});
							</script>

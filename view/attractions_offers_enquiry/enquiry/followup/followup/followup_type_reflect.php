...
<?php if ($followup_status == 'New' || $followup_status == 'In-Followup') {  ?>
	...
	<script>
		...
		$('#cust_stateDiv').addClass('hidden');
		$('#quotation_id').addClass('hidden');
	</script>
<?php } elseif ($followup_status == 'Converted') {  ?>
	...
	<script>
		...
		$('#followup_date').removeClass('hidden');
		$('#cust_stateDiv').removeClass('hidden');
		$('#quotation_id').removeClass('hidden');
	</script>
<?php } else {  ?>

...
$q = "select * from branch_assign where link='daily_activity/index.php'";
...
<div class="header_bottom">
  <div class="row mg_bt_10">
      <div class="col-md-12 text-right">
          <button class="btn btn-info btn-sm ico_left btn-primary" type="button" data-toggle="modal" data-target="#activity_save_modal" title="Add New Activity"><i class="fa fa-plus"></i>&nbsp;&nbsp;Activity</button>
      </div>
  </div>
</div>

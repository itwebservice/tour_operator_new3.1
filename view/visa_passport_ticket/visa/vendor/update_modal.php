...
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Visa Vendor'"));

...
$q = "select branch_status from branch_assign where link='bus_booking/booking/index.php'";
...
<script>
	...
	function booking_dropdown_load(customer_id, booking_id) {
		...
		var branch_status = $('#branch_status').val();
		$.post('inc/booking_dropdown_load.php', {

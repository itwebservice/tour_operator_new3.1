...
<table class="table table-hover" id="bus_tbl_refund" style="margin: 20px 0 !important;">
	...
	<tfoot>
		<tr class="active">
			...
			<th class="text-right warning" colspan="2">Pending : <?= number_format((($pending_total=="") ? 0 : $pending_total), 2); ?></th>
			<th class="text-right danger" colspan="2">Cancelled : <?= number_format((($cancelled_total=="") ? 0 : $cancelled_total),2); ?></th>
			<th class="text-right success" colspan="3">Total_Refund : <?= number_format(($total_refund - $pending_total - $cancelled_total), 2); ?></th>
		</tr>
	</tfoot>
</table>

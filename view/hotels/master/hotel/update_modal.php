...
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$sq_hotel[hotel_name]' and password='$sq_hotel[mobile_no]' and vendor_type='Hotel Vendor'"));
...
$sq_hotel_img = mysqlQuery("select * from hotel_vendor_images_entries where hotel_id='$hotel_id'");
while ($row_hotel_img = mysqli_fetch_assoc($sq_hotel_img)) {
        ...
        <form id="frm_hotel_update">
          ...
          <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-md-2  col-sm-6 mg_bt_10">
                <select name="cust_state1" id="cust_state1" title="Select State/Country Name" style="width:100%" required class="app_select2">
            ...
            <div class="row">
              <div class="col-md-2 col-sm-6 mg_bt_10">
                <select name="rating_star" id="rating_star" title="Hotel Category" required class="app_select2" style="width:100%">
              ...
              <div class="col-md-2 col-sm-6 mg_bt_10">
                <select name="hotel_type1" id="hotel_type1" title="Hotel Type" class='form-control app_select2' style='width:100%;'>
              ...
              <div class="col-md-2 mg_bt_10">
                <select class="form-control app_select2" name="side" id="side1" title="Balance side" data-toggle='tooltip'>
          ...
          <div class="hidden panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-md-2 col-sm-6 mg_bt_10">
                <input type="text" value="<?= $sq_hotel['account_name'] ?>" class="form-control" id="account_name1" name="account_name1" placeholder="A/c Type" title="A/c Type">
              </div>
              <div class="col-md-2 col-sm-6 mg_bt_10">
...
<script>
  ...
  function upload_pic() {
    ...
    $.ajax({
      ...
      data: {
        hotel_upload_url: hotel_upload_url,
    ...
    $('#frm_hotel_update').validate({
      ...
      submitHandler: function(form) {
        ...
        if (parseFloat(cwb_from) == 0 || cwb_from == '') {
          error_msg_alert('Enter Child With Bed From Age in Policies');
          $('#accordion').css({
        ...
        if (parseFloat(cwb_to) == 0 || cwb_to == '') {
          error_msg_alert('Enter Child With Bed To Age in Policies');
          $('#accordion').css({
            border: '1px solid red'
          });
          return false;
        ...
        if (parseFloat(cwob_from) == 0 || cwob_from == '' || parseInt(cwob_to) == parseInt(cwb_from)) {
          error_msg_alert('Enter Child Without Bed From Age in Policies');
          $('#accordion').css({
            border: '1px solid red'
          });
          return false;
        ...
        if (parseFloat(cwob_to) == 0 || cwob_to == '') {
          error_msg_alert('Enter Child Without Bed To Age in Policies');
          $('#accordion').css({
            border: '1px solid red'
          });
          return false;
        ...
        if (parseFloat(cwb_from) > parseFloat(cwb_to)) {
          error_msg_alert('Invalid Child With Bed From-To Age in Policies');
          $('#accordion').css({
            border: '1px solid red'
          });
          return false;
        ...
        if (parseFloat(cwob_from) > parseFloat(cwob_to)) {
          error_msg_alert('Invalid Child Without Bed From-To Age in Policies');
          $('#accordion').css({
            border: '1px solid red'
          });
          return false;

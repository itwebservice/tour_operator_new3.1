...
<div id="div_hotels_list" class="main_block loader_parent mg_tp_20">
    <div class="table-responsive">
        <table id="hotel_master_tab" class="table table-hover" style="margin: 20px 0 !important; width:100%; ">
        </table>
    </div>
</div>
...
<script>
    ...
    function view_tarrif_modal(hotel_id) {
        $.post('hotel/view_tarrif_modal.php', {
            hotel_id: hotel_id
        }, function(data) {
            $('#div_view_modal').html(data);
        });

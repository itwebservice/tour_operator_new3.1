	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
				 ...
				 <div class="col-md-6 col-sm-6 col-xs-12">
					...
					<span class="main_block">
		        		  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        		  <?php
							$sq_credit = mysqli_fetch_assoc(mysqlQuery("SELECT sum(`credit_charges`) as sumc FROM `exc_payment_master` WHERE `exc_id`='$sq_exc_info[exc_id]' and `clearance_status`!='Cancelled' and clearance_status != 'Pending'"));

...
if ($sq_est['purchase_return'] == '1') {
  ...
  $balance_amount += (($sq_est['net_total'] - (float)($cancel_estimate[0]->net_total)) + $cancel_est) - $total_paid;
} else {
            ...
            <div class="row mg_bt_10">
              ...
              <div class="col-md-4">
                <select name="bank_id1" id="bank_id1" title="Debitor Bank" <?= $enable ?> disabled>
                  ...
                  <?php  }
                  get_bank_dropdown('Debitor Bank'); ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-md-8" style="margin-top:10px !important;">
               ...
               <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"  data-toggle="tooltip" required>
                                    ...
                                    //   $currency_code1 = $sq_tour['currency_code'];
                                    // }
                                    // else{

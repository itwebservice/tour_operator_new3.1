                                                ...
                                                <div class="row mg_bt_10">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="text" id="duration" name="duration"
                                                            placeholder="Duration" title="Duration">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="text" id="dep_point" name="dep_point"
                                                            placeholder="Pickup Point" title="Pickup Point">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <input type="text" id="rep_time" name="rep_time"
                                                ...
                                                <div class="row mg_bt_10">
                                                    <div class="col-md-12 ">
                                                        <button type="button" class="btn btn-sm btnType st-custBtn"
                                                            ...
                                                            title="Download CSV"><i class="icon fa fa-download"></i>CSV
                                                            Format</button>

                                                        <div class="div-upload" id="div_upload_button2" role="button"
                                                            data-toggle="tooltip" title="Upload CSV">
                                                            <div id="timing_tariff_upload" class="upload-button1">
                                                                <span>CSV</span>
                                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mg_bt_10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table id="table_exc_tarrif_offer"
                                                                    name="table_exc_tarrif_offer"
                                                                    class="table table-bordered no-marg pd_bt_51"
                                                                    style="width:100%">
                                                                    <tr>
                                                                        <td><input class="css-checkbox" id="chk_offer"
                                                                                type="checkbox"><label class="css-label"
                                                                                for="chk_offer"> </label></td>
                                                                        <td><input maxlength="15" value="1" type="text"
                                                                                name="username" placeholder="Sr. No."
                                                                                class="form-control" disabled /></td>
                                                                        <td><select name="offer_type" id="offer_type"
                                                                                style="width: 130px"
                                                                                class="form-control app_select2">
                                                                        ...
                                                                        <td><input type="text" id="from_date"
                                                                                ...
                                                                                value="<?= date('d-m-Y') ?>"
                                                                                style="width: 120px;"
                                                                                onchange="get_to_date(this.id,'to_date')" />
                                                                        </td>
                                                                        <td><input type="text" id="to_date"
                                                                                ...
                                                                                value="<?= date('d-m-Y') ?>"
                                                                                style="width: 120px;" /></td>
                                                                        <td><select name="amount_in" id="amount_in"
                                                                                style="width: 125px"
                                                                                class="form-control app_select2">
                                                                                <option value=''>Amount In</option>
                                                                                <option value='Flat'>Flat</option>
                                                                        ...
                                                                        <td><input type='text' id="coupon_code"
                                                                                name="coupon_code"
                                                                                placeholder="Coupon Code"
                                                                                title="Coupon Code"
                                                                                style="width: 130px;" /></td>
                                                                        <td><input type='number' id="oamount"
                                                                                name="oamount" placeholder="*Amount"
                                                                                class="form-control" title="Amount"
                                                                                style="width: 108px;" /></td>
                                                    ...
                                                    <div class="row mg_bt_10">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <textarea id="note" name="note"
                                                                onchange="validate_spaces(this.id)" placeholder="Note"
                                                                title="Note"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row mg_bt_20">
                                                        <div class="col-md-4 col-sm-4 mg_bt_10_sm_xs">
                                                            ...
                                                            <textarea class="feature_editor" id="inclusions" name="inclusions"
                                                                placeholder="Inclusions" title="Inclusions" rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-4 col-sm-4">
                                                            <h3 class="editor_title">Exclusions</h3>
                                                            <textarea class="feature_editor" id="exclusions" name="exclusions"
                                                                class="form-control" placeholder="Exclusions" title="Exclusions"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-4 col-sm-4 mg_bt_10_sm_xs">
                                                            <h3 class="editor_title">Terms & Conditions</h3>
                                                            <textarea class="feature_editor" id="terms" name="terms"
                                                                placeholder="Terms & Conditions" title="Terms & Conditions"
                                                                rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    $('#to_date,#from_date,#from_date_basic,#to_date_basic').datetimepicker({
        timepicker: false,
        format: 'd-m-Y'
    });
    ...
    function display_format_modal1() {
        var base_url = $('#base_url').val();
        window.location = base_url + "images/csv_format/activity_timing_slots.csv";
    }
        ...
        $('#frm_b2b_exc_save').validate({
            ...
            submitHandler: function(form) {
                ...
                if (bfrom_date_array.length == 0) {
                    error_msg_alert('Atlease one row required in Basic Costing!');
                    return false;
                }
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        note: note,
                        off_days: off_days,
                        timing_slots: JSON.stringify(timing_slots),

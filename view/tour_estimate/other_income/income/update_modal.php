...
$sq_income_info = mysqli_fetch_assoc(mysqlQuery("select * from other_income_master where income_id='$income_id'"));
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select name="income_type_id" title="Income Type" id="income_type_id">
                  ...
                  <?php 
                  $sq_income_type = mysqlQuery("select * from other_income_type_master order by income_type");
                  while($row_income_type = mysqli_fetch_assoc($sq_income_type)){
                    ?>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select name="bank_id" id="bank_id" title="Select Bank" <?= $disabled ?>>
                  <?php 
                  $sq_bank = mysqli_fetch_assoc(mysqlQuery("select * from bank_master where bank_id='$sq_income_info[bank_id]'"));

		...
		<table class="table table-hover" id="tbl_expense_list" style="margin: 20px 0 !important;">
				...
				<tbody>
					...
					while($row_expense = mysqli_fetch_assoc($sq_expense)){
						...
						$sq_paid = mysqli_fetch_assoc(mysqlQuery("select payment_amount as sum from other_expense_payment_master where expense_type_id='$row_expense[expense_type_id]' and supplier_id='$row_expense[supplier_id]'"));

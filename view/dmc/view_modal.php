...
$sq_dmc= mysqli_fetch_assoc(mysqlQuery("select * from dmc_master where dmc_id='$dmc_id'"));
						     	...
						     	<div class="row">
									...
									<div class="col-md-12">
							        	...
							        	<?php 
							        		...
							        		$sq_city = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$sq_dmc[city_id]'")); 
							        	...
							        	?>
							        		...
							        		<div class="row">
           										...
           										<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd">
							        				...
							        				<?php $sq_state = mysqli_fetch_assoc(mysqlQuery("select * from state_master where id='$sq_dmc[state_id]'"));
                   									 ?> 
							        				 <span class="main_block">
							        			...
							        			<div class="col-md-6">
							        				...
							        				<span class="main_block hidden">
							        				    ...
							        				    <?php echo "<label>Account Type <em>:</em></label> " .$sq_dmc['account_name']; ?> 
							        				...
							        				<span class="main_block hidden">
							        				    ...
							        				    <?php echo "<label>IFSC/SWIFT CODE <em>:</em></label> " .strtoupper($sq_dmc['ifsc_code']); ?>
							        				...
							        				<span class="main_block hidden">
							        				    ...
							        				    <?php echo "<label>Personal Identification No(PIN) <em>:</em></label> " .strtoupper($sq_dmc['pan_no']); ?>

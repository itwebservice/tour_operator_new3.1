        ...
        <div class="row mg_tp_20">
            ...
            <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
                ...
                <?php if ($sq_traveler_info['pan_card_url'] != "") : ?>
                    <a href="<?= $download_urlpan_card ?>" class="btn btn-info ico_center"
                        title="Download PAN Card" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
                <?php endif; ?>
            </div>
            <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
                <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
                ...
                <?php if($sq_traveler_info['driving_license']!=""): ?>
                    <a href="<?= $download_url ?>" class="btn btn-info ico_center" title="Download Driving License"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
                <?php endif; ?>
            </div>
        </div>
...
function pan_card_upload3()
{
    ...
    new AjaxUpload(btnUpload, {
        action: 'air_ticket/upload_pan_card_file3.php',
        name: 'uploadfile1',
        onSubmit: function(file, ext){
...
function pan_card_upload4()
{
    ...
    new AjaxUpload(btnUpload, {
        action: 'air_ticket/upload_pan_card_file4.php',
        name: 'uploadfile1',
        onSubmit: function(file, ext){
...
function driving_license_upload()
{
    ...
    new AjaxUpload(btnUpload, {
        action: 'air_ticket/upload_driving_license.php',
        name: 'uploadfile1',
        onSubmit: function(file, ext){
...
function upload_tour_pan_card(doc_name) {
    ...
    $.ajax({
        ...
        data: {
            entry_id: entry_id,
            id_proof_url: id_proof_url,id_proof_url3:id_proof_url3,id_proof_url4:id_proof_url4,driving_license:driving_license
        },
        success: function(result) {
            msg_alert(doc_name + ' uploaded successfully!');
        }

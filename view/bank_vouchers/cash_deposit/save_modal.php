      ...
      <div class="modal-body">            
            ...
            <div class="row">
              <div class="col-md-12 col-sm-9">
                <span style="color: red;line-height: 35px;" data-original-title="" title="" class="note"><?= 'Please make sure Date, Amount, Debitor bank entered properly.' ?></span>
              </div>
            </div>

            <div class="row text-center mg_tp_20">
              <div class="col-xs-12">
                <button class="btn btn-sm btn-success" id="btn_cash_save"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Save</button>
              </div>
            </div>
      </div>
    </div>
...
$('#frm_save').validate({
  ...
  submitHandler:function(form){
    ...
    $('#btn_cash_save').prop('disabled',true);

...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Cash Withdrawal')
...
$count = 0;
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue('B'.$row_count, $row_withdraw['withdraw_id'])
        ...
        ->setCellValue('F'.$row_count, ($sq_emp['first_name'] !='')?$sq_emp['first_name'].' '.$sq_emp['last_name']:'Admin');
...
header('Content-Disposition: attachment;filename="Cash_Withdrawal('.date('d-m-Y H:i').').xls"');

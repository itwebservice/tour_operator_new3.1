					...
					<div class="panel panel-default panel-body fieldset">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 mg_bt_10_sm_xs">
								...
								<input type="text" id="narration" class="form-control" name="narration" placeholder="Narration" title="Narration" style="height: 50px;">
							</div>
						</div>
...
$('#customer_id,#currency_code1').select2({

					...
					<div class="panel panel-default panel-body fieldset ">
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<table id="tbl_dynamic_miscellaneous_update" name="tbl_dynamic_miscellaneous_update" class="table table-bordered no-marg" style="min-width:1500px">
										<?php
										$offset = "_u";
										$sq_entry_count = mysqli_num_rows(mysqlQuery("select * from miscellaneous_master_entries where misc_id='$misc_id'"));
										if ($sq_entry_count == 0) {
						...
						<div class="panel panel-default panel-body fieldset mg_tp_30">
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
									...
									<input type="hidden" id="old_total" value="<?= $sq_visa_info['misc_total_cost'] ?>" readonly>
								</div>
								<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                ...
                                <select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"  data-toggle="tooltip" required>
                                    ...
                                    if($sq_visa_info['currency_code'] ==''){
                                      $currency_code1 = $currency;
                                    }
                                    else{
                                      $currency_code1= $sq_visa_info['currency_code'];
                                    }
						...
						<div class="row text-center">
							<div class="col-md-12 mg_bt_10">
								<button class="btn btn-sm btn-success" id="misc_update"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Update</button>
							</div>
						</div>
...
<script>
	...
	$('#customer_id1,#service1,#acurrency_code1').select2();
	$('#birth_date1, #issue_date1, #due_date1,#balance_date1').datetimepicker({
		timepicker: false,
		format: 'd-m-Y'
	});
	...
	$(function() {
		...
		$('#frm_visa_update').validate({
			...
			submitHandler: function(form) {
				...
				$('#misc_update').prop('disabled', true);

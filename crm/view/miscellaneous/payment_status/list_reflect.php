...
while ($row_visa = mysqli_fetch_assoc($sq_visa)) {
	...
	$customer_name = get_sales_report_customer_name($row_visa['customer_id'], get_sales_report_passenger_name('Miscellaneous', $row_visa['misc_id']));
...
$currency_amount_3= '';
	...
	$temp_arr = array("data" => array(
		...
		number_format($total_bal, 2).$currency_amount_4,

                ...
                <form id="frm_emquiry_edit">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mg_bt_10">
                                <select name="reference_id_u" id="reference_id_u" style="width:100%" title="Reference" class="app_select2"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 mg_bt_10_xs">
                                <select name="assigned_emp_id_u" id="assigned_emp_id_u" title="Allocate To" class="app_select2"
                                    style="width:100%">
                                    <?php
                                    $admin_select_flag = 0;

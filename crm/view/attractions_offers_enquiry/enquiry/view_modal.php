...
$cust_user_name = '';
if ($sq_enq_info['user_id'] != 0) {
	$row_user = mysqli_fetch_assoc(mysqlQuery("Select name from customer_users where user_id =" . $sq_enq_info['user_id']));
...
$reference_name = isset($sq_ref['reference_name']) ? $sq_ref['reference_name'] : '';
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<span class="main_block">
															...
															<?php echo "<label>Customer <em>:</em></label> " . $sq_enq_info['name'] . $cust_user_name; ?>
													...
													<div class="col-md-6">
														...
														<span class="main_block">
															...
															<?php echo "<label>Reference <em>:</em></label> " . $reference_name; ?>
										...
										<tbody>
											...
											foreach ($enquiry_content as $values) {
												...
												if ($values['preffered_airline']) {
													...
													$airline_name = $sq_airline['airline_name'] . ' (' . $sq_airline['airline_code'] . ')';
												}
											?>
												<tr>

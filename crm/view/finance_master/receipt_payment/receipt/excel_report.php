...
$objPHPExcel->setActiveSheetIndex(0)
    ...
    ->setCellValue('G'.$row_count, "Payment Mode")
    ->setCellValue('H'.$row_count, "Created By");
...
while($row_deposit = mysqli_fetch_assoc($sq_deposit)){
    ...
    ->setCellValue('C'.$row_count, get_receipt_payment_id($row_deposit['id'],$row_deposit['receipt_type'],$yr1[0]))
    ->setCellValue('D'.$row_count, $row_deposit['receipt_type'])
    ->setCellValue('E'.$row_count, get_date_user($row_deposit['payment_date']))
    ->setCellValue('F'.$row_count, number_format($row_deposit['payment_amount'],2))
    ->setCellValue('G'.$row_count, $row_deposit['payment_mode'])        
    ->setCellValue('H'.$row_count, ($sq_emp['first_name'] !='') ? $sq_emp['first_name'].' '.$sq_emp['last_name']:'Admin');
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('F'.$row_count, 'Total Amount : '.number_format($total_amount,2))

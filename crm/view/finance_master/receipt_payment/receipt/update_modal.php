      ...
      <div class="modal-body">
            ...
            <div class="row mg_bt_10">
              <div class="col-md-4 col-sm-6 col-xs-12">
                  <select name="receipt_type" id="receipt_type1" class='form-control' title="Transaction Type" disabled>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <select name="ledger_id" id="ledger_id1" title="Select Ledger" class="form-control app_select2" style="width:100%" disabled>
...
$('#rpfrm_update').validate({
  ...
  submitHandler:function(form){
    ...
    var receipt_type = $('#receipt_type1').val();

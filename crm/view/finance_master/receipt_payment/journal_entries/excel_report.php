...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$row_count, "Debit_Amount");
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$row_count, 'Total Debit '.number_format($total_cr,2));
...
header('Content-Disposition: attachment;filename="Journal_Entries('.date('d-m-Y H:i').').xls"');

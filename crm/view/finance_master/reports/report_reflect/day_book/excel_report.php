...
while($row_query = mysqli_fetch_assoc($sq_query))
{
        ...
        $sq_ledger = mysqli_fetch_assoc(mysqlQuery("select * from ledger_master where ledger_id='$row_query[gl_id]'"));
...
header('Content-Disposition: attachment;filename="Day_Book_Register('.date('d-m-Y H:i').').xls"');

		...
		<div class="profile_box main_block">
        	 	...
        	 	<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd; min-height: 105px;">
	        		<span class="main_block">
		                  ...
		                  <?php echo "<label>Branch Name <em>:</em></label> ".$sq_branch['branch_name']; ?>
		            </span>
	        		<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		            ...
		            <span class="main_block" style="text-transform: uppercase;">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
        	 	...
        	 	<div class="col-md-6">  
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Account Branch Name <em>:</em></label> ".$query['branch_name']; ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>

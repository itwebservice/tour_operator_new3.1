...
<div class="row mg_bt_10">
  <div class="col-xs-12"> 
      <button type="button" data-toggle="tooltip" class="btn btn-excel" title="Note: Upload Image size below 1MB, resolution : 1800*400, Format : JPEG,JPG."><i class="fa fa-question-circle"></i></button>
  </div>
</div>

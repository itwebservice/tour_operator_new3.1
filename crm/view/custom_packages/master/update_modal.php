                    ...
                    <div class="app_panel_content Filter-panel">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                                    <div class="col-md-3 col-sm-3">
                                        <?php $sq_query_dest = mysqli_fetch_assoc(mysqlQuery("select * from destination_master where dest_id = '$sq_pckg[dest_id]'"));
                                        ?>
                                        <select id="dest_name_u" name="dest_name_u" title="Select Destination" class="form-control" style="width:100%" disabled>
                                            <option value="<?php echo $sq_query_dest['dest_id']; ?>">
                                                <?php echo $sq_query_dest['dest_name']; ?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <select name="tour_type" id="tour_type" title="Tour Type" onchange="incl_reflect(this.id,'1')" <?= $status ?>>
                                            <?php if ($sq_pckg['tour_type'] != '') { ?>
                                                <option value="<?= $sq_pckg['tour_type'] ?>"><?= $sq_pckg['tour_type'] ?>
                                                </option>
                                            <?php } else { ?>
                                    ...
                                    <div class="col-md-3 mg_bt_10">
                                        <select name="currency_code" id="currency_code1" title="Currency" style="width:100%">
                                            ...
                                            <option value='<?= $sq_currency['id'] ?>'>
                                                <?= $sq_currency['currency_code'] ?></option>
                                            <?php
                                    ...
                                    <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                        <select id="dest_image1" name="dest_image1" title="Destination Image" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?= $sq_pckg['dest_image'] ?>"><?= $image_url[$count] ?>
                                                </option>
                                            <?php } ?>

                                            <option value="">Select Image</option>
                                            <?php
                                            $query = " select * from gallary_master where dest_id = '$sq_pckg[dest_id]'";
                                            $count = 0;
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <select id="status1" name="status1" title="Status" class="<?= $active_inactive_flag ?>">
                                            <option value="<?php echo $sq_pckg['status']; ?>">
                                                <?php echo $sq_pckg['status']; ?></option>
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20">
                                    <div class="col-md-3 col-sm-3 mg_bt_10_xs hidden">
                                        <input type="text" id="seo_slug" name="seo_slug" value="<?php echo $sq_pckg['seo_slug']; ?>" class="form-control" placeholder="*SEO friendly slug" title="SEO friendly slug" oninput="cleanSlug()" />
                                    ...
                                    <div class="col-md-3 col-sm-3 mg_bt_10_xs hidden">
                                        <select id="tour_theme" name="tour_theme" title="Select Tour Theme" class="form-control" style="width:100%">
                                            <?php
                                            if($sq_pckg['tour_theme'] != 0){
                                                $sq_query = mysqli_fetch_assoc(mysqlQuery("select id,name from tour_theme where id = '$sq_pckg[tour_theme]'"));
                                                ?>
                                                <option value="<?php echo $sq_query['id']; ?>">
                                                    <?php echo $sq_query['name']; ?></option>
                                                  <?php  } ?>
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20 hidden">
                                        ...
                                        <tr>
                                            ...
                                            <td class='col-md-1/2 pad_8'><select id="meal_plan<?php echo $count; ?>" title="Meal Plan" name="meal_plan" class="form-control mg_bt_10" style='width:125px;margin-top:35px;'>
                                                    <?php if ($sq_pckg1['meal_plan'] != '') { ?>
                                                        <option value="<?php echo $sq_pckg1['meal_plan']; ?>">
                                                            <?php echo $sq_pckg1['meal_plan']; ?></option>
                                                    <?php } ?>
                        ...
                        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                ...
                                <div class="col-md-6 mg_tp_10"><button type="button" class="btn btn-excel btn-sm" title="Note - Please ensure you added transfer tariff"><i class="fa fa-question-circle" style="margin-top:5px;"></i></button></div>
                                <div class="col-xs-6 text-right mg_tp_10">
                                ...
                                <table id="tbl_package_tour_transport" name="tbl_package_tour_transport" class="table border_0 table-hover" style="padding: 0 !important;">
                                    ...
                                    if ($sq_count == 0) { ?>
                                        ...
                                        while ($row_tr = mysqli_fetch_assoc($sq_pckgtr)) {
                        ...
                        <div class="row mg_tp_20 mg_bt_20">
                            <div class="col-md-12 col-sm-6 mg_bt_10_sm_xs">
                                <textarea class="form-control" id="note1" name="note1" placeholder="Note" title="Note" rows="2"><?= $sq_pckg['note'] ?></textarea>
                            </div>
                        </div>
...
function addItineraryRowUpdate() {
    ...
    newRow.innerHTML = `
        ...
        <td class='col-md-1 pad_8' style="width: 120px;">
            <div style="margin-top: 35px;">
                <label for="day_image_${count}" class="btn btn-sm btn-success" style="margin-bottom: 5px; padding: 6px 12px; font-size: 12px; cursor: pointer; border-radius: 4px; border: none; background-color: #28a745; color: white; font-weight: 500;">
                    <i class="fa fa-image"></i> Upload Image
                </label>
...
function cleanSlug() {
const packageName = $('#seo_slug').val() || $('#package_name').val();
$('#seo_slug').val(generateSlug(packageName));
}
    ...
    $(function() {
        ...
        $('#frm_package_master_update').validate({
            ...
            submitHandler: function(form, event) {
                ...
                var result = package_name_validation('package_name1');
                if(!result) { error_msg_alert('Package name should not allow special character.'); return false; }

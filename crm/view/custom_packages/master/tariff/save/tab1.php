            ...
            <div class="app_panel_content Filter-panel">
                <div class="row mg_bt_10">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <select name="dest_id" id="dest_id" title="Select Destination"
                            onchange="package_dynamic_reflect(this.id)" style="width:100%" required>
                ...
                <div class="row mg_bt_10">
                    <div class="col-md-12 text-right text_center_xs">
                        <div class="col-md-6 text-left">
                            <button type="button" class="btn btn-sm btnType st-custBtn" onclick="tariff_csv();"
                                data-toggle="tooltip" title="Download CSV"><i class="icon fa fa-download"></i>CSV
                                Format</button>

                            <div class="div-upload mg_bt_20" id="div_upload_button2" data-toggle="tooltip"
                                title="Upload CSV">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tbl_package_tariff" name="tbl_package_tariff"
                                ...
                                style="width: 1400px;">
                                <tr>
                                    <td><input class="css-checkbox" id="chk_ticket1" type="checkbox" checked><label
                                            class="css-label" for="chk_ticket1"> </label></td>
                                    <td><input maxlength="15" value="1" type="text" name="no" placeholder="Sr. No."
                                            class="form-control" disabled /></td>
                                    <td><select id="hotel_type" name="form-control" title="Select Hotel Type"
                                            style="width:170px;">
                                            <?php get_hotel_category_dropdown(); ?>
                                        </select></td>
                                    <td><input type="number" id="min_pax" class="form-control" placeholder="*Min Pax"
                                            title="Min Pax" style="width:110px;" /></td>
                                    <td><input type="number" id="max_pax" class="form-control" placeholder="*Max Pax"
                                            title="Max Pax" style="width:110px;" /></td>
                                    <td><input type="text" id="from_date" class="form-control" placeholder="*From Date"
                                            title="Valid From Date" style="width:110px;" value="<?= date('d-m-Y') ?>"
                                            onchange="get_to_date(this.id,'to_date');" /></td>
                                    ...
                                    <td><input type="number" id="ccwb_cost" class="form-control" placeholder="CWB PP"
                                            title="CWB PP Cost" style="width:120px;" /><span>B2C Cost</span></td>
                                    <td><input type="number" id="ccwob_cost" class="form-control" placeholder="CWOB PP"
                                            title="CWOB PP Cost" style="width:120px;" /><span>B2C Cost</span></td>
                                    <td><input type="number" id="cinfant_cost" class="form-control"

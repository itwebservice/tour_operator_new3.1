        ...
        <div class="container-fluid">
                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <table id="table_package_tarrif_offer" name="table_package_tarrif_offer"
                                    class="table table-bordered no-marg pd_bt_51" style="width:100%">
                                    <tr>
                                        <td><input class="css-checkbox" id="chk_offer" type="checkbox"><label
                                                class="css-label" for="chk_offer"> </label></td>
                                        <td><input maxlength="15" value="1" type="text" name="username"
                                                placeholder="Sr. No." class="form-control" disabled /></td>
                                        <td><select name="offer_type" id="offer_type" data-toggle="tooltip"
                                                title="Offer Type" style="width: 150px"
                                                class="form-control app_select2">
                                                <option value=''>*Offer Type</option>
                                                <option value='Offer'>Offer</option>
                                                <option value='Coupon'>Coupon</option>
                                        </td>
                                        <td><input type="text" id="from_date_h" class="form-control" name="from_date_h"
                                                placeholder="Valid From" title="Valid From"
                                                onchange="get_to_date(this.id,'to_date_h')" value="<?= date('d-m-Y') ?>"
                                                style="width: 130px;" /></td>
                                        <td><input type="text" id="to_date_h" class="form-control" name="to_date_h"
                                                placeholder="Valid To " title="Valid To"
                                                onchange="validate_validDate('from_date_h' ,'to_date_h')"
                                                value="<?= date('d-m-Y') ?>" style="width: 130px;" /></td>
                                        <td><select name="amount_in" id="amount_in" data-toggle="tooltip"
                                                title="Amount In" style="width: 150px" class="form-control app_select2">
                                                <option value=''>*Amount In</option>
                                                <option value='Flat'>Flat</option>
                                                <option value='Percentage'>Percentage</option>
                                            </select></td>
                                        <td><input type='text' id="coupon_code" name="coupon_code"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table_package_tarrif_offer" name="table_package_tarrif_offer"
                                    class="table table-bordered no-marg pd_bt_51" style="min-width:1500px">
                                    <?php
                    $count = 1;
                    while ($row_tab5 = mysqli_fetch_assoc($sq_tab5)) { ?>
                                    <tr>
                                        <td><input class="css-checkbox" id="chk_offer<?= $count ?>-u" type="checkbox"
                                                checked><label class="css-label" for="chk_offer"> </label></td>
                                        <td><input maxlength="15" value="<?= $count ?>" type="text" name="username"
                                                placeholder="Sr. No." class="form-control" disabled /></td>
                                        <td><select name="offer_type" id="offer_type" data-toggle="tooltip"
                                                title="Offer Type" style="width: 150px"
                                                class="form-control app_select2">
                                                <option value='<?= $row_tab5['type'] ?>'><?= $row_tab5['type'] ?>
                                                </option>
                                                <option value=''>*Offer Type</option>
                                                <option value='Offer'>Offer</option>
                                                <option value='Coupon'>Coupon</option>
                                        </td>
                                        <td><input type="text" id="from_date_h<?= $count ?>-u" class="form-control"
                                                name="from_date_h<?= $count ?>-u" placeholder="Valid From"
                                                title="Valid From"
                                                onchange="get_to_date(this.id,'to_date_h<?= $count ?>-u')"
                                                value='<?= get_date_user($row_tab5['from_date']) ?>'
                                                style="width: 130px;" /></td>
                                        <td><input type="text" id="to_date_h<?= $count ?>-u" class="form-control"
                                                name="to_date_h" placeholder="Valid To " title="Valid To"
                                                onchange="validate_issueDate('from_date_h<?= $count ?>-u' ,'to_date_h<?= $count ?>-u')"
                                                value='<?= get_date_user($row_tab5['to_date']) ?>'
                                                style="width: 130px;" />
                                        </td>
                                        <td><select name="amount_in" id="amount_in" style="width: 150px"
                                                class="form-control app_select2" data-toggle="tooltip"
                                                title="Amount In">
                                                <option value='<?= $row_tab5['offer_in'] ?>'>
                                                    <?= $row_tab5['offer_in'] ?>
                                                </option>
                                                <option value=''>*Amount In</option>
                                                <option value='Flat'>Flat</option>
                                        ...
                                        <td><input type='text' id="coupon_code" name="coupon_code"
                                                placeholder="Coupon Code" title="Coupon Code" style="width: 150px;"
                                                value="<?= $row_tab5['coupon_code'] ?>" /></td>
                                        <td><input type='number' id="amount" name="amount" placeholder="*Amount"
                                                class="form-control" title="Amount" style="width: 100px;"
                                                value="<?= $row_tab5['offer_amount'] ?>" /></td>
                                        <td><select name="agent_type<?= $count ?>-u" id="agent_type<?= $count ?>-u"
                                                style="width: 150px" class="form-control app_select2" title="Agent Type"
                                                multiple>
                                                <?php
                            ...
                            ?>
                                        ...
                                        <td><input type="hidden" id="entry_id" name="entry_id"
                                                value='<?= $row_tab5['entry_id'] ?>' /></td>
                                    </tr>
                                    <script>
            ...
            <div class="row text-center mg_tp_20 mg_bt_150">
                <div class="col-xs-12">
                    ...
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-success" id="btn_price_update"><i
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
            ...
            data: {
                ...
                hotel_type_array: hotel_type_array,
                min_pax_array: min_pax_array,
                max_pax_array: max_pax_array,
                from_date_array: from_date_array,
                to_date_array: to_date_array,
                badult_array: badult_array,
                bcwb_array: bcwb_array,
                bcwob_array: bcwob_array,
                binfant_array: binfant_array,
                cadult_array: cadult_array,
                ccwb_array: ccwb_array,
                cbcwob_array: cbcwob_array,
                cinfant_array: cinfant_array,
                entry_id_array: entry_id_array,
                type_array: type_array,
                offer_from_date_array: offer_from_date_array,
                offer_to_date_array: offer_to_date_array,
                offer_array: offer_array,
                coupon_code_array: coupon_code_array,
                offer_amount_array: offer_amount_array,
                agent_array: agent_array,
                offer_id_array: offer_id_array,
                offer_checked_id_array: offer_checked_id_array,
                bextra_array: bextra_array,
                cextra_array: cextra_array
            },
                        ...
                        callback: function(data1) {
                            if (data1 == "yes") {
                                ...
                                window.location.href = base_url +
                                    'view/custom_packages/master/index.php?activeid=3';
                            }
                        }
                    });
                }

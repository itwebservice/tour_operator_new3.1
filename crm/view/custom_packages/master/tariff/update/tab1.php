                ...
                <div class="row mg_bt_10">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <select name="package_id" id="package_id" title="Package Name" style="width:100%" disabled>
                            ...
                            ?>
                            <option value="<?= $sq_tours['package_id'] ?>">
                                <?php echo $sq_tours['package_name'] . " (" . $sq_tours['total_days'] . "D/" . $sq_tours['total_nights'] . "N )" ?>
                            </option>';
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tbl_package_tariff" name="tbl_package_tariff"
                                class="table table-bordered table-hover table-striped pd_bt_51 no-marg"
                                style="width: 1400px;">
                                <?php
                                $count = 1;
                                ...
                                ?>
                                <tr>
                                    <td><input class="css-checkbox" id="chk_ticket-u<?= $count ?>" type="checkbox"
                                            checked><label class="css-label" for="chk_ticket"> </label></td>
                                    <td><input maxlength="15" value="<?= $count ?>" type="text" name="no"
                                            placeholder="Sr. No." class="form-control" disabled /></td>
                                    <td><select id="hotel_type-u<?= $count ?>" name="form-control" style="width:170px;"
                                            title="Select Hotel Type">
                                            <option value="<?= $row_tours['hotel_type'] ?>">
                                                <?= $row_tours['hotel_type'] ?>
                                            </option>
                                            <?php get_hotel_category_dropdown(); ?>
                                        </select></td>
                                    <td><input type="number" id="min_pax-u<?= $count ?>" class="form-control"
                                            placeholder="*Min Pax" title="Min Pax" style="width:100px;"
                                            value="<?= $row_tours['min_pax'] ?>" /></td>
                                    <td><input type="number" id="max_pax-u<?= $count ?>" class="form-control"
                                            placeholder="*Max Pax" title="Max Pax" style="width:100px;"
                                            value="<?= $row_tours['max_pax'] ?>" /></td>
                                    <td><input type="text" id="from_date-u<?= $count ?>" class="form-control"
                                            placeholder="*From Date" title="Valid From Date" style="width:100px;"
                                            onchange="get_to_date(this.id,'to_date-u<?= $count ?>');"
                                            value="<?= get_date_user($row_tours['from_date']) ?>" /></td>
                                    <td><input type="text" id="to_date-u<?= $count ?>" class="form-control"
                                    ...
                                    <td><input type="number" id="bcwb_cost-u<?= $count ?>" class="form-control"
                                            placeholder="CWB PP" title="CWB PP Cost" style="width:120px;"
                                            value="<?= $row_tours['bcwb'] ?>" /><span>B2B Cost</span></td>
                                    <td><input type="number" id="bcwob_cost-u<?= $count ?>" class="form-control"
                                            placeholder="CWOB PP" title="CWOB PP Cost" style="width:120px;"
                                            value="<?= $row_tours['bcwob'] ?>" /><span>B2B Cost</span></td>
                                    <td><input type="number" id="binfant_cost-u<?= $count ?>" class="form-control"
                                            placeholder="Infant PP" title="Infant PP Cost" style="width:120px;"
                                            value="<?= $row_tours['binfant'] ?>" /><span>B2B Cost</span></td>
                                    <td><input type="number" id="bextra_cost-u<?= $count ?>" class="form-control"
                                            placeholder="ExtraBed PP" title="ExtraBed PP Cost" style="width:120px;"

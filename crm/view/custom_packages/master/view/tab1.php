				    		...
				    		<div class="row">
			        			<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd;">
									...
									<span class="main_block hidden">
										...
										$tour_theme_name = mysqli_fetch_assoc(mysqlQuery("select * from tour_theme where id ='$sq_pckg[tour_theme]'"));
										
										echo '<label>Tour Theme  <em>:</em></label>'.$tour_theme_name['name']; ?> 
				    				</span>
				        		</div>
			        			<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd;">
				        			<span class="main_block">

...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Train Ticket Report')
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, "From Location")
        ->setCellValue('F'.$row_count, "To Location")
        ->setCellValue('G'.$row_count, "Train Name")
        ->setCellValue('H'.$row_count, "Train No")
        ->setCellValue('I'.$row_count, "Class");
...
while($row_ticket =mysqli_fetch_assoc($sq_ticket)){
    ...
    while($sq_entry1 = mysqli_fetch_assoc($sq_entry12)){
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E'.$row_count, $sq_entry1['travel_from'])
            ->setCellValue('F'.$row_count, $sq_entry1['travel_to'])
            ->setCellValue('G'.$row_count, $sq_entry1['train_name'])
            ->setCellValue('H'.$row_count, $sq_entry1['train_no'])
            ->setCellValue('I'.$row_count, $sq_entry1['class']);

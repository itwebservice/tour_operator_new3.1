...
while($row_refund = mysqli_fetch_assoc($sq_refund)){
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E'.$row_count, get_train_ticket_booking_refund_id($row_refund['refund_id'],$year1))
...
header('Content-Disposition: attachment;filename="Train Ticket Booking Refund('.date('d-m-Y H:i').').xls"');

			...
			<div class="panel panel-default panel-body app_panel_style feildset-panel">
				...
				<div class="row mg_bt_10">
					...
					<div class="col-sm-4 col-xs-12 mg_bt_10_sm_xs mg_tp_10">
						...
						<input type="text" id="adult_fair" name="adult_fair" placeholder="Adult Fare" title="Adult Fare" value="<?= $sq_ticket['adult_fair'] ?>" onchange="calculate_total_amount(this.id);validate_balance(this.id)" >
		...
		<div class="row mg_bt_10">
			...
			<!-- <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                <select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"  data-toggle="tooltip" required>
                                    ...
                                    if($sq_ticket['currency_code'] ==''){
                                      $currency_code1 = $currency;
                                    }
                                    else{
                                      $currency_code1= $sq_ticket['currency_code'];
                                    }

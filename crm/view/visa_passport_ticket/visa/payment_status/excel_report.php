...
$currency_amount_3= '';
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('I' . $row_count, number_format($row_visa['visa_issue_amount'], 2))
...
header('Content-Disposition: attachment;filename="VisaSummary(' . date('d-m-Y H:i') . ').xls"');

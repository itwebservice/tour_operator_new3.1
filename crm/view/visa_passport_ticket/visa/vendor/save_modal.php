...
<div class="modal fade" id="save_modal_1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 mg_bt_10">
         ...
         <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="account_name" id="account_name" placeholder="A/c Type" class="form-control" title="A/c Type">
        </div> 
         <div class="col-md-3 col-sm-6 mg_bt_10">

...
<form id="frm_save">
  <div class="row mg_tp_20">
      ...
      <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
          ...
          <a href="<?= $download_url ?>" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" title="Download Passport Copy" class="btn btn-info ico_center" download><i class="fa fa-download"></i>
          </a>
          <?php } ?>
      </div>   
      <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
          ...
          <a href="<?= $pan_url ?>" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" title="Download PAN Card" class="btn btn-info ico_center" download><i class="fa fa-download"></i></a>
          <?php } ?>
      </div> 
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <a href="<?= $pan_url3 ?>" class="btn btn-info ico_center" title="Download Voter Id"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <a href="<?= $pan_url4 ?>" class="btn btn-info ico_center" title="Download Aadhar Card"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
...
function pan_card_upload3()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'group_tour/upload_pan_card_file3.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){
...
function pan_card_upload4()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'group_tour/upload_pan_card_file4.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){
...
function driving_license_upload()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'group_tour/upload_driving_license.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){

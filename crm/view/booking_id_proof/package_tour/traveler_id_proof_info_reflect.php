        ...
        <div class="row mg_tp_20">
          ...
          <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
              ...
              if($sq_traveler_info['id_proof_url']!=""): ?>
                <a href="<?= $download_url2 ?>" class="btn btn-info ico_center" title="Download Passport Copy" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
              <?php endif; ?>
          </div>
          ...
          <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
              ...
              if($sq_traveler_info['pan_card_url']!=""){ ?>
                <a href="<?= $pan_carddownload_url2 ?>" class="btn btn-info ico_center" title="Download PAN Card" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
              <?php } ?>
          </div>
          <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
              <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
              ...
              if($sq_traveler_info['pan_card_url3']!=""){ ?>
                <a href="<?= $pan_carddownload_url2 ?>" class="btn btn-info ico_center" title="Download Voter Id" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
              <?php } ?>
          </div>
          <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
              <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
              ...
              if($sq_traveler_info['pan_card_url4']!=""){ ?>
                <a href="<?= $pan_carddownload_url2 ?>" class="btn btn-info ico_center" title="Download Aadhar Card" style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
              <?php } ?>
          </div>
          <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
              <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
...
function driving_license_upload()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'package_tour/upload_driving_license.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){

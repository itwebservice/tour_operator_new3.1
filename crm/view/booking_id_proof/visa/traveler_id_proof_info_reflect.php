...
<div class="panel panel-default panel-body">
    ...
    <div class="row mg_tp_20">
      ...
      <div class="col-md-4">
        <input type="text" name="issue_date" id="issue_date" title="Issue Date" class="form-control" value="<?= ($sq_traveler_info['issue_date'] == "1970-01-01" || $sq_traveler_info['issue_date'] == "0000-00-00") ? date('d-m-Y'): get_date_user($sq_traveler_info['issue_date']) ?>"  placeholder="Issue Date"  title="Issue Date" onchange="get_to_date(this.id,'expiry_date');">
      </div>
      <div class="col-md-4">
        <input type="text" name="expiry_date" id="expiry_date" title="Expiry Date" class="form-control" value="<?= ($sq_traveler_info['expiry_date'] == "1970-01-01" || $sq_traveler_info['expiry_date'] == "0000-00-00") ? date('d-m-Y'): get_date_user($sq_traveler_info['expiry_date']) ?>"  placeholder="Expiry Date" title="Expiry Date" onchange="validate_validDate('issue_date','expiry_date');">
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            ...
            <a href="<?= $download_url ?>" class="btn btn-info ico_center" title="Download Passport Copy"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        
        <!-- style="padding-top: 15px;padding-left:20px;padding-right: 24px;padding-bottom: 15px;" -->
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <?php if($sq_traveler_info['pan_card_url']!=""): ?>
              <a href="<?= $download_urlpan_card ?>" class="btn btn-info ico_center" title="Download PAN Card"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <?php if($sq_traveler_info['pan_card_url3']!=""): ?>
              <a href="<?= $download_urlpan_card3 ?>" class="btn btn-info ico_center" title="Download Voter Id"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <?php if($sq_traveler_info['pan_card_url4']!=""): ?>
              <a href="<?= $download_urlpan_card4 ?>" class="btn btn-info ico_center" title="Download Aadhar Card"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
        <div class="col-md-2 col-sm-6 mg_tp_20 text_left_xs" style="display:flex;align-items:flex-start;gap:5px;">
            <div class="div-upload" style="margin-bottom: 5px;flex:1;" id="div_upload_button">
            ...
            <?php if($sq_traveler_info['driving_license']!=""): ?>
              <a href="<?= $driving_license_url ?>" class="btn btn-info ico_center" title="Download Driving License"  style="padding: 10px 19px;border-radius:20px;background-color:<?= $theme_color ?>;" download><i class="fa fa-download"></i></a>
            <?php endif; ?>
        </div>
    </div>
...
function pan_card_upload3()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'visa/upload_pan_card_file3.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){
...
function pan_card_upload4()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'visa/upload_pan_card_file4.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){
...
function driving_license_upload()
{
    ...
    new AjaxUpload(btnUpload, {
      action: 'visa/upload_driving_license.php',
      name: 'uploadfile1',
      onSubmit: function(file, ext){

        status.text('');
        var tour_id = $("#fcmb_traveler_id").val();

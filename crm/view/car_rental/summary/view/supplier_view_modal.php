                  ...
                  <tbody>
                    ...
                    while ($row_entry = mysqli_fetch_assoc($sq_query)) {
                      ...
                      if ($row_entry['purchase_return'] == 0) {
                        ...
                        $p_purchase = ($row_entry['net_total'] - (float)($cancel_estimate[0]->net_total));
                        $total_purchase = $p_purchase;
                      }


                      // currency conversion
                          $currency_amount3 = currency_conversion($currency,$row_entry['currency_code'],$total_purchase);
                          if($row_entry['currency_code'] !='0' && $currency != $row_entry['currency_code']){
                            $currency_amount = ' ('.$currency_amount3.')';
                          }else{
                            $currency_amount = '';
                          }
                      $count++;
                    ?>
                      <tr>
                        ...
                        <td><?php echo number_format($total_purchase, 2).$currency_amount; ?></td>
                      </tr>
                    <?php
                    }
                    ?>

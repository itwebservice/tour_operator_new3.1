        ...
        <div class="modal-dialog modal-lg" role="document" style="width: 95% !important;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">New Car Rental Booking</h4>
                </div>
                <div class="modal-body">
                    <div class="panel panel-default panel-body app_panel_style feildset-panel">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10_sm_xs">
                                <select name="customer_id" id="customer_id" class="customer_dropdown"
                                    title="Select Customer" style="width:100%"
                                    onchange="customer_info_load('');get_auto_values('balance_date','basic_amount','payment_mode','service_charge','markup_cost','save','true','service_charge');">
                            ...
                            <div id="cust_details">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <input type="text" id="company_name1" class="hidden form-control"
                                        name="company_name" title="Company Name" placeholder="Company Name" readonly>
                                </div>
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <input type="text" id="credit_amount" class="hidden form-control"
                                        name="credit_amount" placeholder="Credit Note Balance"
                        ...
                        <div class="row mg_tp_10">
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <input type="text" id="pass_name" name="pass_name" class="form-control"
                                    title="Guest Name" placeholder="Guest Name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12 ">
                                <select name="quotation_id" id="quotation_id" style="width:100%"
                                    ...
                                    <?php
                                    $query = "SELECT * FROM `car_rental_quotation_master` where 1 and status='1' ";
                                    ...
                                    while ($row_enq = mysqli_fetch_assoc($sq_enq)) {
                                        ...
                                        $year = $yr[0];
                                    ?>
                                    <option value="<?= $row_enq['quotation_id'] ?>">
                                        <?= get_quotation_id($row_enq['quotation_id'], $year) . ': ' . $row_enq['customer_name'] ?>
                                    </option>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <select name="vehicle_name" id="vehicle_name" title="Vehicle Name" class="form-control"
                                    onchange="get_car_cost();get_capacity(this.id,'')">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <select name="travel_type" id="travel_type" title="Travel Type" class="form-control"
                                    onchange="reflect_feilds();get_car_cost();">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="capacity" name="capacity"
                                    onchange="validate_balance(this.id);calculate_total_fees(this.id)"
                                    placeholder="Capacity" title="Capacity" class="form-control">
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="number" id="total_pax" name="total_pax"
                                    onchange="validate_balance(this.id);calculate_total_fees(this.id);"
                                    placeholder="No Of Pax" title="No Of Pax" class="form-control" pattern="[0-9]+">
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <textarea type="text" name="local_places_to_visit" class="form-control"
                                    id="local_places_to_visit"
                                    onchange="validate_spaces(this.id);calculate_total_fees(this.id)"
                                    placeholder="Route" title="Route" rows="1"></textarea>

                                <input type="text" id="places_to_visit" name="places_to_visit"
                                    class="form-control route_suggest" placeholder="Route" title="Route"
                                    onchange="get_car_cost();">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="from_date" name="from_date" placeholder="From Date"
                                    title="From Date" value="<?= date('d-m-Y') ?>" class="form-control"
                                    onchange="get_to_date(this.id,'to_date');total_days_reflect();calculate_total_fees(this.id)">
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="to_date" name="to_date" placeholder="To Date" title="To Date"
                                    value="<?= date('d-m-Y') ?>" class="form-control"
                                    onchange="validate_validDate('from_date','to_date');total_days_reflect();calculate_total_fees(this.id)">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="total_hrs" name="total_hrs" placeholder="Total Hrs"
                                    title="Total Hrs" class="form-control">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="days_of_traveling"
                                    onchange="validate_balance(this.id);calculate_total_fees(this.id);"
                                    name="days_of_traveling" class="form-control" placeholder="Days Of Travelling"
                                    title="Days Of Travelling">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="extra_km" name="extra_km" class="text-right form-control"
                                    placeholder="Extra Km Rate" title="Extra KM Rate"
                                    onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="extra_hr_cost" name="extra_hr_cost"
                                    class="text-right form-control" placeholder="Extra Hr Rate" title="Extra Hr Rate"
                                    onchange="calculate_total_fees(this.id);validate_balance(this.id);">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="total_max_km" name="total_max_km" placeholder="Total Max Km"
                                    title="Total Max Km" class="text-right form-control">
                                <input type="text" id="total_km" name="total_km" placeholder="Total Km" title="Total Km"
                                    class="form-control">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="traveling_date" name="traveling_date"
                                    placeholder="Travelling Date" title="Travelling Date"
                                    onchange="calculate_total_fees(this.id);">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="panel panel-default panel-body app_panel_style feildset-panel">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <input type="text" id="driver_allowance" name="driver_allowance"
                                            placeholder="Driver Allowance" class="text-right form-control"
                                            title="Driver Allowance"
                                            onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <input type="text" id="permit_charges" name="permit_charges"
                                            class="text-right form-control" placeholder="Permit Charges"
                                            title="Permit Charges"
                                            onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <input type="text" id="toll_and_parking" name="toll_and_parking"
                                            class="text-right form-control" placeholder="Toll & Parking"
                                            title="Toll & Parking"
                                            onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <input type="text" id="state_entry_tax" name="state_entry_tax"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" name="service_charge" id="service_charge"
                                            ...
                                            onchange="validate_balance(this.id);get_auto_values('balance_date','basic_amount','payment_mode','service_charge','markup_cost','save','true','service_charge')">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <small>&nbsp;</small>
                                    ...
                                    <small id="markup_show">&nbsp;</small>
                                     ...
                                     <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10" style="margin-top:15px !important;">
                            <select name="currency_code" id="currency_code1" title="Currency" style="width:100%" class="form-control app_select2" data-toggle="tooltip" required>
                                <?php
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="payment_amount" name="payment_amount" class="form-control"
                                    ...
                                    onchange="payment_amount_validate(this.id,'payment_mode','transaction_id', 'bank_name','bank_id');validate_balance(this.id);get_credit_card_charges('identifier','payment_mode','payment_amount','credit_card_details','credit_charges');">
                            </div>
                        </div>
                        ...
                        <div class="row mg_bt_10">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <select name="bank_id" id="bank_id" title="Select Bank" disabled class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-9">
                                <span style="color: red;line-height: 35px;" data-original-title="" title="" class="note"
                                    class="form-control"><?= $txn_feild_note ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col-xs-12">
                            <button id="btn_booking_save" class="btn btn-sm btn-success"><i
...
$('#from_date,#to_date,#total_hrs,#total_km,#total_max_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#local_places_to_visit,#places_to_visit,#traveling_date')
    .hide();
...
function reflect_feilds() {
    ...
    if (type == 'Local') {
        ...
        $('#total_max_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#places_to_visit,#traveling_date')
            .hide();
    }
    if (type == 'Outstation') {
        $('#total_hrs,#total_km,#local_places_to_visit').hide();
        $('#from_date,#to_date,#total_max_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#places_to_visit,#traveling_date')
            .show();
    }
}

function business_rule_load() {
    get_auto_values('balance_date', 'basic_amount', 'payment_mode', 'service_charge', 'markup_cost', 'save', 'true',
        'service_charge', false, true);
}
$(function() {
    $('#frm_booking_save').validate({
        ...
        submitHandler: function(form, e) {
            // e.preventDefault();
            $('#btn_booking_save').prop('disabled', true);
            ...
            if (payment_mode == "Advance") {
                ...
                $('#btn_booking_save').prop('disabled', false);
                return false;
            }
                ...
                if (data !== 'valid') {
                    ...
                    $.post(base_url + 'view/load_data/finance_date_validation.php', {
                        ...
                        if (data !== 'valid') {
                            ...
                            function saveData() {
                                $.post(base_url +
                                    'controller/car_rental/booking/booking_save.php', {
                                        emp_id: emp_id,
                                    ...
                                    function(result) {
                                        ...
                                        if (msg[0] == 'error') {
                                            ...
                                            $('#btn_booking_save').button(
                                                'reset');
                                            $('#booking_save_modal').modal(
                                                'hide');
                                            msg_alert(msg1[0]);
                                            booking_list_reflect();
                                            window.open(base_url +
                                                'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Car Rental&amount=' +
                                                basic_amount +
                                                '&booking_id=' + msg1[1]);
                                            setTimeout(() => {
                                                if ($(

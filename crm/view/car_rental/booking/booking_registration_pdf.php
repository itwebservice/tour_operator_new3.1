...
// $pdf->Image($call_icon, $pdf->GetX(), $pdf->GetY(), 6); // Adjust width and position
// $pdf->SetXY($pdf->GetX() + 8, $pdf->GetY() - 6); 
...
$y_pos = $pdf->getY(); // Get the current Y-position after phone number
$pdf->SetXY(10, $y_pos + 4); 
...
$total_cost1 = currency_conversion($currency,$sq_booking['currency_code'],$total_cost);
$total_cost = currency_conversion($currency,$currency,$total_cost).'('.$total_cost1.')';

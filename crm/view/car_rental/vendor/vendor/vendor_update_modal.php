...
$sq_vendor = mysqli_fetch_assoc(mysqlQuery("select * from car_rental_vendor where vendor_id='$vendor_id'"));
$vendor_name = addslashes($sq_vendor['vendor_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Car Rental Vendor'"));
...
<div class="modal fade" id="vendor_update_modal"  data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Update Vehicle Supplier Details</h4>
      </div>
      <div class="modal-body">
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_10">
        <legend>Vehicle Supplier Information</legend>
        <div class="row">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30 hidden">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-sm-6 mg_bt_10">
            <input type="text" id="account_name1" name="account_name1" placeholder="A/c Type" title="A/c Type" value="<?= $sq_vendor['account_name'] ?>">
          </div>
          <div class="col-sm-3 col-sm-6 mg_bt_10">
           ...
           <div class="row mg_bt_10">
            ...
            <div class="row"><div class="col-md-12"><div class="table-responsive">
                <table id="tbl_dynamic_car_rental_vehicle1" name="tbl_dynamic_car_rental_vehicle1" class="table table-bordered no-marg">
                  <?php 
                  $count = 0;
                  $sq_vehivle_entry = mysqlQuery("select * from car_rental_vendor_vehicle_entries where vendor_id='$vendor_id'");
                  while($row_vehicle_entry = mysqli_fetch_assoc($sq_vehivle_entry)){
                    $count++;
                    ?>
                   <tr>
...
$(document).ready(function() {
    $("#cust_state1").select2({
      dropdownParent: $("#vendor_update_modal")});
      $('.app_select2').select2();

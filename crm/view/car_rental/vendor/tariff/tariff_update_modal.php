...
$sq_vendor = mysqli_fetch_assoc(mysqlQuery("select * from car_rental_tariff_entries where entry_id='$entry_id'"));
if($role!='Admin' && $role!="Branch Admin"){ $value="readonly"; }
?>

<div class="modal fade" id="vendor_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_10">
                        ...
                        if($sq_vendor['tour_type']=="Local"){?>
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-sm-6 mg_bt_10" >
                                    <select name="local_status" id="local_status" data-toggle="tooltip" title="Status" class="form-control">
                                        <?php if($sq_vendor['status']!=''){ ?> <option value="<?= $sq_vendor['status'] ?>"><?=$sq_vendor['status']?></option> <?php } ?>
                                        <?php if($sq_vendor['status']!='Active'){ ?><option value="Active">Active</option><?php } ?>
                                        <?php if($sq_vendor['status']!='Inactive'){ ?><option value="Inactive">Inactive</option><?php } ?>
                                    </select>
                                </div>
                                <div class="col-sm-3 col-sm-6 mg_bt_10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-sm-6 mg_bt_10">
                                    <input type="text" id="total_days" name="total_days" data-toggle="tooltip" placeholder="Total Days" title="Total Days" class="form-control" value="<?= $sq_vendor['total_days']?>"/>
                                </div>
                                <div class="col-sm-3 col-sm-6 mg_bt_10">
                                ...
                                <div class="col-sm-3 col-sm-6 mg_bt_10">
                                    <input type="text" id="toll_parking" name="toll_parking" data-toggle="tooltip" placeholder="Toll & Parking Charges" title="Toll & Parking Charges" class="form-control" value="<?= $sq_vendor['toll_parking']?>"/>
                                </div>
                                <div class="col-sm-3 col-sm-6 mg_bt_10">
                        ...
                        <div class="row text-center mg_bt_10 mg_tp_10">
                            <div class="col-md-12">
                                <button class="btn btn-sm btn-success" id="tbtn_update"><i class="fa fa-floppy-o"></i>&nbsp;&nbsp;Update</button>
                            </div>
                        </div> 
                    </div>
                </form>

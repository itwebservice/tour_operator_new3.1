...
<div class="modal fade profile_box_modal" id="car_rental_view_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      		...
      		<div class="modal-body profile_box_padding">
				  ...
				  <!-- Nav tabs -->
				  	<ul class="nav nav-tabs" role="tablist">
				    	<li role="presentation" class="active"><a href="#basic_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Vehicle Tariff Information</a></li>
											...
											<div class="profile_box main_block">
                                                ...
                                                <?php }else{ ?>
								        				...
								        				<span class="main_block">
														 ...
														 <span class="main_block"> 
								        					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
								        				    <?php echo "<label>Travel Type  <em>:</em></label> " .$sq_vendor['tour_type']; ?>
								        				</span>
								        				...
								        				<span class="main_block">
								        					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
								        				    <?php echo "<label>Toll & Parking Charges <em>:</em></label> " .$sq_vendor['toll_parking']; ?> 
								        				</span>
                                                        <span class="main_block">
								        					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
								        				    <?php echo "<label>State Entry Charge <em>:</em></label> " .$sq_vendor['state_entry_pass']; ?> 
								        				</span>
                                                        <span class="main_block">
								        					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>

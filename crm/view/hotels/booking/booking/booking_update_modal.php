        ...
        <div class="modal-dialog modal-lg" role="document" style="width: 95% !important;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="booking_id1" name="booking_id" value="<?= $booking_id ?>">
                    <input type="hidden" id="hotel_sc1" name="hotel_sc" value="<?php echo $reflections[0]->hotel_sc ?>">
                    <input type="hidden" id="hotel_markup1" name="hotel_markup" value="<?php echo $reflections[0]->hotel_markup ?>">
                    <input type="hidden" id="hotel_taxes1" name="hotel_taxes" value="<?php echo $reflections[0]->hotel_taxes ?>">
                    <input type="hidden" id="hotel_markup_taxes1" name="hotel_markup_taxes" value="<?php echo $reflections[0]->hotel_markup_taxes ?>">
                    <input type="hidden" id="hotel_tds1" name="hotel_tds"  value="<?php echo $reflections[0]->hotel_tds ?>">
                    ...
                    <?php
                    if($sq_booking['quotation_id'] != ''){
                        ?>
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_20">
                        <legend>Quotation Details</legend>
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <input type="text" value="<?= $sq_booking['quotation_id'] ?>" readonly/>
                            </div>
                        </div>
                    </div>
                    <?php }
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-responsive" id="hotel_booking_wrap">
                                    <?php $prefix = "_u"; ?>
                                    <table id="tbl_hotel_booking_update"
                                        ...
                                        <tr class="<?= $bg ?>">
                                            ...
                                            <?php }?>    
                                            <td><input type="text" style="width:150px;" class="app_datetimepicker"
                                                    id="check_in<?= $prefix . $count ?>_f"
                                                    name="check_in<?= $prefix . $count ?>_f"
                                                    placeholder="Check-In Date Time" title="Check-In Date Time"
                                                    onchange="get_to_datetime(this.id,'check_out<?= $prefix . $count ?>_f');calculate_total_nights(this.id, 'check_out<?= $prefix . $count ?>_f','no_of_nights<?= $prefix . $count ?>_f')"
                                                    value="<?= date('d-m-Y H:i', strtotime($row_entry['check_in'])) ?>">
                                            </td>
                                            <td><input type="text" style="width:150px;" class="app_datetimepicker"
                                                    id="check_out<?= $prefix . $count ?>_f"
                                                    name="check_out<?= $prefix . $count ?>_f"
                                                    onchange="calculate_total_nights('check_in<?= $prefix . $count ?>_f',this.id,'no_of_nights<?= $prefix . $count ?>_f')"
                                                    placeholder="Check-Out Date Time" title="Check-Out Date Time"
                                                    value="<?= date('d-m-Y H:i', strtotime($row_entry['check_out'])) ?>">
                                            </td>
                                            <td><input type="text" style="width:100px;"
                                                    id="no_of_nights<?= $prefix . $count ?>_f"
                                                    name="no_of_nights<?= $prefix . $count ?>_f"
                                            ...
                                            <?php }?>
                                            <td><select name="accomodation_type<?= $prefix . $count ?>_f"
                                                    style="width:150px;" id="accomodation_type<?= $prefix . $count ?>_f"
                                                    title="Accommodation Type">
                                                    <?php if ($row_entry['accomodation_type'] != '') { ?>
                                                    <option value="<?= $row_entry['accomodation_type'] ?>">
                                                        <?= $row_entry['accomodation_type'] ?></option>
                                                    <?php } ?>
                                            ...
                                            <td><input type="text" id="extra_beds<?= $prefix . $count ?>_f"
                                                    style="width:100px;" name="extra_beds<?= $prefix . $count ?>_f"
                                                    placeholder="Extra Beds" title="Extra Beds"
                                                    onchange="number_validate(this.id)"
                                                    value="<?= $row_entry['extra_beds'] ?>"></td>
                                            <td><select title="Meal Plan" id="meal_plan<?= $prefix . $count ?>_f"
                                                    style="width:100px;" name="meal_plan<?= $prefix . $count ?>_f"
                                                    title="Meal Plan" Placeholder="Meal Plan">
                                                    <?php if ($row_entry['meal_plan'] != "") { ?>
                                                    <option value="<?= $row_entry['meal_plan'] ?>">
                                                        <?= $row_entry['meal_plan'] ?></option>
                                                    <?php } ?>
                                                    <?php get_mealplan_dropdown(); ?>
                                                </select></td>
                                            <td><input type="text" id="conf_no<?= $prefix . $count ?>_f"
                                                    style="width:130px;" name="conf_no<?= $prefix . $count ?>_f"
                                                    placeholder="Confirmation No." title="Confirmation No."
                                                    value="<?= $row_entry['conf_no'] ?>"></td>
                                            <td><input type="hidden" value="<?= $row_entry['entry_id'] ?>">
                                            </td>
                                        </tr>
                                        <script>
                    ...
                    foreach ($bsmValues[0] as $key => $value) {
                        switch ($key) {
                        case 'basic':
                            $sub_total = ($value != "") ? $sub_total + $service_tax_amount : $sub_total;
                            $inclusive_b = $value;
                            break;
                        case 'service':
                        ...
                        case 'markup':
                            ...
                            break;
                        case 'discount':
                            $discount = ($value != "") ? $discount + $sq_booking['tds'] : $discount;
                            $inclusive_d = $value;
                            break;
                        }
                    }
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <select title="Select Tax" id="tcs_tax" name="tcs_tax" class="form-control">
											...
											<option value="5" <?php if($sq_booking['tcs_per']==5){ echo "selected"; } ?>>5% TCS</option>
                    ...
                    <div class="row text-center mg_tp_20 mg_bt_20">
                        <div class="col-xs-12">
                            <button class="btn btn-sm btn-success" id="update_btn"><i
...
$('#check_in_u1, #check_out_u1, #check_in_u1_f, #check_out_u1_f').datetimepicker({
    format: 'd-m-Y H:i'
});
...
function customer_details_update() {
    ...
    $.post(base_url + 'view/visa_passport_ticket/train_ticket/home/customer_details_update.php', {
...
function total_fun1() {
    ...
    total = parseFloat(total)+parseFloat(totalTcs);
...
$(function() {
    $('#frm_hotel_booking_update').validate({
        ...
        submitHandler: function(form) {
            ...
            var children_with = $('#children_with1').val();
            ...
            var tcs_tax = $('#tcs1').val();
            var tcs_per = $('#tcs_tax1').val();
            ...
            var hotel_sc = $('#hotel_sc1').val();
            var hotel_markup = $('#hotel_markup1').val();
            var hotel_taxes = $('#hotel_taxes1').val();
            var hotel_markup_taxes = $('#hotel_markup_taxes1').val();
            var hotel_tds = $('#hotel_tds1').val();
            var tax_apply_on = $('#atax_apply_on').val();
            var tax_value = $('#tax_value1').val();
            var markup_tax_value = $('#markup_tax_value1').val();
            var reflections = [];
            console.log(hotel_taxes);
            reflections.push({
                'hotel_sc': hotel_sc,
            ...
            $.post(base_url + 'view/load_data/finance_date_validation.php', {
                ...
                if (data !== 'valid') {
                    ...
                    $.ajax({
                        type: 'post',
                        url: base_url +
                            'controller/hotel/booking/booking_update.php',
                        data: {
                            booking_id: booking_id,
                            customer_id: customer_id,
                            pass_name: pass_name,
                            adults: adults,
                            childrens: childrens,child_with_bed:children_with,
                            infants: infants,
                            sub_total: sub_total,
...
function customTcsTax()
{
    ...
    if(tcs_tax!=='')
    {
       var  subtotal=$("#sub_total1").val();
       var  service_charge=$("#service_charge1").val();
       var discount=$("#discount1").val();

       var txt_actual_tour_cost1=$("#total_fee1").val();
       var  service_tax_amount=0;
       var  tax_subtotal=$("#service_tax_subtotal1").val();
    ...
    if (parseFloat(service_tax_markup) !== 0.00 && (service_tax_markup) !== "") {
	   ...
	   var service_charge_amt=parseFloat(service_charge)-parseFloat(discount);
       var tdsamount=parseFloat(parseFloat(service_tax_amount)+parseFloat(service_charge_amt)+parseFloat(subtotal)+parseFloat(markup)+parseFloat(markupservice_tax_amount))*parseFloat(tcs_tax)/100;
       var totalTds=$("#tcs1").val();
       if(totalTds=='')
       {
        totalTds=0;   
       }
       $("#tcs1").val(tdsamount.toFixed(2));

       txt_actual_tour_cost1=parseFloat(txt_actual_tour_cost1)-parseFloat(totalTds);
       var txt_actual_tour_cost1total=parseFloat(tdsamount)+parseFloat(txt_actual_tour_cost1);
       $("#total_fee1").val(txt_actual_tour_cost1total.toFixed(2));
    }
    else
    {
        var totalTds=$("#tcs1").val();
        $("#tcs1").val(0.00);
        var txt_actual_tour_cost1=$("#total_fee1").val();
        var txt_actual_tour_cost1total=parseFloat(txt_actual_tour_cost1)-parseFloat(totalTds);
        $("#total_fee1").val(txt_actual_tour_cost1total.toFixed(2));
    }    

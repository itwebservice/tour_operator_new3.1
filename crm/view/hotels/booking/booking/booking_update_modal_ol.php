        ...
        <div class="modal-dialog modal-lg" role="document" style="width: 95% !important;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="hotel_markup1" name="hotel_markup"
                        value="<?php echo $reflections[0]->hotel_markup ?>">
                    <input type="hidden" id="hotel_taxes1" name="hotel_taxes"
                        value="<?php echo $reflections[0]->hotel_taxes ?>">
                    <input type="hidden" id="hotel_markup_taxes1" name="hotel_markup_taxes"
                        value="<?php echo $reflections[0]->hotel_markup_taxes ?>">
                    <input type="hidden" id="hotel_tds1" name="hotel_tds"
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="tds1" name="tds1" placeholder="TDS" title="TDS"
                                    onchange="total_fun1();validate_balance(this.id)" value="<?= $sq_booking['tds'] ?> "
                                    <?= $readonly ?>>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="number" name="tcs_tax" id="tcs_tax1" placeholder="TCS"
                                    value="<?= $sq_booking['tcs_tax'] ?>" title="TCS"
                                    onchange="total_fun1();validate_balance(this.id)" <?= $tcs_readonly ?> />
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" name="total_fee1" id="total_fee1"
                                    class="amount_feild_highlight text-right" placeholder="Net Total" title="Net Total"
                                    value="<?= $sq_booking['total_fee'] ?>" readonly>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" name="due_date1" id="due_date1" placeholder="Due Date"
                                    title="Due Date" value="<?= get_date_user($sq_booking['due_date']) ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <select name="currency_code" id="acurrency_code1" title="Currency" style="width:100%"
...
function total_fun1() {
    ...
    sub_total = ($('#basic_show1').html() == '&nbsp;') ? sub_total : parseFloat($('#basic_show1').text().split(' : ')[
        1]);
    service_charge = ($('#service_show1').html() == '&nbsp;') ? service_charge : parseFloat($('#service_show1').text()
        .split(' : ')[1]);
    markup = ($('#markup_show1').html() == '&nbsp;') ? markup : parseFloat($('#markup_show1').text().split(' : ')[1]);
    discount = ($('#discount_show1').html() == '&nbsp;') ? discount : parseFloat($('#discount_show1').text().split(
        ' : ')[1]);

...
$client_modal_type = isset($_POST['client_modal_type']) ? $_POST['client_modal_type'] : null;
?>
            ...
            <div class="modal-body">
                <form id="frm_hotel_save">
                    <div class="panel panel-default panel-body app_panel_style feildset-panel">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-6 mg_bt_10 ">
                                <select name="rating_star" id="rating_star" class="form-control" title="Hotel Category" style='width:100%' class="app_select2">
                            ...
                            <div class="col-md-2 col-sm-6 mg_bt_10 ">
                                <select name="hotel_type" id="hotel_type" title="Hotel Type" style='width:100%' style='width:100%' class="form-control app_select2">
                            ...
                            <div class="col-md-8 col-sm-6 mg_bt_10 ">
                                <textarea id="txt_hotel_address" onchange="validate_address(this.id);" name="txt_hotel_address" style="height: 42px !important;" placeholder="Hotel Address" class="form-control" title="Hotel Address" rows="1"></textarea>
                            </div>
                            <div class="col-sm-2 mg_bt_10">
                                <input class="form-control" type="number" id="opening_balance" name="opening_balance" placeholder="*Opening Balance" title="Opening Balance" value="0">
                            </div>
                            <div class="col-md-2 col-sm-6 mg_bt_10">
                                <select class="form-control" name="side" id="side" title="Balance side" data-toggle='tooltip' style="width:100%;" class="app_select2">
                    ...
                    <div class="hidden panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-2 col-sm-6 mg_bt_10 ">
                                <input type="text" id="account_name" name="account_name" placeholder="A/c Type" title="A/c Type">
                            </div>
                            <div class="col-md-2 col-sm-6 mg_bt_10 ">
                                    ...
                                    <div class="panel panel-default main_block">
                                        <div class="panel-heading main_block" role="tab" id="heading1">
                                            <div class="Normal collapsed main_block" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="false" aria-controls="collapse1" id="collapsed1">
                                                <div class="col-md-12"><span><em style="margin-left: 15px;"><?php echo "Hotel Amenities and Policies"; ?></em></span>
                                                </div>
                                            </div>
                                        </div>
        ...
        new AjaxUpload(btnUpload, {
            ...
            onComplete: function(file, response) {
                ...
                if (img_array.length > 10) {
                    error_msg_alert("Sorry, you can upload up to 10 images");
                    return false;
                }
    ...
    $(function() {
        $('#frm_hotel_save').validate({
            ...
            submitHandler: function(form) {
                ...
                if (((parseInt(cwob_from) == 0 || cwob_from == '') && (parseInt(cwob_to) == 0 ||
                        cwob_to == '')) && ((parseInt(cwb_from) == 0 || cwb_from == '') && (parseInt(
                        cwb_to) == 0 || cwb_to == ''))) {
                    error_msg_alert(
                        'Enter Child With Bed & Child Without Bed Age in Hotel Amenities & Policies'
                    );
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For missing Age Without Bed And With Bed (Full Blank)
                if (((parseInt(cwob_from) == 0 || cwob_from == '') && (parseInt(cwob_to) == 0 ||
                        cwob_to == '')) && ((parseInt(cwb_from) != 0 || cwb_from != '') && (parseInt(
                        cwb_to) != 0 || cwb_to != ''))) {
                    error_msg_alert(
                        'Enter Child Without Bed From Age & To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> Without Bed(To Blank,From Blank)
                if (((parseInt(cwob_from) != 0 || cwob_from != '') && (parseInt(cwob_to) != 0 ||
                        cwob_to != '')) && ((parseInt(cwb_from) == 0 || cwb_from == '') && (parseInt(
                        cwb_to) == 0 || cwb_to == ''))) {
                    error_msg_alert(
                        'Enter Child With Bed From Age & To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> With Bed(To Blank,From Blank)
                if (((parseInt(cwob_from) == 0 || cwob_from == '') && (parseInt(cwob_to) != 0 ||
                        cwob_to != '')) && ((parseInt(cwb_from) == 0 || cwb_from == '') && (parseInt(
                        cwb_to) != 0 || cwb_to != ''))) {
                    error_msg_alert(
                        'Enter Child Without Bed From Age & With Bed From Age in Hotel Amenities & Policies'
                    );
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> Without Bed(From Blank) With Bed(From Blank)
                if (((parseInt(cwob_from) != 0 || cwob_from != '') && (parseInt(cwob_to) == 0 ||
                        cwob_to == '')) && ((parseInt(cwb_from) != 0 || cwb_from != '') && (parseInt(
                        cwb_to) == 0 || cwb_to == ''))) {
                    error_msg_alert(
                        'Enter Child Without Bed To Age & With Bed To Age in Hotel Amenities & Policies'
                    );
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> Without Bed(To Blank) With Bed(To Blank)  
                if (((parseInt(cwob_from) != 0 || cwob_from != '') && (parseInt(cwob_to) == 0 ||
                        cwob_to == '')) && ((parseInt(cwb_from) == 0 || cwb_from == '') && (parseInt(
                        cwb_to) != 0 || cwb_to != ''))) {
                    error_msg_alert(
                        'Enter Child Without Bed To Age & With Bed From Age in Hotel Amenities & Policies'
                    );
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> Without Bed(To Blank) With Bed(From Blank)  
                if (((parseInt(cwob_from) == 0 || cwob_from == '') && (parseInt(cwob_to) != 0 ||
                        cwob_to != '')) && ((parseInt(cwb_from) != 0 || cwb_from != '') && (parseInt(
                        cwb_to) == 0 || cwb_to == ''))) {
                    error_msg_alert(
                        'Enter Child Without Bed From Age & With Bed To Age in Hotel Amenities & Policies'
                    );
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                } // For Missing Age -> Without Bed(From Blank) With Bed(To Blank) 
                if (parseInt(cwb_from) == 0 || cwb_from == '') {
                    error_msg_alert('Enter Child With Bed From Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseInt(cwb_to) == 0 || cwb_to == '') {
                    error_msg_alert('Enter Child With Bed To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseInt(cwob_from) == 0 || cwob_from == '') {
                    error_msg_alert('Enter Child Without Bed From Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseInt(cwob_to) == 0 || cwob_to == '') {
                    error_msg_alert('Enter Child Without Bed To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseInt(cwb_from) > parseInt(cwb_to) || parseInt(cwob_to) == parseInt(cwb_from)) {
                    error_msg_alert('Invalid Child With Bed From-To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseInt(cwob_from) > parseInt(cwob_to)) {
                    error_msg_alert(
                        'Invalid Child Without Bed From-To Age in Hotel Amenities & Policies');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                if (parseFloat(cwob_to) > parseFloat(cwb_from)) {
                    error_msg_alert('Invalid Child Without-Bed and With-Bed Ages');
                    $('#accordion').css({
                        border: '1px solid red'
                    });
                    return false;
                ...
                $.post(
                    base_url + "controller/hotel/hotel_master_save_c.php", {
                        ...
                        immergency_contact_no: immergency_contact_no,
                        ...
                        supp_pan: supp_pan,
                        hotel_image_path: hotel_image_path,

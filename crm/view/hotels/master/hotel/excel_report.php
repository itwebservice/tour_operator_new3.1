...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C3', !empty($sq_city['city_name']) ? $sq_city['city_name'] : null)
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('R'.$row_count, "Personal Identification No(PIN)")
...
header('Content-Disposition: attachment;filename="Hotel_Supplier('.date('d-m-Y H:i').').xls"');

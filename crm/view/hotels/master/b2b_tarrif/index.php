...
<div class="app_panel_content Filter-panel">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
            <input type="text" placeholder="From date" title="From Date" class="form-control" id="from_date_filter" data-toggle="tooltip" onchange="get_to_datetime(this.id,'to_date_filter')" />
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
            <div class="datepicker-wrap">
            <input type="text" placeholder="To date" title="To Date" class="form-control" id="to_date_filter" data-toggle="tooltip" onchange="validate_validDatetime('from_date_filter','to_date_filter')" />
            </div>
        </div>

        ...
        <div class="container-fluid">
            <div class="app_panel_content Filter-panel" style="overflow-x:hidden;">
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    <legend>Tariff for Hotel</legend>
                    ...
                    <div class="row mg_bt_10">
                        <div class="col-md-12 text-right text_center_xs">
                            <div class="col-md-6 text-left">
                                <button type="button" class="btn btn-sm btnType st-custBtn" onclick="seasonal_csv();" data-toggle="tooltip" title="Download CSV"><i class="icon fa fa-download"></i>CSV
                                    Format</button>

                                <div class="div-upload  mg_bt_20" data-toggle="tooltip" title="Upload CSV" id="div_upload_button1">
                                    <div id="b2btariff_csv_upload" role='button'><span>CSV</span>
                                    </div>

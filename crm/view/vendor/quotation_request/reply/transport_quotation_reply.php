...
<div class="panel panel-default panel-body app_panel_style feildset-panel" style="margin-bottom: 30px;">
	...
	<div class="main_block mg_tp_20">
		...
		<div class="col-md-6 no-pad">
			<textarea id="txt_enquiry_specification" name="txt_enquiry_specification" placeholder="Other Comments" class="feature_editor" title="Other Comments"></textarea>
		</div>
...
{
  var trans_cost = $('#txt_trans').val();

  if(trans_cost==""){ trans_cost = 0;}
   
  $('#txt_cost').val(trans_cost);
 ...
 $(function(){
  $('#frm_enquiry_save').validate({
    ...
    submitHandler:function(form){
		...
		$.ajax({
			type:'post',
			url: base_url+'../../../../../../controller/vendor/quotation_request/quotation_reply_save.php',
			data:{transport_cost : transport_cost, total_cost : total_cost ,enquiry_spec : enquiry_spec, request_id : request_id, supplier_id : supplier_id , created_by : created_by, currency_code : currency_code, enquiry_id : enquiry_id},

...
$sq_req = mysqli_fetch_assoc(mysqlQuery("select * from vendor_reply_master where id='$id'"));
$sq_currency1 = mysqli_fetch_assoc(mysqlQuery("select * from currency_name_master where id = '$sq_req[currency_code]'"));

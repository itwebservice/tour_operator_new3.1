...
$sq_vendor = mysqli_fetch_assoc(mysqlQuery("select * from other_vendors where vendor_id='$vendor_id'"));
$vendor_name = addslashes($sq_vendor['vendor_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_vendor[mobile_no]' and vendor_type='Other Vendor'"));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Other Supplier Details</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input class="form-control" type="number" id="opening_balance" name="opening_balance" placeholder="*Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" >
          </div>   
          <div class="col-md-3 col-sm-6 mg_bt_10">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30 hidden">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="supp_pan" name="supp_pan" onchange="validate_alphanumeric(this.id)" value="<?= $sq_vendor['pan_no']?>" placeholder="Personal Identification No(PIN)" title="Personal Identification No(PIN)" style="text-transform: uppercase;">
            </div>
          
          <div class="col-sm-3 mg_bt_10">
            <input class="hidden" type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_vendor['as_of_date']) ?>">
          </div>
        </div>
      </div>

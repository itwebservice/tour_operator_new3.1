...
<div class="container">
    ...
    <form id="frm_save" class="mg_tp_20">
	    ...
	    <div class="row mg_bt_20">
	        <div class="answer_wrap">
	            <h4>3. Quality of Transport Services</h4>
	          <div class="col-md-12">
	           ...
	           <div class="col-md-12">
	                ...
	                <input type="radio" id="unacceptable5" name="ticket_info" value="Unacceptable"><label for="unacceptable">Unacceptable</label>
	           </div>
	          </div>
	        </div>
	    </div>
	     ...
	     <div class="row mg_bt_20">
	        <div class="answer_wrap">
	            <h4>4. Quality of Accommodation Services</h4>
	          <div class="col-md-12">
	           ...
	           <div class="col-md-12">
	            ...
	            <div class="col-md-12 mg_tp_10">
	              <h4>b) How would you rate your accommodations for Hygiene & Cleanliness?</h4>
	                 <div class="col-md-12">
	             ...
	             <div class="col-md-12">
	            <h4>c) How was the quality & quantity of meal?</h4>
	           <div class="col-md-12">

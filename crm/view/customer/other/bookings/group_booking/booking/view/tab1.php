<div class="row">
	...
	<div class="col-sm-6 right_border_none_sm mg_bt_20" style="border-right: 1px solid #ddd">
		...
		<div class="profile_box main_block" style="min-height: 166px;">
    	 	...
    	 	$sql = $query = mysqli_fetch_assoc(mysqlQuery("select * from tour_master where tour_id='$tour_id'"));?>
			...
			$sq_group = mysqli_fetch_assoc(mysqlQuery("select * from tour_groups where group_id='$tour_group_id'"));
	...
	<div class="col-sm-6 mg_bt_20">
		...
		<div class="profile_box main_block" style="min-height: 156px;">
			...
			<?php  
				...
				$sq_traveler_personal_info = mysqli_fetch_assoc(mysqlQuery("select * from traveler_personal_info where tourwise_traveler_id='$id'"));
...
<div class="row">
	...
	<?php 
		...
		$sq_total_mem = mysqli_num_rows(mysqlQuery("select traveler_id from travelers_details where traveler_group_id='$sq_group_info[traveler_group_id]'"));

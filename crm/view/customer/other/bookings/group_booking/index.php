            ...
            <div class="row">
                <div class="panel-body text-center main_block">
                    ...
                    <label for="rd_id_proof" class="app_dual_button">
                        <input type="radio" id="rd_id_proof" name="rd_group_booking" onchange="group_booking_content_reflect()">
                        &nbsp;&nbsp;ID Proof
                    </label>
                </div>
            </div>
...
<script>
    function group_booking_content_reflect() {
        ...
        if(id == "rd_id_proof"){
            $.post('bookings/group_booking/id_proof/index.php', {}, function(data) {
                $('#div_group_booking_content').html(data);
            });
        }
    }

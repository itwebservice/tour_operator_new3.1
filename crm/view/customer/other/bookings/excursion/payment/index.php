...
?>
    ...
    <div class="app_panel_content Filter-panel">
		<div class="row">
			<div class="col-md-3">
				<select name="exc_id_filter1" id="exc_id_filter1" style="width:100%" onchange="exc_payment_list_reflect()">
...
<script>
$('#exc_id_filter1').select2();
	function exc_payment_list_reflect()
	{
		var exc_id = $('#exc_id_filter1').val();
		$.post('bookings/excursion/payment/exc_payment_list_reflect.php', { exc_id : exc_id }, function(data){

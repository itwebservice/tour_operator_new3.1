<div class="row">
	<div class="col-md-4 col-sm-12 col-xs-12">
		<div class="profile_box main_block">
			...
			<?php $sq_customer = mysqli_fetch_assoc(mysqlQuery("select * from customer_master where customer_id='$sq_exc_info[customer_id]'"));
		...
		<div class="profile_box main_block" style="min-height: 141px;">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<?php
					$total_amount = currency_conversion($currency, $sq_exc_info['currency_code'], (float)($sq_exc_info['exc_total_cost']) + (float)($query['sumc']));
					?>
					<span class="main_block">
					...
					<tbody>
						...
						if ($sq_entry_count == 0) {
							...
							while ($row_entry = mysqli_fetch_assoc($sq_entry)) {
								...
								$child_cost1 = currency_conversion($currency, $sq_exc1['currency_code'], $row_entry['child_cost']);
								$total_cost1 = currency_conversion($currency, $sq_exc1['currency_code'], $row_entry['total_cost']);
								$count++;
						?>
								<tr class="<?php echo $bg; ?>">
									...
									<td><?php echo $adult_cost1; ?> </td>
									<td><?php echo $child_cost1; ?> </td>
									<td><?php echo $total_cost1; ?> </td>
								</tr>
						<?php
							}
						}

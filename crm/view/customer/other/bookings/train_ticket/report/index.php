...
?>
    ...
    <div class="app_panel_content Filter-panel">
		<div class="row">		
			<div class="col-md-3">
				<select name="ticket_id_filtert" id="ticket_id_filtert" style="width:100%" onchange="train_ticket_report_list_reflect()">
...
$('#ticket_id_filtert').select2();
	function train_ticket_report_list_reflect()
	{
		var ticket_id = $('#ticket_id_filtert').val();
		$.post('bookings/train_ticket/report/train_ticket_report_list_reflect.php', { ticket_id : ticket_id }, function(data){
			$('#div_ticket_report_list').html(data);
		});
	}
	train_ticket_report_list_reflect();
</script>

				...
				<tbody>
					...
					while ($row_ticket_payment = mysqli_fetch_assoc($sq_ticket_payment)) {
						...
						if ($sq_ticket_info['cancel_type'] == '1') {
							...
							$outstanding = (($total_sale - (float)($cancel_estimate)) + $cancel_amount) - $total_pay_amt;
						} else {

...
<?php 
$sq_t_count = mysqli_num_rows(mysqlQuery("select * from package_tour_transport_master where booking_id='$booking_id'"));
if($sq_t_count > 0){
?>
<div class="row mg_bt_20">
	<div class="col-md-12">
...
<?php
$sq_a_count = mysqli_num_rows(mysqlQuery("select * from package_tour_excursion_master where booking_id='$booking_id'"));
if($sq_a_count > 0){
?>
<div class="row mg_bt_20">
	<div class="col-md-12">

...
?>
    ...
    <div class="app_panel_content Filter-panel">
		<div class="row">
			<div class="col-md-3">
				<select name="booking_id_filterb" id="booking_id_filterb" style="width:100%" onchange="list_reflect()">
...
<script>
$('#booking_id_filterb').select2();
function list_reflect()
{
	var booking_id = $('#booking_id_filterb').val();
	$.post('bookings/bus/payment/list_reflect.php', { booking_id : booking_id }, function(data){
		$('#div_list').html(data);
	});
}
list_reflect();

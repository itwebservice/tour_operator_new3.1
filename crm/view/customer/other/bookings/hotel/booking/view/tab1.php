<div class="row">
	<div class="col-md-6 col-sm-12 col-xs-12 mg_bt_20_xs">
		<div class="profile_box main_block">
				...
				<?php $sq_customer = mysqli_fetch_assoc(mysqlQuery("select * from customer_master where customer_id='$sq_hotel_info[customer_id]'")); 
        		...
        		<div class="row">
				  ...
				  <div class="col-sm-5 col-xs-12">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Child Without Bed <em>:</em></label> ".$sq_hotel_info['childrens']; ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Child With Bed <em>:</em></label> ".$sq_hotel_info['child_with_bed']; ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		 ...
		 <div class="profile_box main_block" style="min-height: 141px;">
	        ...
	        <div class="row">
				 <div class="col-sm-6 col-xs-12">
	        		<span class="main_block">
	                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	                  <div class="highlighted_cost"><?php echo "<label>Net Total <em>:</em></label> ";?> <?php
						$total_fee = currency_conversion($currency,$sq_hotel_info['currency_code'],($sq_hotel_info['total_fee']+$query['sumc']));
						echo $total_fee; ?> </div>
	                </span>
	        		<span class="main_block">
	        		  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
                ...
                <div class="table-responsive">
                    <table id="tbl_dynamic_visa_update" name="tbl_dynamic_visa_update" class="table table-bordered no-marg">
                       ...
                       $sq_hotel_entry = mysqlQuery("select * from hotel_booking_entries where booking_id='$booking_id'");
                    	...
                    	while($row_entry = mysqli_fetch_assoc($sq_hotel_entry)){
							...
							?>
								<tr class="<?= $bg ?>">
								    ...
								    <td><?php echo date('d/m/Y H:i', strtotime($row_entry['check_out'])); ?></td>

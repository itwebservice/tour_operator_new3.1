...
<div class="row">
      <div class="col-sm-4 col-sm-offset-4">
        <select id="fcmb_traveler_id" name="fcmb_traveler_id" title="Passenger Name" style="width:100%;" onchange="traveler_id_proof_info_reflect()" title="Passenger">
            ...
            <?php
            $query = "select * from visa_master_entries where visa_id in (select visa_id from visa_master where delete_status='0' and customer_id='$customer_id') and status != 'Cancel' order by visa_id desc";
...
function traveler_id_proof_info_reflect()
{
    ...
    $.post('bookings/visa/id_proof/traveler_id_proof_info_reflect.php', { entry_id : traveler_id }, function(data){

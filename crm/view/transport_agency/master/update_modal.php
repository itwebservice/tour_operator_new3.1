...
$vendor_name = addslashes($sq_transport_agency['transport_agency_name']);
$sq_vendor_login = mysqli_fetch_assoc(mysqlQuery("select * from vendor_login where username='$vendor_name' and password='$sq_transport_agency[mobile_no]' and vendor_type='Transport Vendor'"));
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Transporter Supplier Details</h4>
      </div>
    ...
    <input type="hidden" id="vendor_login_id" name="vendor_login_id" value="<?= $sq_vendor_login['login_id'] ?>">
		  <div class="row">
		    <div class="col-md-3 col-sm-6 mg_bt_10">
		      <select id="cmb_city_id" name="cmb_city_id" style="width:100%" class="form-control" title="City Name" data-add-new-option="true" data-lazy-city="true">
      ...
      <div class="row">   
        ...
        <div class="col-sm-3 col-xs-6 mg_bt_10">
            <select name="cust_state1" id="cust_state1" title="Select State/Country Name" style="width:100%" required class="app_select2">
              ...
              $sq_state = mysqli_fetch_assoc(mysqlQuery("select * from state_master where id='$sq_transport_agency[state_id]'"));
              ?>
        ...
        <div class="col-md-3 col-sm-6 mg_bt_10">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <select class="form-control" name="side1" id="side1" title="Balance Side">
              ...
              <?php if($sq_transport_agency['side'] != 'Debit'){ ?>
                <option value="Debit">Debit</option>
              <?php }
              if($sq_transport_agency['side'] != 'Credit'){ ?>
    ...
    <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel hidden">
    <legend>Bank Information</legend>
      <div class="row"> 
        ...
        <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="account_name" name="account_name" placeholder="A/c Type" title="A/c Type" value="<?php echo $sq_transport_agency['account_name'] ?>">
        </div> 
        <div class="col-md-3 col-sm-6 mg_bt_10">

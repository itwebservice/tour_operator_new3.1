...
<div class="modal fade" id="save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Activity Supplier Details</h4>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 mg_bt_10">
				<input type="number" id="mobile_no" name="mobile_no" onchange="mobile_validate(this.id);" placeholder="*Mobile No" title="Mobile No" required>
			</div>
			<div class="col-md-3 col-sm-6 mg_bt_10">
                <input type="number" class="form-control" id="landline_no" onchange="mobile_validate(this.id);" name="landline_no" placeholder="Landline Number" title="Landline Number">
            </div> 			
		</div>
		<div class="row">
			<div class="col-md-3 col-sm-6 mg_bt_10">
				<input type="email" class="form-control" id="email_id" name="email_id" placeholder="Email ID" title="Email ID">
			</div>
			<div class="col-md-3 col-sm-6 ">
                <input type="email" class="form-control" id="txt_email_id_1" name="txt_email_id_1"  placeholder="Alternative Email ID 1" title="Alternative Email ID 1" onchange="validate_email(this.id)">
            </div>
			<div class="col-md-3 col-sm-6 ">
                <input type="email" class="form-control" id="txt_email_id_2" name="txt_email_id_2"  placeholder="Alternative Email ID 2" title="Alternative Email ID 2" onchange="validate_email(this.id)">
            </div>
			<div class="col-md-3 col-sm-6 mg_bt_10">
				<input type="text" id="concern_person_name" name="concern_person_name" placeholder="Contact Person" title="Contact Person">
			</div>
			<div class="col-md-3 col-sm-6 mg_bt_10">
            	<input type="number" id="immergency_contact_no" onchange="mobile_validate(this.id);" name="immergency_contact_no" placeholder="Emergency Contact No" title="Emergency Contact No">
			</div> 
			<div class="col-md-3 col-sm-6 mg_bt_10">
			...
			<div class="col-sm-3 col-xs-6 mg_bt_10">
	            <select name="state" id="state" title="Select State/Country Name" style="width:100%" required class="app_select2">

...
?>
<?= begin_panel('Activity Supplier Information',26) ?>
...
<div class="row text-right mg_bt_20">
    <div class="col-md-12">
    	...
    	&nbsp;&nbsp;
        <button class="btn btn-info btn-sm ico_left" id="btn_save_modal" onclick="save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Activity Supplier</button>
    </div>
</div>
...
<div class="app_panel_content Filter-panel">
	<div class="row">
		<div class="col-md-3 col-sm-6 mg_bt_10_sm_xs">
			<select name="city_id_filter" id="city_id_filter" title="City" style="width:100%" onchange="list_reflect()" data-add-new-option="true">
			</select>
		</div>
...
function list_reflect()
{
	...
	$.post('list_reflect.php', { city_id : city_id, active_flag : active_flag }, function(data){

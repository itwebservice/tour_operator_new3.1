      	...
      	<div class="panel panel-default panel-body app_panel_style feildset-panel">
			...
			<div class="row">
				...
				<div class="col-sm-3 col-xs-6 mg_bt_10">
		            <select name="cust_state1" id="cust_state1"  title="Select State/Country Name" placeholder="Select State/Country Name" style="width:100%" required class="app_select2">

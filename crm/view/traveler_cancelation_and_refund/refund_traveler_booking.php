...
$booking_fee = (float)($sq_tourwise['net_total']);

$sale_Amount = $booking_fee - (float)($total_refund_paid);

$refund_amount = (float)($total_amount) - (float)($sale_Amount);
$remaining = (float)($total_refund_paid) - (float)($total_refund1);
?>

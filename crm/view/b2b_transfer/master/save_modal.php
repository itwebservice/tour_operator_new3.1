<form id="frm_master_save">
    <div class="modal fade" id="master_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
        data-keyboard="false">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <select id="vehicle_type" name="vehicle_type" style="width:100%" title="Vehicle Type"
                                data-toggle="tooltip" class="form-control" tabindex="0" required>
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="vehicle_name" name="vehicle_name"
                                ...
                                title="Vehicle Name" tabindex="-1" required>
                        </div>
                        <div class="col-sm-4">
                            <input type="number" id="seating_capacity" name="seating_capacity" max_length="20"
                                placeholder="*Seating Capacity" title="Seating Capacity" tabindex="3" required>
                        </div>
                    </div>
                    ...
                    <div class="row mg_tp_20">
                        <div class="col-sm-12">
                            ...
                            <textarea class="feature_editor" name="canc_policy" id="canc_policy"
                                style="width:100% !important" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row text-center mg_tp_30">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-success" id="save"><i

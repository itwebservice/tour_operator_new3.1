...
function get_car_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['total_cost'] - $db['net_total']);
        }
        return $profit;
}
...
function get_visa_amount($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $amount += (float)($db['visa_total_cost']);
        }
        return $amount;
}
...
function get_visa_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['visa_total_cost'] - $db['net_total']);
        }
        return $profit;
}
...
function get_excursion_amount($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $amount += (float)($db['exc_total_cost']);
        }
        return $amount;
}
...
function get_excursion_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['exc_total_cost'] - $db['net_total']);
        }
        return $profit;
}
...
function get_misc_amount($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $amount += (float)($db['misc_total_cost']);
        }
        return $amount;
}
function get_misc_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['misc_total_cost'] - $db['net_total']);
        }
        return $profit;
}
...
function get_hotel_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['total_fee'] - $db['net_total']);
        }
        return $profit;
}
...
function get_ticket_amount($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $amount += (float)($db['ticket_total_cost']);
        }
        return $amount;
}
function get_ticket_profit($customer)
{
        ...
        $count = mysqli_num_rows($res);
        while ($db = mysqli_fetch_array($res)) {
                $profit += (float)($db['ticket_total_cost'] - $db['net_total']);
        }
        return $profit;
}

...
$total_enq_count=0;
function get_user_enq($id='',$type='display'){
...
$total_strong =0;
function get_user_enq_strong($id='',$type='display'){
...
$total_hot =0;
function get_user_enq_hot($id='',$type='display'){
...
$total_cold =0;
function get_user_enq_cold($id='',$type='display'){
...
$count = 1;
    ...
    $footer_data = array("footer_data" => array(
        ...
        'foot8' => "".get_user_enq_strong('','total'),
        'class8' => "text-left success",
    
        'foot9' => "".get_user_enq_hot('','total'),
        'class9' => "text-left success",
    
        'foot10' => "".get_user_enq_cold('','total'),

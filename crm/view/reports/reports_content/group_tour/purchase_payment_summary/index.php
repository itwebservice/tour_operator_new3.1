...
<div class="app_panel_content Filter-panel mg_bt_10">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 form-group">
        <button class="btn btn-sm btn-info ico_right" onclick="purchase_payment_reflect()">Proceed&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
    </div>
</div>
...
<script>
	...
	function purchase_payment_reflect(){
		var group_id = $('#group_id_filter').val();
		var tour_id = $('#tour_id_filter').val();
		var branch_status = $('#branch_status').val();
		$.post('reports_content/group_tour/purchase_payment_summary/purchase_payment_report.php', {group_id : group_id,tour_id : tour_id,branch_status:branch_status}, function(data){
            pagination_load(data, column, true, false, 20, 'gr_tour_report',true);
	});
	}
	purchase_payment_reflect();
    ...
    function excel_report_new() {
		...
		var base_url = $('#base_url').val();
		 ...
		 window.location = base_url + 'view/reports/reports_content/group_tour/purchase_payment_summary/export_excel.php?tourName=' + tourName + '&tourDate=' + tourDate;
	}

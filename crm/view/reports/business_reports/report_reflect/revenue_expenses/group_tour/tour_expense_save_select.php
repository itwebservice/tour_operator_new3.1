...
function view_purchase_modal(tour_id,tour_group_id,btn_d)
{
	$('#supplierv_btn-'+btn_d+tour_id+tour_group_id).prop('disabled',true);
	var base_url = $('#base_url').val();
    $('#supplierv_btn-'+btn_d+tour_id+tour_group_id).button('loading');
	$.post(base_url+'view/reports/business_reports/report_reflect/revenue_expenses/group_tour/view_purchase_modal.php', { tour_id : tour_id, tour_group_id : tour_group_id}, function(data){
		...
		$('#supplierv_btn-'+btn_d+tour_id+tour_group_id).prop('disabled',false);
    	$('#supplierv_btn-'+btn_d+tour_id+tour_group_id).button('reset');
	});
}
function other_expnse_modal(tour_id,tour_group_id,btn_d)
{
	$('#suppliere_btn-'+btn_d+tour_id+tour_group_id).prop('disabled',true);
	var base_url = $('#base_url').val();
    $('#suppliere_btn-'+btn_d+tour_id+tour_group_id).button('loading');
	$.post(base_url+'view/reports/business_reports/report_reflect/revenue_expenses/group_tour/other_expnse_modal.php', { tour_id : tour_id, tour_group_id : tour_group_id }, function(data){
		$('#other_expnse_display').html(data);
		$('#suppliere_btn-'+btn_d+tour_id+tour_group_id).prop('disabled',false);
    	$('#suppliere_btn-'+btn_d+tour_id+tour_group_id).button('reset');

...
if($cust_id!=""){
  ...
  $name_str = ($sq_cust['type'] != 'Corporate'||$sq_cust['type'] == 'B2B') ? $sq_cust['first_name'].' '.$sq_cust['last_name'] : $sq_cust['company_name'];
}
else{
	$name_str = "";
}
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Customer Advance')
...
header('Content-Disposition: attachment;filename="Customer_Advance('.date('d-m-Y H:i').').xls"');

...
?>
<div class="modal fade" id="send_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
        ...
        <form id="frm_form_send">
          ...
          <div class="row mg_tp_10">
            <div class="col-md-12 col-sm-6 mg_bt_10">
                <h5>Registration Link : <u><?= BASE_URL ?>view/b2b_customer/registration/registration.php</u></h5>

	...
	<div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
	     ...
	     <legend>Basic Details</legend>
          ...
          <div class="row">
	            ...
	            <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                <select class="form-control app_select2" id='currency' title='Currency' name='currency' style='width:100%;'>
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
          ...
          <div class="row mg_tp_10">
              ...
              <div class="col-sm-3 col-xs-12">
                <select name="cust_state" id="cust_state" title="State/Country Name" style="width : 100%" required class="app_select2">
                  <?php
...
<script>
$('#currency').select2({dropdownParent: $("#agent_update_modal")});
// $('#cust_state').select2({minimumInputLength:1});


// $('#city').select2({minimumInputLength:1,dropdownParent: $("#save_modal")});
$('#cust_state').select2({minimumInputLength:1,dropdownParent: $("#agent_update_modal")});
city_lzloading('#city');

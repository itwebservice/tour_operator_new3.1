<?php
$sq_pax = mysqli_num_rows(mysqlQuery("select * from travelers_details where traveler_group_id ='$traveler_group_id' and status='Active'"));
...
$total_seats = ($sq_pax == 1) ? 1 : ($total_adult + $total_child_b + $total_child_wb + $total_infant);
?>
<form id="frm_tab_3">
    ...
    <div class="app_panel">
        ...
        <div class="app_panel_content no-pad">
            <div class="container-fluid">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                ...
                                <input type="text" id="txt_adult_seats" name="txt_adult_seats"
                                    value="<?php echo $total_adult; ?>" class="text-center" title="Total Adult(s)"
                                    readonly />
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                <label>Total Child With Bed</label>
                                <input type="text" id="txt_child_b_seats" name="txt_child_b_seats"
                                    value="<?php echo $total_child_b; ?>" class="text-center"
                                    title="Total Child(ren) With Bed" readonly />
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                <label>Total Child Without Bed</label>
                                <input type="text" id="txt_child_wb_seats" name="txt_child_wb_seats"
                                    value="<?php echo $total_child_wb; ?>" class="text-center"
                                    title="Total Child(ren) Without Bed" readonly />
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                <label>Total Infant(s)</label>
                                <input type="text" id="txt_infant_seats" title="Total Infant(s)" name="txt_infant_seats"
                                    value="<?php echo $total_infant; ?>" class="text-center" readonly />
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                                <label>Total Single Person</label>
                                <input type="text" id="txt_single_person_seats" name="txt_single_person_seats" value="<?= $sq_tourwise_id['single_person'] ?>" class="text-center form-control valid" title="Total Single Person" readonly />
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center hidden">
                                <label>Total Passenger(s)</label>
                                <input type="text" id="txt_total_seats" title="Total Passenger(s)" name="txt_total_seats"
                                    value="<?php echo $total_seats; ?>" class="text-center" readonly />
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                <label>Adult Amount</label>
                                <input type="number" id="txt_adult_expense" title="Adult Amount" placeholder="Adult Amount" name="txt_adult_expense"
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                ...
                                <input type="number" id="txt_child_bed_expense" title="Child With Bed Amount" placeholder="Child With Bed Amount"
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                ...
                                <input type="number" id="txt_child_wbed_expense" title="Child Without Bed Amount" placeholder="Child Without Bed Amount" name="txt_child_wbed_expense" class="text-right" value="<?php echo $tourwise_details['child_without_bed'] ?>" onchange="calculate_total_discount(); validate_balance(this.id)" />
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                <label>Infant Amount</label>
                                <input type="number" id="txt_infant_expense" title="Infant Amount" placeholder="Infant Amount" name="txt_infant_expense"
                                    class="text-right" value="<?php echo $tourwise_details['infant_expense'] ?>"
                                    onchange="calculate_total_discount(); validate_balance(this.id)" />
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                                <label>Single Person Amount</label>
                                <input type="number" id="txt_single_person_expense" title="Single Person Amount" placeholder="Single Person Amount" name="txt_single_person_expense" class="text-right form-control valid" onchange="calculate_total_discount();validate_balance(this.id)" value="<?php echo $tourwise_details['single_person_cost'] ?>" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                                ...
                                <select name="gcurrency_code1" id="gcurrency_code1" title="Currency" style="width:100%"
                        ...
                        <div class="bg_white main_block panel-default-inner">
                            <div class="text-center">
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                    <input type="text" id="visa_country_name" onchange="validate_city(this.id)"
                                        name="visa_country_name" placeholder="Country Name" title="Country Name"
                                        value="<?= $tourwise_details['visa_country_name'] ?>">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                ...
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                    ...
                                    <input type="hidden" id="visa_service_tax" name="visa_service_tax"
                                        value="<?= $tourwise_details['visa_service_tax'] ?>">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                    <input type="text" id="visa_service_tax_subtotal" name="visa_service_tax_subtotal"
                                        value="<?= $tourwise_details['visa_service_tax_subtotal'] ?>" title="Tax Amount"
                                        readonly>
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                    <input type="text" id="visa_total_amount" class="amount_feild_highlight text-right"
                                        name="visa_total_amount" placeholder="Total Amount" title="Total Amount"
                                        onchange="validate_balance(this.id); calculate_total_discount()"
                                        value="<?= $tourwise_details['visa_total_amount'] ?>" readonly>
                                </div>
                            </div>
                            <div class="text-center">
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    <input type="text" id="insuarance_company_name" name="insuarance_company_name"
                                        onchange="validate_company(this.id)" placeholder="Insurance Company"
                                        title="Insurance Company"
                                        value="<?= $tourwise_details['insuarance_company_name'] ?>">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    <input type="text" id="insuarance_amount" name="insuarance_amount"
                                        placeholder="Insurance Amount" title="Insurance Amount"
                                        onchange="validate_balance(this.id); calculate_total_discount()"
                                        value="<?= $tourwise_details['insuarance_amount'] ?>">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    <input type="text" id="insuarance_service_charge" title="Service Charge"
                                        name="insuarance_service_charge" class="text-right"
                                        onchange="validate_balance(this.id); calculate_total_discount()"
                                        value="<?= $tourwise_details['insuarance_service_charge'] ?>" />
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    ...
                                    <input type="hidden" id="insuarance_service_tax" name="insuarance_service_tax"
                                        value="<?= $tourwise_details['insuarance_service_tax'] ?>">
                                </div>
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    <input type="text" id="insuarance_service_tax_subtotal"
                                        name="insuarance_service_tax_subtotal"
                                        value="<?= $tourwise_details['insuarance_service_tax_subtotal'] ?>"
                                ...
                                <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                    <input type="text" id="insuarance_total_amount"
                                        ...
                                        onchange="validate_balance(this.id); calculate_total_discount()"
                                        value="<?= $tourwise_details['insuarance_total_amount'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                        ...
                        <div class="text-right text_center_xs mg_tp_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_repeater_discount" title="Repeater's Travelling Discount"
                                    name="txt_repeater_discount" class="text-right"
                                    placeholder="Repeaters Travelling Discount"
                                    value="<?php echo $tourwise_details['repeater_discount'] ?>"
                                    onchange="calculate_total_discount();validate_balance(this.id);" />
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label>Adjustment discount</label>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_adjustment_discount" title="Adjustment discount"
                                    name="txt_adjustment_discount" class="text-right" placeholder="Adjustment Discount"
                                    value="<?php echo $tourwise_details['adjustment_discount'] ?>"
                                    onchange="calculate_total_discount();validate_balance(this.id);" />
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_total_discount" name="txt_total_discount"
                                    title="Total Discount" class="text-right amount_feild_highlight"
                                    placeholder="Total Discount " value="<?php echo $total_discount ?>" readonly />
                        ...
                        <div class="text-right text_center_xs">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_tour_fee" name="txt_tour_fee" class="text-right"
                                    title="Tour Amount" Placeholder="Tour Amount" readonly
                                    value="<?php echo $tourwise_details['tour_fee_subtotal_1'] ?>" />
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_travel_total_expense1" name="txt_travel_total_expense"
                                    class="text-right" value="<?php echo $tourwise_details['total_travel_expense'] ?>"
                                    title="Total Travel Amount" onchange="calculate_total_discount(this.id)" readonly />
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label class="theme_col">Basic
                                    Amount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="basic_amount" name="basic_amount" class="text-right"
                                    value="<?= $basic_cost ?>" title="Basic Amount"
                                    onchange="get_auto_values('txt_date','basic_amount','payment_mode','service_charge','markup','update','false','basic','basic')"
                                    readonly />
                                <small id="basic_show"
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="hidden" id="service_tax_per" name="service_tax_per"
                                    value="<?= $tourwise_details['service_tax_per'] ?>">
                                <input type="text" id="txt_service_charge" name="txt_service_charge" class="text-right"
                                    disabled value="<?php echo $tourwise_details['service_tax'] ?>" />
                            </div>
                        </div>
                        <div class="text-right text_center_xs hidden">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_total_tour_fee1" name="txt_total_tour_fee1"
                                    class="text-right" placeholder="Total" title="Total" readonly
                                    value="<?php echo $tourwise_details['tour_fee_subtotal_2'] ?>" />
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 hidden"><label
                                    for="insuarance_total_amount1">Insurance Amount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 hidden">
                                <input type="text" id="insuarance_total_amount1" name="insuarance_total_amount1"
                                    ...
                                    placeholder="Insurance Amount" onchange="validate_balance(this.id);"
                                    value="<?= $tourwise_details['insuarance_total_amount'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="text-right text_center_xs mg_bt_10">
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label
                                    for="insuarance_total_amount1">Select TCS Tax</label></div>
                ...
                <div class="text-right text_center_xs mg_bt_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label
                                    for="insuarance_total_amount1">TCS </label></div>
                                    <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 ">
                                    <input type="number" name="tcs" id="tcs1" readonly class="text-right"
                                    placeholder="TCS" title="TCS" value="<?=$tourwise_details['tcs_tax'] ?>">

                </div>
                </div>
                <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 hidden"><label>TCS</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 hidden">
                                <?php
                                $tcs_amount1 = $tourwise_details['tcs_tax']; //}
                                ?>
                                <input type="number" id="tcs_tax" name="tcs_tax" class="text-right" placeholder="TCS"
                                    title="TCS" onchange="calculate_total_discount(this.id);validate_balance(this.id)"
                                    <?= $tcs_readonly ?> value="<?= number_format($tcs_amount1, 2) ?>" />
                            </div>

                        <div class="text-right text_center_xs mg_bt_10">
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label
                                    for="insuarance_total_amount1">Roundoff</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 ">
                                <input type="text" name="roundoff" id="roundoff" class="text-right"
                                    placeholder="Round Off" title="RoundOff"
                                    value="<?= $tourwise_details['roundoff'] ?> " readonly>
                            </div>
                        ...
                        <div class="text-right text_center_xs mg_bt_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_total_tour_fee" name="txt_total_tour_fee"
                                    class="amount_feild_highlight text-right" placeholder="Total Amount"
                                    title="Total Amount" value="<?= $tourwise_details['net_total'] ?>" readonly />
                                    <input type="hidden" id="old_total" value="<?= $tourwise_details['net_total'] ?>"/>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                        ...
                        <div class="text-center mg_bt_20">
                            <div class="col-xs-12">
                                <textarea id="txt_special_request" name="txt_special_request" rows="2"
                                    placeholder="Enter your special request i.e Veg food, driver language : English"
                                    title="Enter your special request i.e Veg food, driver language : English"><?php echo $tourwise_details['special_request'] ?></textarea>
                            </div>
                            <input type="hidden" id="txt_date" name="txt_date"
                                value="<?= date('d-m-Y', strtotime($tourwise_details['form_date'])) ?>" />
                        </div>
        ...
        <div class="panel panel-default panel-body pad_8 text-center main_block bg_light mg_bt_0">
            ...
            <button class="btn btn-sm btn-success" id="btn_update_booking"><i
...
function tour_cost_calculate_u1() {
    ...
    var total = parseFloat(adult_expense) + parseFloat(child_b_expense) + parseFloat(child_wb_expense) + parseFloat(
        infant_expense);

...
while ($row_booking = mysqli_fetch_assoc($sq_booking)) {
  ...
  // currency conversion
  $currency_amount1 = currency_conversion($currency, $row_booking['currency_code'], (float)($total_tour_amount) - (float)($cancel_amount));
  ...
  $objPHPExcel->setActiveSheetIndex(0)
    ...
    ->setCellValue('O' . $row_count, number_format((float)($total_tour_amount) - (float)($cancel_amount), 2) . $currency_amount)
  ...
  $total_sale += (float)($total_tour_amount) - (float)($cancel_amount);

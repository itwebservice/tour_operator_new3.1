<div class="row">
    <div class="col-sm-10 col-xs-12 col-sm-push-2 text-right">
        ...
        <button type="button" class="btn btn-pdf btn-sm" title="Delete Row" onclick="deleteRow('tbl_plane_travel_details_dynamic_row'); calculate_plane_expense('tbl_plane_travel_details_dynamic_row')"><i class="fa fa-trash"></i></button>
...
<div class="row mg_tp_20"> <div class="col-xs-12"> <div class="table-responsive">       
    ...
    <table id="tbl_plane_travel_details_dynamic_row" name="tbl_plane_travel_details_dynamic_row" class="table table-bordered table-hover pd_bt_51 no-marg">
        <tr>
            ...
            <td><input type="text" id="txt_plane_seats-1" name="txt_plane_seats-1" title="Total Seats"  placeholder="Total Seats"  maxlength="2" onchange="validate_balance(this.id);" style="width:110px" /></td>

...
<div class="row text-right mg_bt_10">
    ...
    <button class="btn btn-info btn-sm ico_left pull-left" style="margin-right:10px" onclick="display_format_modal();"><i class="fa fa-download"></i>&nbsp;&nbsp;CSV Format</button>
		...
		<button class="btn btn-info btn-sm ico_left" onclick="add_all_system_contacts()"><i class="fa fa-plus"></i>&nbsp;&nbsp;System Mobile nos</button>
...
<div class="row mg_tp_20">
  ...
  <div class="row">
    <div class="col-md-4">
      <select name="sms_group_id" id="sms_group_id" title="Select SMS Group Name" class="form-control">
        <option value="">SMS Group Name</option>
        <?php 

...
$sq_mobile_no_info = mysqli_fetch_assoc(mysqlQuery("select * from sms_mobile_no where mobile_no_id='$mobile_no_id'"));
?>
<div class="modal fade" id="mobile_no_update_modal"  role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">

...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B'.$row_count, "Mobile No");
...
while($row_mobile_no = mysqli_fetch_assoc($sq_mobile_no)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B'.$row_count, $row_mobile_no['mobile_no']);
...
header('Content-Disposition: attachment;filename="Mobile_Numbers('.date('d-m-Y H:i').').xls"');

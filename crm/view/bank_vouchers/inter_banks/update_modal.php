...
$sq_bank_info = mysqli_fetch_assoc(mysqlQuery("select * from inter_bank_transfer_master where entry_id='$entry_id'"));
?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update Inter Bank Transfers</h4>
      </div>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select id="from_bank_id" name="from_bank_id" style="width:100%" title="Creditor Bank" class="form-control" disabled>  
                 <?php
                    $sq_bank1 = mysqli_fetch_assoc(mysqlQuery("select * from bank_master where bank_id='$sq_bank_info[from_bank_id]'"));
                 ?>
               ...
               <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select id="to_bank_id" name="to_bank_id" style="width:100%" title="Debitor Bank" class="form-control" disabled> 
                  <?php
                    $sq_bank2 = mysqli_fetch_assoc(mysqlQuery("select * from bank_master where bank_id='$sq_bank_info[to_bank_id]'"));
                  ?>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" id="ins_no1" name="ins_no1" onchange="validate_spaces(this.id); validate_specialChar(this.id);" placeholder="Instrument Number" value="<?= $sq_bank_info['instrument_no'] ?>" title="Instrument Number" class="form-control" onchange="get_lapse_date('trans_type1','ins_no1','1')">
              </div>
            </div>
            <div class="row">
               <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
$('#frm_update').validate({
  ...
  submitHandler:function(form){
    ...
    if((parseInt(payment_amount)!='0') && (payment_old_amount != payment_amount))

...
<div id="div_taxes_list" class="main_block loader_parent mg_tp_20">
 <div class="table-responsive">
        <table id="other_rules_tab" class="table table-hover" style="margin: 20px 0 !important; width:100%">         
        </table>
    </div>
</div>
...
function o_list_reflect(){
    ...
    $.post('business_rules/other/list_reflect.php', {status:active_flag,tax_filter:tax_filter}, function(data){
	setTimeout(() => {
...
function save_modal(){
	...
	$.post('business_rules/other/save_rules.php', {}, function(data){
...
function update_modal(rule_id){
	...
	$.post('business_rules/other/update_modal.php', {rule_id : rule_id}, function(data){
		$('#div_modal_content').html(data);

    ...
    <div class="app_panel">
        ...
        <div class="container" style="width:100% !important;">
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="number" id="txt_tour_cost" name="txt_tour_cost" onchange="validate_balance(this.id)"
                        class="form-control" placeholder="Adult Cost" title="Adult Cost"
                        value="<?php echo $tour_info['adult_cost']; ?>" maxlength="10" />
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="number" id="txt_child_with_cost" name="txt_child_with_cost"
                        ...
                        value="<?php echo $tour_info['child_with_cost']; ?>" title="CWB Cost" maxlength="10" />
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="number" id="txt_child_without_cost" name="txt_child_without_cost"
                        ...
                        value="<?php echo $tour_info['child_without_cost']; ?>" title="CWOB Cost" maxlength="10" />
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="number" id="txt_infant_cost" name="txt_infant_cost" onchange="validate_balance(this.id)"
                        class="form-control" placeholder="Infant Cost" value="<?php echo $tour_info['infant_cost']; ?>"
                        title="Infant Cost" maxlength="10" />

                </div>
            </div>
            <div class="row mg_tp_10 text-center">
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    <input type="number" id="with_bed_cost" onchange="validate_balance(this.id)"
                        value="<?php echo $tour_info['with_bed_cost']; ?>" name="with_bed_cost"
                        placeholder="Extra bed cost" title="Extra bed cost">
                </div>
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    <input type="number" id="single_person_cost" onchange="validate_balance(this.id)"
                        value="<?php echo $tour_info['single_person_cost']; ?>" name="single_person_cost"
            ...
            <div class="row mg_tp_20">
                ...
                <div class="col-md-6 col-sm-6 mg_bt_10_sm_xs">
                    ...
                    <textarea class="feature_editor" id="inclusions" name="inclusions" placeholder="Inclusions"
                        title="Inclusions" rows="4"><?php echo $tour_info['inclusions']; ?></textarea>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <textarea class="feature_editor" id="exclusions" name="exclusions" class="form-control"
                        ...
                        rows="4"><?php echo $tour_info['exclusions']; ?></textarea>
                </div>
            ...
            <div class="row mg_bt_10 mg_tp_20 text-center">
                ...
                &nbsp;&nbsp;
                <button class="btn btn-sm btn-success ico_left" id="btn_quotation_update">Update<i
...
$('#frm_tour_update').validate({
    ...
    submitHandler: function(form) {
        ...
        var txt_tour_note = $('#txt_tour_note').val();
...
function hotel_name_list_load(id) {
    ...
    $.get("../../../view/custom_packages/master/package/hotel/hotel_name_load.php", {
        city_id: city_id
    }, function(data) {
...

{
    ...
    $.get("../../../view/custom_packages/master/package/hotel/hotel_type_load.php", {
        hotel_id: hotel_id
    }, function(data) {

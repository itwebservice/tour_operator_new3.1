<?php
$day_count = 0;
$sq_day_image = mysqli_fetch_assoc(mysqlQuery("select * from tour_master where tour_id='$tour_id'"));
?>
<form id="frm_tab_2">
    <!--=======Header panel end======-->
    <input type="hidden" id="base_url" value="<?= BASE_URL ?>" />
    <input type="hidden" id="tour_id" value="<?= $tour_id ?>">
    <input type='hidden' id='delete_image_url' name='delete_image_url'>
    ...
    <div class="app_panel">
        ...
        <div class="container" style="width:100% !important;">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mg_bt_20">
                    <select id="dest_name2" name="dest_name" title="Select Destination"
                        onchange="image_list_reflect(this.value)" class="form-control" style="width:100%">
            ...
            while ($row_dest = mysqli_fetch_assoc($sq_query)) { ?>
                ...
                <div class="col-md-2">
                    <input type="button" class="btn btn-sm btnType" id="btn_image_save"
                        onclick="daywise_image_prepare()" autocomplete="off" data-original-title="save" title="save"
                        value="Save">
                </div>
            ...
            <div class="row text-center mg_tp_20">
                <div class="col-md-12">
                    ...
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-info ico_right" id="btn_quotation_save">Next&nbsp;&nbsp;<i
...
function image_list_reflect(dest_name2) {
    ...
    $.post('../inc/image_list_reflect.php', {
        dest_id: dest_id
    }, function(data) {
        $('#image_div').html(data);
    });

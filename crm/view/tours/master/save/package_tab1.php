        ...
        <div class="container-fluid">
            <div class="app_panel_content no-pad">
                <div class="row mg_tp_20">
                    ...
                    <div class="col-md-3 col-sm-6 mg_bt_10">
                        <input class="form-control" type="text" onchange="package_name_validation(this.id);" oninput="updateSlug()"
...
<script>
    ...
    function updateSlug() {
        const packageNameVal = $('#txt_tour_name').val();
        if (packageNameVal) {
    ...
    $(function() {
        $('#frm_tour_master_save1').validate({
            ...
            submitHandler: function(form) {
                ...
                if (!result) {
                    error_msg_alert('Tour name should not allow special character.');
                    return false;
                }

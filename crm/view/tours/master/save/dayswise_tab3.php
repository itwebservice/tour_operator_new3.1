<form id="frm_tab_2">
    <div class="app_panel" style="background-color: #fff;">
        <!--=======Header panel======-->

        <!--=======Header panel end======-->
        <div class="container" style="width:100% !important;">

            <div class="row" style="padding: 20px 0 25px 200px;">
            ...
            <div class="row text-center mg_tp_20">
                <div class="col-md-12">
                    ...
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-info ico_right" class="next_btn"
                        id="btn_quotation_save">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
                </div>
            </div>

...
$sq = mysqli_fetch_assoc(mysqlQuery("select branch_status from branch_assign where link='employee/master/index.php'"));
          ...
          <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10_xs">
                <select name="role_filter" id="role_filter" title="Select Role">
                    ...
                    <?php 
                    $sq_role = mysqlQuery("select * from role_master where active_flag!='Inactive' order by role_name ");
                    while($row_role = mysqli_fetch_assoc($sq_role)){
                        ?>
            ...
            <select name="location_id_filter" id="location_id_filter" onchange="branch_name_load('_filter')" title="Select Location" style="width:100%">
                  ...
                  <?php 
                  $sq_location = mysqlQuery("select * from locations where active_flag='Active' order by location_name");

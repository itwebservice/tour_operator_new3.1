    ...
    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        ...
        <div class="row mg_tp_10">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" type="text" id="txt_first_name1" name="txt_first_name"
                    placeholder="First Name" value="<?= $emp_info['first_name'] ?>" title="First Name">

            </div>

            <div class="col-md-3 col-sm-6 mg_bt_10">

                <input class="form-control" type="text" onchange="fname_validate(this.id);" id="txt_last_name1"
                    name="txt_last_name" placeholder="Last Name" value="<?= $emp_info['last_name'] ?>"
                    title="Last Name">

            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                <input type="hidden" name="country_code_val" id="country_code_val"
                    value="<?= $emp_info['country_code'] ?>">
                <select name="country_code1" id="country_code1" class="form-control" style="width:100%">
                    <?= get_country_code() ?>
                </select>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" type="text" id="txt_mobile_no11" onchange="mobile_validate(this.id);"
                    name="txt_mobile_no" placeholder="Mobile No"
                    value="<?= str_replace($emp_info['country_code'], "", $emp_info['mobile_no']) ?>"
                    title="Mobile Number">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" type="text" id="txt_mobile_no2" name="txt_mobile_no2"
                placeholder="Alternative Mobile No." onchange="mobile_validate(this.id);"
                value="<?= $emp_info['mobile_no2'] ?>" title="Alternative Mobile No.">

            </div>

            <div class="col-md-3 col-sm-6 mg_bt_10">

                <input type="text" name="employee_birth_date1" id="employee_birth_date1" placeholder="*Date Of Birth"
                    title="Date Of Birth" onchange="calculate_age_member(this.id); "
                    value="<?= date('d-m-Y', strtotime($emp_info['dob'])) ?>">
        ...
        <div class="row mg_tp_10 text-center hidden">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                ...
                <input type="text" id="txt_uan1" name="txt_uan1" placeholder="UAN" title="UAN"
                    value="<?php echo $emp_info['uan_code']; ?>" />
    ...
    <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
        ...
        <div class="row text-center mg_tp_10">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select name="location_idu" id="location_idu" title="Location" onchange="branch_name_load('u')">

                    <?php

                    $location_id = $emp_info['location_id'];

                    $sq_location1 = mysqli_fetch_assoc(mysqlQuery("select * from locations where location_id='$location_id'"));
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select class="form-control" id="branch_idu" name="branch_idu" title="Branch"
                    ...
                    $sq_branch = mysqli_fetch_assoc(mysqlQuery("select * from branches where branch_id='$branch_id' order by branch_name"));
                    ...
                    <?php
                    if ($branch_status == 'yes' && $role != 'Branch Admin') {
                        $sq_branch = mysqlQuery("select * from branches where location_id='$location_id'");
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <textarea class="form-control" id="txt_address1" onchange="validate_address(this.id);"
                    name="txt_address" placeholder="Address" rows="1"
                    title="Addresss"><?= $emp_info['address'] ?></textarea>

            </div>

            <div class="col-md-3 col-sm-6 mg_bt_10">

                <input type="text" name="date_of_join1" id="date_of_join1" placeholder="Date Of Joining"
                    title="Date Of Joining" value="<?= date('d-m-Y', strtotime($emp_info['date_of_join'])); ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="emp_username11" name="emp_username1"
                    onchange="validate_username(this.id);" type="text" placeholder="Username" value="<?= $username ?>"
                    title="Username" />
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="txt_password1" onchange="validate_password(this.id);"
                    name="txt_password" type="password" placeholder="Password" value="<?= $password ?>"
                    title="Password" />
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="txt_password11" onchange="validate_password(this.id);"
                    name="txt_password1" type="password" placeholder="Confirm password" value="<?= $password ?>"
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select class="form-control" id="role_id1" name="role_id1" onchange="select_color(this.id)" title="Role"
                    ...
                    $sq = mysqli_fetch_assoc(mysqlQuery("select * from role_master where role_id='$emp_info[role_id]'"));
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="txt_target1" name="txt_target1" type="text" placeholder="Monthly Target"
                    value="<?= $emp_info['target'] ?>" title="Monthly Target To Sale"
                    onchange=" validate_balance(this.id)" />

            </div>
            <div class="col-md-3 col-sm-6 mg_bt_10">

                <input class="form-control" id="txt_incentive_per1" name="txt_incentive_per1" type="text"
                    placeholder="Incentive(%)" title="Incentive(%)" onchange="validate_balance(this.id);"
                    value="<?= $emp_info['incentive_per'] ?>" />
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input type="hidden" id="salary" name="salary" placeholder="Salary" title="Salary"
        ...
        <div class="row"> -->
            <div class="col-md-3 col-sm-6 col-xs-7 mg_bt_10">
                ...
                <div class="div-upload">
                    ...
                    <input type="hidden" value="<?php echo $emp_info['photo_upload_url']; ?>" id="photo_upload_url_u"
                        name="photo_upload_url_u">
            ...
            <div class="col-md-3 col-sm-6 col-xs-5">
                ...
                <div class="div-upload">
                    ...
                    <input type="hidden" id="id_upload_url1" name="id_upload_url1"
                        value="<?php echo $emp_info['id_proof_url']; ?>">
        ...
        <div class="row mg_tp_10">
            ...
            <div class="col-md-3 mg_bt_10">
                <input type="text" id="app_smtp_host" onchange="fname_validate(this.id)" name="app_smtp_host"
                    placeholder="SMTP Host" title="SMTP Host" value="<?= $emp_info['app_smtp_host'] ?>">
                <small>Note : Enter SMTP host name Ex. mail.itourscloud.com</small>
            </div>
            <div class="col-md-3 mg_bt_10">
                <input class="form-control" type="text" id="txt_email_id1" name="txt_email_id" placeholder="Email ID"
                    value='<?= $emp_info['email_id'] ?>' onchange="validate_email(this.id)" title="Email ID">
            </div>
            <div class="col-md-3 mg_bt_10">
                <input type="password" id="app_smtp_password" name="app_smtp_password" class="form-control"
                    placeholder="SMTP Password" title="SMTP Password" value="<?= $emp_info['app_smtp_password'] ?>">
        ...
        <div class="row">
            <div class="col-md-3 mg_bt_10">
                <input type="text" id="app_smtp_method" onchange="fname_validate(this.id);" name="app_smtp_method"
                    placeholder="SMTP Method" title="SMTP Method" value="<?= $emp_info['app_smtp_method'] ?>">
            ...
            <div class="col-md-3 mg_bt_10">
                <input type="text" onchange="validate_alphanumeric(this.id);" id="app_smtp_port" name="app_smtp_port"
                    placeholder="SMTP Port" title="SMTP Port" value="<?= $emp_info['app_smtp_port'] ?>">
    ...
    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30 hidden">
        ...
        <div class="row mg_tp_10">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input type="text" id="issue_date1" name="issue_date1" placeholder="Issue Date" title="Issue Date"
                    onchange="get_to_date(this.id,'expiry_date1')"
                    value="<?php echo get_date_user($emp_info['issue_date']); ?>">

            </div>

            <div class="col-md-3 col-sm-6 mg_bt_10">

                <input type="text" id="expiry_date1" name="expiry_date1" placeholder="Expiry Date" title="Expiry Date" /
                    value="<?php echo get_date_user($emp_info['expiry_date']); ?>">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                ...
                <input class="form-control" type="text" id="txt_visa_amt1" name="txt_visa_amt1"
                    placeholder="Visa Amount" title="Visa Amount" value="<?= $emp_info['visa_amt'] ?>"
                    onchange="validate_balance(this.id)">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                ...
                <input type="text" name="renewal_amount1" id="renewal_amount1" placeholder="Renewal Amount"
                    title="Renewal Amount" value="<?= $emp_info['renewal_amount'] ?>"
                    onchange="validate_balance(this.id)">
...
$('#date_of_join1,#issue_date1,#expiry_date1').datetimepicker({
    timepicker: false,
    format: 'd-m-Y'
});
...
$('#employee_birth_date1').datetimepicker({
    timepicker: false,
    maxDate: yest,
    format: 'd-m-Y'
});

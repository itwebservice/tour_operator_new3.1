...
$sq_airport = mysqli_fetch_assoc(mysqlQuery("select * from airport_master where airport_id='$airport_id'"));
$sq_city = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$sq_airport[city_id]'"));
?>
<form id="frm_update">

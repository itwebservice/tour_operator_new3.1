                ...
                <tbody>
                  ...
                  while($row_itinerary = mysqli_fetch_assoc($sq_itinerary)){
                    ...
                    <tr>
                      ...
                      <td class="col-md-5 no-pad" style="padding-left: 5px !important;"><textarea id="day_program<?=$count?>-u" name="day_program" class="form-control" rows="3" placeholder="*Day-wise Program" onchange="validate_spaces(this.id);validate_dayprogram(this.id);" title="Day-wise Program"><?=$row_itinerary['daywise_program']?></textarea></td>

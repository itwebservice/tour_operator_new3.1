      ...
      <div class="modal-body">
        ...
        <div class="row mg_bt_10"> 
          <div class="col-md-12 text-right">
            <button type="button" class="btn btn-excel" title="Add Row" onclick="addRow('tbl_dynamic_state_name')"><i class="fa fa-plus"></i></button>
            <button type="button" class="btn btn-pdf btn-sm" title="Delete Row" onclick="deleteRow('tbl_dynamic_state_name')"><i class="fa fa-trash"></i></button>
          </div> 
        </div>

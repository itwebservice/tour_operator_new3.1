...
$sq = mysqli_fetch_assoc(mysqlQuery("select * from city_master where city_id='$city_id'"));
?>

<form id="frm_city_master_update">
<input type="hidden" id="city_id" name="city_id" value="<?= $city_id ?>">

<div class="modal fade" id="city_master_update_modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="myModalLabel">

                    ...
                    <div class="row">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                <div class="main_block text-center">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" id="txt_travel_total_expense1"
                                            name="txt_travel_total_expense1"
                                            onchange="validate_balance(this.id);calculate_tour_cost(this.id)"
                                            placeholder="Travel Amount" title="Travel Amount" value="0" readonly />
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" id="total_basic_amt" class="text-right"
                                            name="total_basic_amt"
                                            onchange="calculate_tour_cost(this.id);get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','basic');validate_balance(this.id);"
                                            placeholder="Total Basic Amount" title="Total Basic Amount" value="0"
                                            readonly />
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" id="service_charge" name="service_charge"
                                            ...
                                            onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount_amt');validate_balance(this.id);calculate_tour_cost(this.id)">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <small id="service_show" style="color:#000000">&nbsp;</small>
                                        <label for="service_charge">Discount In</label>
                                        <select title="Discount In" id="discount_in" name="discount_in" class="form-control" onchange="calculate_tour_cost(this.id);get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount_amt');" >
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="number" id="discount_amt" name="discount_amt" onchange="calculate_tour_cost(this.id);get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount_amt');validate_balance(this.id);" placeholder="Discount" title="Discount">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <small>&nbsp;</small>
                                        <label for="service_charge">Tax Apply On</label>
                                        <select title="Tax Apply On" id="tax_apply_on" name="tax_apply_on" class="form-control" onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount_amt');">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <small>&nbsp;</small>
                                        <label for="service_charge">Select Tax</label>
                                        <select title="Select Tax" id="tax_value" name="tax_value" class="form-control" onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount_amt');">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="number" name="tcs_tax" id="tcs_tax" class="text-right"
                                            placeholder="TCS" title="TCS" onchange="calculate_total_tour_cost()"
                                            <?= $tcs_readonly ?>>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <label for="tds">TDS</label>
                                        <input type="number" name="tds" id="tds" class="text-right"
                                            placeholder="TDS" title="TDS" onchange="calculate_total_tour_cost()">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" name="roundoff" id="roundoff" class="text-right"
                                            ...
                                            onchange="calculate_total_tour_cost()" readonly>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" id="txt_actual_tour_cost1"
                                            ...
                                            placeholder="Total Amount" title="Total Amount" readonly>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs hidden">
                                        <label for="currency_code">Currency</label>
                                        <select name="currency_code3" id="currency_code3" style="width:100%"
                                            title="Currency">
                                            <?php
                                ...
                                <div class="main_block text-center">
                                    <div class="col-md-3 col-sm-6 col-xs-12 col-xs-12 mg_bt_10_xs hidden">
                                        ...
                                        <input type="text" id="rue_cost" name="rue_cost"
                                            ...
                                            placeholder="ROE Cost" title="ROE Cost" value="1">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs hidden">
                                        <label for="txt_tour_service_tax">Tax</label>
                                        <select name="tour_taxation_id" id="tour_taxation_id" title="Tax"
                                            onchange="generic_tax_reflect(this.id, 'txt_tour_service_tax', 'calculate_total_tour_cost');"><?php get_taxation_dropdown(); ?>
                                        </select>
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                <div class="main_block text-center">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                        <input type="text" id="visa_amount" name="visa_amount" placeholder="Amount"
                                            title="Amount"
                                            onchange="validate_balance(this.id); calculate_total_tour_cost()" value="0">
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10">
                                        <input type="text" id="visa_service_tax_subtotal"
                                            name="plane_service_tax_subtotal" placeholder="Tax Amount"
                                ...
                                <div class="main_block text-center">
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="insuarance_company_name"
                                            onchange="validate_specialChar(this.id)" name="insuarance_company_name"
                                            placeholder="Insurance Company" title="Insurance Company">
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="insuarance_amount" name="insuarance_amount"
                                            placeholder="Insurance Amount" title="Insurance Amount"
                                            placeholder="Insuarance Amount"
                                            onchange="validate_balance(this.id); calculate_total_tour_cost()" value="0">
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="insuarance_service_charge"
                                            name="insuarance_service_charge" class="text-right" value="0.00"
                                            onchange="validate_balance(this.id); calculate_total_tour_cost()"
                                            placeholder="Service Charge" title="Service Charge" />
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                ...
                                <div class="main_block text-center mg_bt_10 ">
                                    <div class="col-md-2 col-md-offset-1 col-sm-4 col-xs-12 mg_bt_10_xs hidden">
                                        ...
                                        <input type="text" id="visa_total_amount1" name="visa_total_amount1"
                                            placeholder="Visa Amount" title="Visa Amount"
                                            onchange="validate_balance(this.id); calculate_total_tour_cost()" value="0"
                                            disabled>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs hidden">
                                        ...
                                        <input type="text" id="insuarance_total_amount1" name="insuarance_total_amount1"
                                            placeholder="Insuarance  Amount" title="Insuarance Amount"
                                            onchange="validate_balance(this.id);" value="0" disabled>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                        <label for="txt_actual_tour_cost2">Tour</label>
                                        <input type="text" id="txt_actual_tour_cost2" name="txt_actual_tour_cost2"
                                            placeholder="Tour Cost" title="Tour Cost" value="0" disabled>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs">
                                        <label for="txt_actual_tour_cost">Total Tour Amount</label>
                                        <input type="text" id="txt_actual_tour_cost"
                                            class="amount_feild_highlight text-right" name="txt_actual_tour_cost"
                                            placeholder="Tour Cost" title="Tour Cost" value="0" disabled>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                <div class="col-xs-12">
                                    <div
                                        class="panel panel-default panel-body pad_8 mg_tp_20 mg_bt_20 legend_pan bk_payment_wrap">
                                        <div class="row">
                                            <div class="chk_wrap">
                                                <input type="checkbox" id="chk_pay_for_tour" style="float:left;"
                                                    checked>
                                            </div>
                                            <div class="col-md-2 col-sm-4 mg_bt_10_xs mg_tp_10">
                                                <input type="text" id="txt_payment_date1" name="txt_payment_date1"
                                                    placeholder="Date" value="<?php echo date('d-m-Y') ?>" title="Date"
                                                    onchange="check_valid_date(this.id)" />
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                                <select id="cmb_payment_mode1" name="cmb_payment_mode1" title="Mode"
                                                    onchange="payment_installment_enable_disable_fields('1');get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','basic','discount_amt',true);get_identifier_block('identifier','cmb_payment_mode1','credit_card_details','credit_charges');get_credit_card_charges('identifier','cmb_payment_mode1','txt_amount1','credit_card_details','credit_charges')"><?php get_payment_mode_dropdown(); ?>
                                                </select>
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                                <input type="text" id="txt_amount1" name="txt_amount1"
                                            ...
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                                <input type="text" class="bank_suggest" id="txt_bank_name1"
                                                    name="txt_bank_name1" placeholder="Bank Name"
                                                    onchange="fname_validate(this.id)" title="Bank Name" disabled />
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                            ...
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                                <select name="bank_id1" id="bank_id1" placeholder="Select Bank"
                                                    title="Select Bank" disabled>
                                                    <?php get_bank_dropdown(); ?>
                                                </select>
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                                <input class="hidden" type="text" id="credit_charges"
                                                    name="credit_charges" title="Credit card charges" disabled>
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                            ...
                                            <select style="display:none" id="cmb_payment_of_type1"
                                                name="cmb_payment_of_type1" disabled>
                                                <option value="Tour">Pay for tour</option>
                                            </select>
                                            <select class="select-field-113" id="cmb_travel_of_type1"
                                                name="cmb_travel_of_type1" title="Travelling Type"
                                ...
                                <div class="col-xs-12 hidden">
                                    <div class="panel panel-default panel-body pad_8 legend_pan bk_payment_wrap"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-sm-4 mg_bt_10_xs">
                                                ...
                                                <input type="text" id="txt_payment_date2"
                                                    value="<?php echo date('d-m-Y') ?>" name="txt_payment_date2"
                                                    placeholder="Date" title="Date"
                                                    onchange="check_valid_date(this.id)" />
                                            </div>
                                            <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                                <select id="cmb_payment_mode2" name="cmb_payment_mode2" title="Mode"
                                                    onchange="payment_installment_enable_disable_fields('2')">
                                                    <?php get_payment_mode_dropdown(); ?>
                                                </select>
                                            </div>
                                            <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                                <input type="text" id="txt_amount2" name="txt_amount2"
                                                    placeholder="*Amount" title="Amount"
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                                <input type="text" class="bank_suggest" id="txt_bank_name2"
                                                    name="txt_bank_name2" placeholder="Bank Name"
                        ...
                        <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                ...
                                <div class="main_block text-center mg_bt_10">
                                    <div class="col-xs-12">
                                        <textarea id="txt_special_request" onchange="validate_address(this.id)"
                                            name="txt_special_request" placeholder="Your special request E.g(Veg Food)"
                                            title="Your special request E.g(Veg Food)" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="main_block mg_bt_20">
                                    <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="txt_balance_due_date" name="txt_balance_due_date"
                                            placeholder="Due Date" title="Due Date" />
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="employee_name" name="employee_name"
                                            value="<?php echo ($booker_name == ' ') ? 'Admin' : $booker_name; ?>"
                                            placeholder="Employee Name" title="Employee Name" disabled />
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="txt_booking_date" name="txt_booking_date"
                                            placeholder="Booking Date" title="Booking Date"
                                            value="<?php echo date('d-m-Y') ?>"
                                            onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','service_charge','discount_amt',true);check_valid_date(this.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel panel-default main_block bg_light pad_8 text-center mg_bt_150" style="background-color: #fff; border: none;">
                <div class="text-center">
                    <div class="col-xs-12">
                        ...
                        <button class="btn btn-sm btn-success" id="btn_package_tour_master_save"><i

...
<div class="row mg_bt_30"> <div class="col-xs-12"> <div class="table-responsive">
    ...
    <table id="tbl_plane_travel_details_dynamic_row" name="tbl_plane_travel_details_dynamic_row" class="table table-bordered table-hover table-striped pd_bt_51 no-marg" style="width: 1400px;">
        ...
        <td style="min-width:300px;" class="planeairport-select"><select name="from_sector-1" id="from_sector-1" class="form-control app_select2 plane-airport-select" data-sector-type="from" title="From Sector" data-add-new-option="true" style="width:100%;"><option value="">*From Sector</option></select></td>
        <td style="min-width:300px;" class="planeairport-select"><select name="to_sector-1" id="to_sector-1" class="form-control app_select2 plane-airport-select" data-sector-type="to" title="To Sector" data-add-new-option="true" style="width:100%;"><option value="">*To Sector</option></select></td>
        ...
        <td><input type="text" id="txt_plane_seats-1" onchange="validate_balance(this.id)" name="txt_plane_seats-1" placeholder="Total Seats" title="Total Seats" maxlength="3" style="width: 110px;"  /></td>
        <td><input type="text" id="txt_plane_amount-1" name="txt_plane_amount-1" style="width:130px" placeholder="*Amount" onchange="validate_balance(this.id);" onkeyup="calculate_plane_expense('tbl_plane_travel_details_dynamic_row',true)" title="Amount" style="width: 130px;" /></td>

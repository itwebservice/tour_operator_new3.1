...
while ($row_booking = mysqli_fetch_assoc($sq_booking)) {
  ...
  $after_cancel_amt = (float)($total_booking_amt) - (float)($cancel_amount);
  // currency conversion
...
$objPHPExcel->setActiveSheetIndex(0)
  ...
  ->setCellValue('R' . $row_count, number_format($total_cancel, 2))
  ->setCellValue('S' . $row_count, number_format($total_sale, 2))
  ->setCellValue('T' . $row_count, number_format($total_paid, 2))

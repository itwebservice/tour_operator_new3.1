...
?>
<div class="modal fade" id="quotation_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    data-keyboard="false">
                ...
                <section id="sec_ticket_save" name="frm_ticket_save">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs text_left_sm_xs" role="tablist">
                            ...
                            <li role="presentation"><a href="#tab_2" aria-controls="tab_2" role="tab"
                                    data-toggle="tab">Travel Information</a></li>
                            <li role="presentation"><a href="#tab_3" aria-controls="tab_3" role="tab"
...
<script>
$('#enquiry_id').select2();
$('#from_date1, #to_date1,#quotation_date1').datetimepicker({
    timepicker: false,
    format: 'd-m-Y'
});

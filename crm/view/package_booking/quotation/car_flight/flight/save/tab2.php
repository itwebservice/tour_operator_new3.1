<form id="frm_tab2">
                ...
                <div class="accordion_content main_block mg_bt_10">
                    <div class="panel panel-default main_block">
                        <div class="panel-heading main_block" role="tab" id="heading_<?= $count ?>">
                            <div class="Normal main_block" role="button" data-toggle="collapse" data-parent="#accordion"
                                href="#collapse1" aria-expanded="true" aria-controls="collapse1" id="collapsed1">
                                ...
                                <div class="row mg_tp_10 mg_bt_10">
                                    ...
                                    <div class="col-xs-6 text-right mg_bt_20_sm_xs">
                                        <button type="button" class="btn btn-excel btn-sm"
                                            onclick="addRow('tbl_flight_quotation_dynamic_plane');event_airport('tbl_flight_quotation_dynamic_plane');" title="Add Row"><i
                                                class="fa fa-plus"></i></button>
                                        <button type="button" class="btn btn-pdf btn-sm"
                                            onclick="deleteRow('tbl_flight_quotation_dynamic_plane')" title="Delete Row"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="tbl_flight_quotation_dynamic_plane"
                                                name="tbl_flight_quotation_dynamic_plane"
                                                class="table table-bordered no-marg pd_bt_51">

                                                <tr>

                                                    <td><input class="css-checkbox" id="chk_plan-1" type="checkbox"
                                                            checked><label class="css-label" for="chk_plan-1"> <label>
                                                    </td>
                                                    ...
                                                    <td style="min-width:360px;">
                                                        <select name="from_sector-1" id="from_sector-1"
                                                                    class="form-control app_select2 plane-airport-select" style="width:100%"
                                                    ...
                                                    <td><input type="text" id="adult-1" name="adult-1"
                                                            placeholder="*Total Adult(s)" title="Total Adult(s)"
                                                            onchange="" style="width: 139px;" /></td>
                                                    <td><input type="text" id="child-1" name="child-1"
                                                            placeholder="Total Child(ren)" title="Total Child(ren)"
                                                            style="width: 139px;" /></td>
                                                    <td><input type="text" id="infant-1" name="infant-1"
                                                            placeholder="Total Infant(s)" title="Total Infant(s)"
                                                            style="width: 139px;" /></td>

                                                    <td><input type="text" id="txt_dapart-1" name="txt_dapart-1"
    ...
    <div class="row text-center">
        ...
        <div class="col-xs-12">
            ...
            <button class="btn btn-info btn-sm ico_right"
                onclick="get_auto_values('quotation_date','subtotal','payment_mode','service_charge','markup_cost','save','true','service_charge', true);">Next&nbsp;&nbsp;<i
...
function initFlightQuotationPlaneAirports() {
    if (typeof refreshPlaneAirportSelect2In === 'function') {
        refreshPlaneAirportSelect2In('#tbl_flight_quotation_dynamic_plane');
    } else if (typeof initPlaneAirportSelect2 === 'function') {
        initPlaneAirportSelect2('#tbl_flight_quotation_dynamic_plane');
    } else {
        setTimeout(initFlightQuotationPlaneAirports, 200);
    }
}
initFlightQuotationPlaneAirports();
if (typeof initAllAirlineSelectAddNew === 'function') {
    initAllAirlineSelectAddNew('#tbl_flight_quotation_dynamic_plane');
}
    ...
    $('#frm_tab2').validate({
        ...
        submitHandler: function(form, e) {
...

            {
...

                {
...

                    {
                        ...
                        $('#tbl_flight_quotation_dynamic_plane').parent('div').closest(
            ...
            if (!selectedCount) {
                ...
                $('.accordion_content').removeClass("indicator");
                $('#tbl_flight_quotation_dynamic_plane').parent('div').closest('.accordion_content')
                    .addClass("indicator");
                return false;
            }
...
function airport_load_main(ids) {
    ids.forEach(function(id) {
        ...
        $("#" + object_id).autocomplete({
            ...
            return $("<li disabled>")
                .append("<a>" + item.value.split(" -")[1] + "<br><b>" + item.value.split(" -")[0] +
                    "<b></a>")
                .appendTo(ul);
        }
    });

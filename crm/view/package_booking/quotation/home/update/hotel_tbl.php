            ...
            if($sq_hotel_count==0){
                ...
                <tr>
                    ...
                    <td class="hidden"><input type="text" id="extra_bed_cost-1" name="extra_bed_cost-1" placeholder="Extra bed cost" title="Extra bed cost"  style="display: none" onchange="validate_balance(this.id)"></td> 
                        <td><select name="meal_plan-1" id="meal_plan-1" style="width:145px;" title="Meal Plan" class="form-control app_select2" onchange="get_hotel_cost();"><?php get_mealplan_dropdown(); ?></select></td>
                ...
                while($row_q_hotel = mysqli_fetch_assoc($sq_q_hotel)){
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:150px;" class="app_datepicker form-control" id="check_in-<?= $count ?>_u" name="check_in-<?= $count ?>" value="<?= get_date_user($row_q_hotel['check_in']) ?>" placeholder="Check-In Date" title="Check-In Date" onchange="get_auto_to_date(this.id);get_hotel_cost();"></td>
                        <td><input type="text" style="width:150px;" class="app_datepicker form-control" id="check_out-<?= $count ?>_u" name="check_out-<?= $count ?>"  value="<?= get_date_user($row_q_hotel['check_out']) ?>"placeholder="Check-Out Date" title="Check-Out Date" onchange="calculate_total_nights(this.id);validate_validDates(this.id);get_hotel_cost();"></td>
                        ...
                        <td><select name="meal_plan-<?= $count ?>" id="meal_plan-<?= $count ?>" style="width:145px;" title="Meal Plan" class="form-control app_select2" onchange="get_hotel_cost();">
                            <?php if($row_q_hotel['meal_plan'] != ''){ ?>
                                <option value="<?php echo $row_q_hotel['meal_plan']; ?>"><?php echo $row_q_hotel['meal_plan']; ?></option>
                            <?php } ?>

...
<table class="table table-bordered no-marg">
	...
	<tbody>
		<td style="word-wrap: break-word;white-space: pre-wrap;width:1150px;"><pre class="real_text"><?= $sq_quotation['incl'] ?></pre></td>
	</tbody>
	</table>
...
<table class="table table-bordered no-marg">
	...
	<tbody>
		<td style="word-wrap: break-word;white-space: pre-wrap;width:1150px;"><pre class="real_text"><?= $sq_quotation['excl'] ?></pre></td>
	</tbody>
	</table>

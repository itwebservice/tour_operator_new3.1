...
?>
<div class="modal fade" id="quotation_save_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    data-keyboard="false">
    <div class="modal-dialog modal-lg" style="width: 95% !important;height:90% !important;" role="document">
...
$('#txt_arrval1,#txt_dapart1, #train_arrival_date,#cruise_departure_date,#cruise_arrival_date,#train_departure_date')
    .datetimepicker({
        format: 'd-m-Y H:i'
    });

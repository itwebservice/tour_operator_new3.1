      ...
      <div class="modal-body">
      	...
      	<section id="sec_ticket_save" name="frm_ticket_save">
			  ...
			  <ul class="nav nav-tabs text_left_sm_xs" role="tablist">
			    ...
			    <li role="presentation"><a href="#tab3_u" aria-controls="tab3_u" role="tab" data-toggle="tab">Travel And Stay</a></li>
...
$('#from_date1, #to_date1, #quotation_date1').datetimepicker({ timepicker:false, format:'d-m-Y', minDate: 0 });

...
$sq_sms_group_info = mysqli_fetch_assoc(mysqlQuery("select * from email_group_master where email_group_id='$email_group_id'"));
?>
<div class="modal fade" id="email_group_update_modal" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
      ...
      <div class="modal-body">
		...
		<input type="hidden" id="email_group_id1" name="email_group_id" value="<?= $email_group_id ?>">
      	...
      	<div class="row">
      		...
      		<div class="col-md-6">
      			<button class="btn btn-sm btn-success" id="update_loading"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Update</button>
      		</div>
      	</div>

...
$branch_status = isset($_POST['branch_status']) ? $_POST['branch_status'] : 'no';
?>
<input type="hidden" id="branch_status" name="branch_status" value="<?= $branch_status ?>" >
<div class="row text-right mg_bt_10">
    <button class="btn btn-info btn-sm ico_left" data-toggle="modal" data-target="#email_template_save_modal"><i class="fa fa-plus"></i>&nbsp;&nbsp;Template</button>
</div>
...
function list_reflect(){
	...
	$.post('templates/list_reflect.php', {template_type:template_type,branch_status:branch_status}, function(data){

...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B'.$row_count, "Email ID");
...
while($row_email_no = mysqli_fetch_assoc($sq_email_no)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B'.$row_count, $row_email_no['email_id']);
...
header('Content-Disposition: attachment;filename="Email_ID('.date('d-m-Y H:i').').xls"');

...
<div class="row text-right mg_bt_10">
	<div class="col-md-12">
		...
		<button class="btn btn-info btn-sm ico_left" onclick="add_all_system_emails()"><i class="fa fa-plus"></i>&nbsp;&nbsp;System Emails</button>
...
<div id="div_modal"></div>
	...
	<div class="row">
		<div class="col-md-3">
			<select name="email_group_id" id="email_group_id" class="form-control" title="Select Email Group Name">
				<option value="">Email Group Name</option>
				<?php 

        ...
        <div class="modal-dialog modal-lg" role="document" style="width: 96% !important;">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">New Bus Booking</h4>
                </div>
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <select name="customer_id" id="customer_id" class="customer_dropdown"
                                    title="Customer Name" style="width:100%"
                                    onchange="customer_info_load();get_auto_values('balance_date','basic_cost','payment_mode','service_charge','markup','save','true','service_charge','discount');">
                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                    <table id="tbl_dynamic_bus_booking" name="tbl_dynamic_bus_booking"
                                        class="table table-bordered no-marg" style="width:1300px;">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                        ...
                        <div class="row mg_bt_10">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="payment_date" name="payment_date" placeholder="Date" title="Date"
                                    value="<?= date('d-m-Y') ?>" onchange="check_valid_date(this.id)">
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <select name="payment_mode" id="payment_mode" title="Mode"
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="payment_amount" name="payment_amount" placeholder="*Amount"
                                    title="Amount"
                        ...
                        <div class="row mg_bt_10">
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <input type="text" id="bank_name" name="bank_name" placeholder="Bank Name"
                                    class="bank_suggest" title="Bank Name" readonly>
                            </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <button id="btn_save" class="btn btn-sm btn-success"><i
...
$('#frm_save').validate({
    ...
    submitHandler: function() {
        ...
        var cust_company_name = $('#corpo_company_name').val();
                    ...
                    if (data !== 'valid') {
                        ...
                        function saveData() {
                            $.ajax({
                                type: 'post',
                                url: base_url +
                                    'controller/bus_booking/booking/booking_save.php',
                                data: {
                                    emp_id: emp_id,
                                ...
                                success: function(result) {
                                    ...
                                    if (msg[0] == 'error') {
                                        ...
                                        window.open(base_url +
                                            'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Bus&amount=' +
                                            basic_cost + '&booking_id=' +
                                            msg1[1]);
                                        setTimeout(() => {
                                            if ($('#whatsapp_switch')
                                                .val() == "on")
                                                whatsapp_send(emp_id,
                                                    customer_id,
                                                    balance_date,
                                                    base_url,
                                                    country_code +

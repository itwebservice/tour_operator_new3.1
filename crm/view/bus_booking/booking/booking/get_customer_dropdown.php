...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="booking_dropdown_load('customer_id_filter', 'booking_id_filter')" class="form-control" title="Select Customer" style="width:100%">

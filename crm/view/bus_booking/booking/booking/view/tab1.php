			...
			<div class="profile_box main_block">
	        	 <h3>Customer Details</h3>
    				...
    				<span class="main_block"> 
    				    ...
    				    <?php echo $sq_customer['first_name'].' '.$sq_customer['last_name'].'&nbsp'.'('.get_bus_booking_id($booking_id,$year).')'; ?>
    				</span>
    				<?php  
		    ...
		    <div class="profile_box main_block" style="min-height: 141px;">
	            ...
	            <div class="row">
		            <div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
		        	    ...
		        	    <span class="main_block">
		        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        	      <?php echo "<label>Markup Amount<em>:</em></label> ".number_format($sq_booking['markup'],2); ?>
		        	    </span>
						<span class="main_block">
		        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					...
					<div class="col-sm-6 col-xs-12">
		        		...
		        		<span class="main_block">
		        		  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        		  <?php
							$sq_credit = mysqli_fetch_assoc(mysqlQuery("SELECT sum(`credit_charges`) as sumc FROM `bus_booking_payment_master` WHERE `booking_id`='$sq_booking[booking_id]' and `clearance_status`!='Cancelled' and clearance_status != 'Pending'"));

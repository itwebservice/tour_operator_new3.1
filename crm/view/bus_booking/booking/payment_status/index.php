...
$q = "select * from branch_assign where link='bus_booking/booking/index.php'";
...
<div class="app_panel_content Filter-panel">
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			...
			<input type="text" id="payment_from_date_filter" name="payment_from_date_filter" placeholder="From Date" title="From Date" onchange="get_to_date('payment_from_date_filter','payment_to_date_filter');">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			<select name="bbranch_id_filter" id="bbranch_id_filter" title="Branch Name" style="width: 100%">
...
$('#customer_id_filter, #booking_id_filter,#cust_type_filter,#booker_id_filter,#bbranch_id_filter').select2();
...

{
	...
	var branch_id = $('#bbranch_id_filter').val();

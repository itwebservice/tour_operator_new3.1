...
.flight-info {
box-shadow: 1px 3px 30px 5px gray;
border-radius: 5px;
padding: 3px 10px;
margin: 35px 20px;
...
li.print_single_itinenary,section.print_single_itinenary {
...
li.print_single_itinenary:before,section.print_single_itinenary:before {
position: absolute;
content: '';
height: 15px;
width: 15px;
...
li.print_single_itinenary:last-child:after,section.print_single_itinenary:last-child:after {
position: absolute;
content: '';
height: 15px;
width: 15px;
...
li.print_single_itinenary .print_itinenary_count,section.print_single_itinenary .print_itinenary_count {
position: absolute;
left: -45px;
top: -43px;
height : 44px;

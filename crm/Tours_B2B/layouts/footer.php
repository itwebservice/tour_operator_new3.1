...
function get_selected_currency(){
    ...
    var tours_pageurl = base_url + 'Tours_B2B/view/tours/tours-listing.php';
    var group_tours_pageurl = base_url + 'Tours_B2B/view/group_tours/tours-listing.php';
    ...
    else if(current_page_url==group_tours_pageurl){
...
function group_tours_page_currencies(){
    var base_url = $('#base_url').val();
    var credit_amount = $("#credit_amount_temp").val();
    var default_currency = $('#global_currency').val();    
    if (typeof Storage !== 'undefined') {
    ...
    // setTimeout(() => {
      ...
      var best_price_list = JSON.parse(sessionStorage.getItem('gtours_best_price'));

...
function group_tours_reflect(id)
{
	...
	$.get(base_url+"Tours_B2B/view/group_tours/inc/tours_list_load.php", { dest_id : dest_id }, function(data){
		$('#cmb_tour_name').html('');
...
function tour_group_reflect(id,flag=false)
{
	...
	$.get(base_url+"Tours_B2B/view/group_tours/inc/tour_group_reflect.php", { tour_id : tour_id, flag : flag }, function(data){
		$('#cmb_tour_group').html('');
...
function seats_availability_reflect()
{
	...
	console.log(tour_group_id);
	if( tour_id == '' || tour_group_id == '')
	{
		document.getElementById("seats_availability").innerHTML = "";
		return false;
	}
	$.get(base_url+'Tours_B2B/view/group_tours/inc/seats_availability_reflect.php', { tour_id : tour_id, tour_group_id : tour_group_id }, function(data){
...
$(function () {
	$('#frm_group_tours_search').validate({
		...
		submitHandler : function (form) {
			...
			$.post(base_url+'controller/group_tour/tours/search_session_save.php', { tours_array: tours_array,currency:currency }, function (data) {
				window.location.href = base_url + 'Tours_B2B/view/group_tours/tours-listing.php';
			});
		}
	});
});
...
if (sizeof($tours_result_array) > 0) {
  ...
  for ($i = 0; $i < sizeof($tours_result_array); $i++) {
    ...
    $tour_name = $tours_result_array[$i]['tour_name'];
...
?>
    ...
    <input type="hidden" id="dest_name-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['dest_name'] ?>">
    ...
    <input type="hidden" id="pp_adult_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_adult_cost'] ?>">
    <input type="hidden" id="pp_child_without_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_child_without_cost'] ?>">
    <input type="hidden" id="pp_child_with_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_child_with_cost'] ?>">
    <input type="hidden" id="pp_with_bed_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_with_bed_cost'] ?>">
    <input type="hidden" id="pp_infant_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_infant_cost'] ?>">
    <input type="hidden" id="pp_infant_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_infant_cost'] ?>">
    <input type="hidden" id="pp_extrabed_cost-<?= $tours_result_array[$i]['tour_id'] ?>" value="<?= $tours_result_array[$i]['pp_extrabed_cost'] ?>">
        ...
        <div class="cardList-accordian">
          ...
          <div class="c-compTabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="tour_date-tab" data-toggle="tab" href="#tour_date-tab<?= $tours_result_array[$i]['tour_id'] ?>" role="tab" aria-controls="tour_date" aria-selected="true">Tour Date</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="itinerary-tab" data-toggle="tab" href="#itinerary-tab<?= $tours_result_array[$i]['tour_id'] ?>" role="tab" aria-controls="itinerary" aria-selected="true">Itinerary</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <!-- **** Tab tour dates **** -->
              <div class="tab-pane show active fade" id="tour_date-tab<?= $tours_result_array[$i]['tour_id'] ?>" role="tabpanel" aria-labelledby="tour_date-tab">

                <!-- **** List **** -->
                <?php for ($pi = 0; $pi < sizeof($tours_result_array[$i]['travel_date']); $pi++) {  ?>
                  <!-- ***** Activity List Card ***** -->
                  <div class="c-cardListHolder">
                    <div class="c-cardListTable type-2" role="button">
                      <input class="btn-radio" type="radio" id="<?= $tours_result_array[$i]['travel_date'][$pi]['tour_date'] . $pi ?>" name="result<?= $tours_result_array[$i]['tour_id'] ?>" value='<?php echo $tours_result_array[$i]['travel_date'][$pi]['group_id'] . '=' . $tours_result_array[$i]['travel_date'][$pi]['tour_date'] . '=' . $tours_result_array[$i]['total_cost'] . '=' . $h_currency_id  ?>'>
                      <!-- *** Activity Card Info *** -->
                      <label class="cardList-info" for="<?= $tours_result_array[$i]['travel_date'][$pi]['tour_date'] . $pi ?>" role="button">
                        <div class="flexGrid">
                          <div class="gridItem">
                            <div class="infoCard">
                              <span class="infoCard_data"><?php echo $tours_result_array[$i]['travel_date'][$pi]['tour_date'] ?></span>
                            </div>
                            <div class="styleForMobile">
                              <div class="infoCard c-halfText m0">
                                <span class="sect">Total Seats :</span>
                                <span class="sect s2"><?= $tours_result_array[$i]['travel_date'][$pi]['total_seats'] ?></span>
                                <span class="sect">/ Available Seats :</span>
                                <span class="sect s2"><?= $tours_result_array[$i]['travel_date'][$pi]['available_seats'] ?></span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="clearfix text-right">
                  <button class="c-button md" onclick="add_to_cart('<?= $tours_result_array[$i]['tour_id'] ?>','GroupTours');"><i class="icon it itours-shopping-cart"></i> Add To Cart</button>
                </div>
              </div>
              <!-- **** Tab tour dates End **** -->
              ...
              <!-- **** Tab itenary **** -->
              <div class="tab-pane fade" id="itinerary-tab<?= $tours_result_array[$i]['tour_id'] ?>" role="tabpanel" aria-labelledby="itinerary-tab">

...
?>
        ...
        <div class="c-mainSlider">
          <div class="js-mainSlider owl-carousel">
            ...
            <!-- Slide1 -->
            <?php
            $images = isset($sq_cms_q['banners'])?json_decode($sq_cms_q['banners']):[];
            if(empty($images)){
              ?>
              <div class="item">
        ...
        <div class="c-searchContainer">
          <div class="search-box container">
            ...
            <ul class="c-search-tabs nav nav-tabs" role="tablist">
              ...
              <li class="nav-item">
                <a
                  class="nav-link"
                  data-toggle="tab"
                  href="#group_tours-tab"
                  role="tab"
                  aria-controls="contact"
                  aria-selected="false"
                  data-service='GroupTours'
                  >GROUP TOUR</a
                >
              </li>
              <li class="nav-item">
            ...
            <div class="search-tab-content tab-content">
              ...
              <div class="tab-pane fade show active" role="tabpanel"  data-service='ComboTours' id="tours-tab">
                <?php include 'tours/tours-search.php'; ?>
              </div>
              <div class="tab-pane fade" role="tabpanel"  data-service='GroupTours' id="group_tours-tab">
                <?php include 'group_tours/tours-search.php'; ?>
              </div>
              <div class="tab-pane fade" data-service='Hotels' role="tabpanel" id="hotel-tab">
        ...
        <div class="container">
          ...
          <div class="c-cardPallet">
            <div class="overflow-hidden">
              ...
              <?php
              $images = isset($sq_cms_q['why_choose_us'])?json_decode($sq_cms_q['why_choose_us']):[];
              for($i=0;$i<sizeof($images);$i++){
                  $url = isset($images[$i]->image_url) ? $images[$i]->image_url : '';
                  $pos = strstr($url,'uploads');
                  if ($url != '' && $pos != false){
      ...
      <?php if($sq_cms_q['amazing_destideas_flag'] != 'Hide'){
              $amazing_dest_ideas = isset($sq_cms_q['amazing_dest_ideas'])?json_decode($sq_cms_q['amazing_dest_ideas']):[];
      ?>
      ...
      <div class="c-graySection">
        ...
        <?php if($sq_cms_q['popular_dest_flag'] != 'Hide'){
          $popular_dest = isset($sq_cms_q['popular_dest'])?json_decode($sq_cms_q['popular_dest']):[];
          ?>
            <div class="container">
              <div class="block">
      ...
      <?php if($sq_cms_q['popular_honey_hotels_flag'] != 'Hide'){
        $popular_honey_hotels = isset($sq_cms_q['popular_honey_hotels'])?json_decode($sq_cms_q['popular_honey_hotels']):[];
      ?>
      <div class="c-destinatioBanner">
        <div class="container">
          <div class="col-sm-12">
            ...
            for($i=0;$i<sizeof($popular_honey_hotels[0]->hotel);$i++){
              ...
              if($hotel_id != ''){
                ...
                if(isset($sq_singleImage['hotel_pic_url'])){
                ...
                $pos = (isset($sq_hotel['description']) && $sq_hotel['description']!='') ? strpos($sq_hotel['description'],'',$des_offset):false;
      ...
      <?php if($sq_cms_q['popular_activities_flag'] != 'Hide'){
        $popular_activities = isset($sq_cms_q['popular_activities'])?json_decode($sq_cms_q['popular_activities']):[];
      ?>
      <div class="c-graySection">
        <div class="container">
          <div class="block">
      ...
      if($sq_cms_q['call_to_action_flag'] != 'Hide'){
        $call_to_action = isset($sq_cms_q['call_to_action'])?json_decode($sq_cms_q['call_to_action']):[];
        $url = isset($call_to_action[0]->image_url) ? $call_to_action[0]->image_url : '';
        $pos = strstr($url,'uploads');
        if ($url != '' && $pos != false){
            $newUrl1 = preg_replace('/(\/+)/','/',$url); 
            $newUrl = BASE_URL.str_replace('../', '', $newUrl1);
      ...
      if($sq_cms_q['popular_hotels_flag'] != 'Hide'){
        $popular_hotels = isset($sq_cms_q['popular_hotels'])?json_decode($sq_cms_q['popular_hotels']):[];
        ?>
          <div class="c-graySection">
            <div class="container">
              <div class="block">
                ...
                <div class="c-cardSlider">
                  <div class="js-cardSlider owl-carousel">
                    ...
                    for($i=0;$i<sizeof($popular_hotels);$i++){
                      ...
                      //Description only 150chars display
                      $pos = isset($sq_hotel['description']) ? substr($sq_hotel['description'],0,150):false;
                      //Rating stars display
                      $star_category = explode(' ', $sq_hotel['rating_star']);
                      $star_category = (sizeof($star_category) > 1) ? $star_category[0] : '';
                      ?>
      ...
      <?php if($sq_cms_q['popular_honey_dest_flag'] != 'Hide'){
              $popular_honey_dest = isset($sq_cms_q['popular_honey_dest'])?json_decode($sq_cms_q['popular_honey_dest']):[];
        ?>
      <div class="c-destinatioBanner pad0-btm M-p50-btm">
        <div class="container">
          <div class="col-md-6 col-12 pull-right">
            ...
            <div class="row">
            <?php 
            $destinations = isset($popular_honey_dest[0]->destination)?($popular_honey_dest[0]->destination):[];
            for($i=0;$i<sizeof($destinations);$i++){

              $dest_id = $popular_honey_dest[0]->destination[$i]->dest_id;
              $sq_dest = mysqli_fetch_assoc(mysqlQuery("select dest_id,dest_name from destination_master where dest_id='$dest_id'"));
              
              $url = isset($destinations[$i]->image_url) ? $destinations[$i]->image_url : '';
              $newUrl = $url;
...
<script type="text/javascript" src="group_tours/js/index.js"></script>

...
if (sizeof($tours_result_array) > 0) {
  for ($i = 0; $i < sizeof($tours_result_array); $i++) {
    ...
    $tax_string = isset($tours_result_array[$i]['taxation'][0]) ? $tours_result_array[$i]['taxation'][0]['taxation_type'] . '-' . $tours_result_array[$i]['taxation'][0]['service_tax'] : '';
?>
    <input type="hidden" id="taxation-<?= $tours_result_array[$i]['package_id'] ?>" value='<?= $tax_string ?>'>
    <!-- ***** Tours Card ***** -->
        ...
        <div class="cardList-info" role="button">
          ...
          <div class="dividerSection type-1 noborder">
            ...
            <div class="divider s2">
              <div class="priceTag">
                <?php
                if ($tours_result_array[$i]['best_lowest_cost']['cost'] != '' && $tours_result_array[$i]['best_org_cost']['org_cost'] != $tours_result_array[$i]['best_lowest_cost']['cost']) {
                ?>
                  <div class="p-old">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="costing-tab<?= $tours_result_array[$i]['package_id'] ?>" role="tabpanel" aria-labelledby="costing-tab">
                ...
                for ($j = 0; $j < sizeof($tours_result_array[$i]['costing_array']); $j++) {
                  ...
                  $offer_amount = (float)($tours_result_array[$i]['offer_options_array'][0]['offer_amount']);
                    ...
                    <div class="c-cardListTable type-2" role="button">
                      ...
                      <label class="cardList-info" for="<?= $tours_result_array[$i]['package_id'] . $j ?>" role="button">
                        <div class="flexGrid">
                          ...
                          <?php
                          if ((float)($org_cost) != (float)($room_cost)) { ?>
                            <div class="gridItem">
              ...
              <div class="tab-pane fade" id="travel-tab<?= $tours_result_array[$i]['package_id'] ?>" role="tabpanel" aria-labelledby="travel-tab">
                ...
                <div class="clearfix m20-btm">
                  <div class="row">
                    ...
                    <?php
                    if (isset($tours_result_array[$i]['transport_array']) && sizeof($tours_result_array[$i]['transport_array']) > 0) { ?>
                      <div class="col-12 m20-btm">
                        <h3 class="c-heading">
                          Transport Details
                        </h3>

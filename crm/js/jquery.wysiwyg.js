	...
	function Wysiwyg() {
		...
		this.controls = {
			...
			h1: {
				...
				visible: true,
				className: "h1",
				command: ($.browser.msie || $.browser.opera || $.browser.chrome) ? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.chrome) ? "<h1>" : "h1",
				tags: ["h1"],
				tooltip: "Header 1"
			},
			...
			h2: {
				...
				className: "h2",
				command: ($.browser.msie || $.browser.opera || $.browser.chrome)	? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.chrome) ? "<h2>" : "h2",
				tags: ["h2"],
				tooltip: "Header 2"
			},
			...
			h3: {
				...
				className: "h3",
				command: ($.browser.msie || $.browser.opera || $.browser.chrome) ? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.chrome) ? "<h3>" : "h3",
				tags: ["h3"],
				tooltip: "Header 3"
			},
			...
			highlight: {
				...
				exec: function () {
					...
					if ($.browser.msie || $.browser.opera || $.browser.chrome) {
						command = "backcolor";
					} else {
						command = "hilitecolor";
					}

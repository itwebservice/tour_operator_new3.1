...
function foo(tableID, quot_table_id, rowCounts) {
  ...
  if (tableID == "tbl_member_dynamic_row") {
    ...
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "txt_m_middle_name" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "txt_m_last_name" + foo.counter
    );
    ...
    for (var i = row.cells[7].childNodes[0].attributes.length; i-- > 0; )
      row.cells[7].childNodes[0].removeAttributeNode(
        row.cells[7].childNodes[0].attributes[i]
      );
    ...
    row.cells[7].childNodes[0].setAttribute("class", "form-control");
    row.cells[7].childNodes[0].setAttribute("title", "Birth Date");
    row.cells[7].childNodes[0].setAttribute("type", "text");
    ...
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "txt_m_adolescence" + foo.counter
    );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "txt_m_passport_no" + foo.counter
    );
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "txt_m_passport_issue_date" + foo.counter
    );
    $(row.cells[11].childNodes[0]).datetimepicker({
      timepicker: false,
      format: "d-m-Y",
    });
    row.cells[12].childNodes[0].setAttribute(
      "id",
      "txt_m_passport_expiry_date" + foo.counter
    );
    $(row.cells[12].childNodes[0]).datetimepicker({
      timepicker: false,
      format: "d-m-Y",
    });
    if (row.cells[13]) {
     ...
     row.cells[14].childNodes[0].setAttribute("type", "text");
     row.cells[15].childNodes[0].setAttribute("type", "text");
     row.cells[16].childNodes[0].setAttribute("type", "text");
  ...
  if (tableID == "tbl_train_travel_details_dynamic_row") {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "txt_train_date" + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute("title", "Departure Date & Time");
    row.cells[2].childNodes[0].setAttribute("style", "width:156px");
    $("#" + row.cells[2].childNodes[0].id).tooltip({ placement: "bottom" });
    $("#" + row.cells[3].childNodes[0].id).tooltip({ placement: "bottom" });
    $("#" + row.cells[4].childNodes[0].id).tooltip({ placement: "bottom" });
    // console.log('#'+row.cells[2].childNodes[0].id);
    // $('#'+row.cells[2].childNodes[0].id).click(function () { $('.tooltip').remove() });
    ...
    dynamic_datetime_ws(row.cells[2].childNodes[0].id);
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "txt_train_from_location" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "txt_train_to_location" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute("id", "txt_train_no" + foo.counter);
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "txt_train_total_seat" + foo.counter
    );
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "txt_train_amount" + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "txt_train_class" + foo.counter
    );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "cmb_train_priority" + foo.counter
    );
  ...
  if (
    ...
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "check-btn-plane-" + prefix + foo.counter
    );
    ...
    row.cells[2].childNodes[0].setAttribute("title", "Departure Date and Time");
    $(row.cells[2].childNodes[0]).tooltip({ placement: "bottom" });
    $(row.cells[2].childNodes[0]).click(function () {
      $(".tooltip").remove();
    });
    row.cells[3].childNodes[0].setAttribute("id", "txt_arravl-" + foo.counter);
    row.cells[3].childNodes[0].value = today;
    dynamic_datetime(row.cells[3].childNodes[0].id);

    row.cells[2].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[3].childNodes[0].id + "')"
    );
    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      "validate_validDatetime('" + row.cells[2].childNodes[0].id + "',id)"
    );
    ...
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "txt_plane_seats-" + prefix + foo.counter
    );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "txt_plane_amount-" + prefix + foo.counter
    );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "from_city-" + prefix + foo.counter
    );
    $(row.cells[10].childNodes[0]).addClass("hidden");
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "to_city-" + prefix + foo.counter
    );
    $(row.cells[11].childNodes[0]).addClass("hidden");
    if(row.cells[12]){
      $(row.cells[12]).addClass("hidden");
      row.cells[12].childNodes[0].value = '';
    }
  }
  ...
  if (tableID == "tbl_check_daily_collection_dynamic_row") {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "txt_chk_collection_date" + foo.counter
    );
    row.cells[2].childNodes[0].placeholder = "Date";
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "txt_chk_collection_bank" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "txt_chk_collection_check_no" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "txt_chk_collection_check_amount" + foo.counter
    );
  }
  ...
  if (tableID == "tbl_dynamic_tour_group") {
    ...
    for (var i = row.cells[3].childNodes[0].attributes.length; i-- > 0; )
      row.cells[3].childNodes[0].removeAttributeNode(
        row.cells[3].childNodes[0].attributes[i]
      );
    ...
    row.cells[2].childNodes[0].setAttribute(
      "onchange",
      'get_to_date(id,"txt_to_date"+foo.counter)'
    );

    row.cells[4].childNodes[0].setAttribute("id", "txt_capacity" + foo.counter);

    jQuery(row.cells[2].childNodes[0]).addClass("form-control").datetimepicker({
      timepicker: false,
      minDate: new Date(),
      format: "d-m-Y",
    });
    jQuery(row.cells[3].childNodes[0]).addClass("form-control").datetimepicker({
      timepicker: false,
      minDate: new Date(),
      format: "d-m-Y",
    });
  ...
  if (tableID == "dynamic_table_list_p_" + quot_table_id) {
    ...
    row.cells[6].childNodes[0].setAttribute(
      "onclick",
      'add_itinerary("dest_name","special_attaraction' +
        foo.counter +
        '","day_program' +
        foo.counter +
        '","overnight_stay' +
  ...
  if (
    tableID == "dynamic_table_list_h_" + quot_table_id ||
    tableID == "hotel_quotation_update"
  ) {
  ...
  if (tableID == "package_program_list") {
    ...
    row.cells[2].setAttribute("style", "padding-left: 5px !important;");
    row.cells[2].setAttribute("required", "");
    row.cells[3].childNodes[0].setAttribute("id", "day_program" + foo.counter);
    row.cells[3].setAttribute("style", "padding-left: 5px !important;");
    ...
    row.cells[4].setAttribute("style", "padding-left: 5px !important;");
...
//     // Add a container for the day program and the buttons
//     var dayProgramContainer = document.createElement('div');
//     dayProgramContainer.setAttribute("class", "day-program-container");
    

//     // Create the day program textarea
//     var dayProgramTextarea = document.createElement('textarea');
//     dayProgramTextarea.setAttribute("id", "day_program" + foo.counter);
    

    
//     dayProgramTextarea.setAttribute("rows", "1");
//     dayProgramTextarea.setAttribute("cols", "50");

//     // Create the B and U buttons
//     var buttonsContainer = document.createElement('div');
//     buttonsContainer.setAttribute("class", "buttons-container");

//     var boldButton = document.createElement('span');
//     boldButton.setAttribute("class", "style_text_b");
//     boldButton.setAttribute("data-wrapper", "**");
//     boldButton.style.fontWeight = "bold";
//     boldButton.style.cursor = "pointer";
//     boldButton.title = "Bold text";
//     boldButton.textContent = "B";

//     var underlineButton = document.createElement('span');
//     underlineButton.setAttribute("class", "style_text_u");
//     underlineButton.setAttribute("data-wrapper", "__");
//     underlineButton.style.cursor = "pointer";
//     underlineButton.title = "Underline text";
...
//     // Append the textarea and the buttons container to the day program container
//     dayProgramContainer.appendChild(dayProgramTextarea);
//     dayProgramContainer.appendChild(buttonsContainer);

//     // Replace the content of the day program cell with the new container
//     row.cells[3].innerHTML = '';
//     row.cells[3].appendChild(dayProgramContainer);

//     // Apply event listeners to the B and U buttons for formatting
//     $(boldButton).on('click', function () {
//         var wrapper = $(this).data("wrapper");
//         var start = dayProgramTextarea.selectionStart;
//         var end = dayProgramTextarea.selectionEnd;
//         var selectedText = dayProgramTextarea.value.substring(start, end);
//         var wrappedText = wrapper + selectedText + wrapper;
//         dayProgramTextarea.value = dayProgramTextarea.value.substring(0, start) + wrappedText + dayProgramTextarea.value.substring(end);
//         dayProgramTextarea.selectionStart = start;
//         dayProgramTextarea.selectionEnd = end + wrapper.length * 2;
//     });
...
//     // Optional: add the rest of your row-specific functionality here
...
//     row.cells[6].childNodes[0].setAttribute("id", "itinerary" + (rowCounts + 1));
//     row.cells[6].childNodes[0].setAttribute(
//         "onclick",
//         'add_itinerary("dest_name2","special_attaraction' +
//             foo.counter +
...
// }
  ...
  if (tableID == "tbl_airport_master") {
    ...
    row.cells[2].childNodes[0].title = "Select City";
  }
  ...
  if (tableID == "tbl_roe_master") {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "currency_code" + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "currency_rate" + foo.counter
    );
  }
  ...
  if (
    tableID == "tbl_package_hotel_master" ||
    tableID == "tbl_package_hotel_master_dynamic_update"
  ) {
    // new edits
    var prefix =
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "hotel_name" + prefix + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "hotel_type" + prefix + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "hotel_tota_days1" + prefix + foo.counter
    );
    if (row.cells[6]) {
  ...
  if (tableID == "tbl_debited") {
    ...
    row.cells[2].childNodes[0].setAttribute("title", "Select Ledger");
    if (row.cells[5]) {
      $(row.cells[5]).addClass("hidden");
    }
  }
  ...
  if (tableID == "tbl_dest_packages") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_dest-1" + foo.counter);
    ...
    row.cells[2].childNodes[0].title = "Select Destination";
    // row.cells[3].childNodes[0].title = 'Select Package';
    row.cells[4].childNodes[0].title = "Select Image";
    // row.cells[4].childNodes[0].setAttribute("style", "width: 150px");
    $(row.cells[2].childNodes[0]).select2().trigger("change");
  }
  if (tableID == "tbl_dest_tours") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_dest-1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "dest_name-1" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "package-1" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "image-1" + foo.counter);
  ...
  if (tableID == "tbl_dest_packages_footer") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_dest-1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "dest_name-1" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "package-1" + foo.counter);
  ...
  if (tableID == "tbl_activities") {
    ...
    row.cells[2].childNodes[0].title = "Select City";
    // row.cells[3].childNodes[0].title = 'Select Activity';
  }
  if (tableID == "tbl_hotels") {
    ...
    city_lzloading("#city_name-1" + foo.counter);
    row.cells[2].childNodes[0].title = "Select City";
    // row.cells[3].childNodes[0].title = "Select Hotel";
  }
  ...
  if (tableID == "tbl_grp_packages_datewise") {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "cmb_tour_name-1" + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "cmb_tour_group-1" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute("id", "validity-1" + foo.counter);

    row.cells[2].childNodes[0].setAttribute(
      "onchange",
      "tour_groups_reflect(id)"
    );
  }
  if (tableID == "tbl_coupons") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_coupon1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "title-1" + foo.counter);
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "coupon_code-1" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute("id", "amount_in-1" + foo.counter);
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "amount-1" + foo.counter
    );
    row.cells[6].childNodes[0].setAttribute("id", "valid_date-1" + foo.counter);
    jQuery(row.cells[6].childNodes[0]).addClass("form-control").datetimepicker({
      timepicker: false,
      minDate: new Date(),
      format: "d-m-Y",
    });
  ...
  if (tableID == "tbl_meta_tags") {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_meta_tags1" + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute("id", "page-1" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "title-1" + foo.counter);
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "description-1" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute("id", "keywords-1" + foo.counter);
    row.cells[6].childNodes[0].setAttribute("id", "entry_id-1" + foo.counter);
  }
  //////////END/////////////
  if (tableID == "tbl_package_tour_member") {
    ...
    row.cells[7].childNodes[0].setAttribute("id", "m_birthdate" + foo.counter);
    row.cells[7].childNodes[0].setAttribute("style", "width: 129px");
    row.cells[7].childNodes[0].setAttribute(
      "onchange",
      "calculate_age_member(id)"
    );
    row.cells[7].childNodes[0].placeholder = "Birth Date";
    var yesterday = new Date(new Date().valueOf() - 1000 * 60 * 60 * 24);
    var d = yesterday.getDate();
  ...
  if (tableID == "tbl_package_hotel_infomration") {
    ...
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "txt_hotel_from_date" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute("style", "width: 170px");
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime('txt_hotel_from_date" +
        foo.counter +
        "', 'txt_hotel_to_date" +
        foo.counter +
        "')"
    );
    row.cells[4].childNodes[0].setAttribute("data-toggle", "tooltip");
    row.cells[4].childNodes[0].placeholder = "Check-In DateTime";
    row.cells[4].childNodes[0].title = "Check-In DateTime";
    ...
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "txt_hotel_to_date" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute("style", "width: 170px");
    row.cells[5].childNodes[0].setAttribute("data-toggle", "tooltip");
    row.cells[5].childNodes[0].placeholder = "Check-Out DateTime";
    ...
    row.cells[9].childNodes[0].setAttribute("id", "extra_bed" + foo.counter);
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "cmb_meal_plan" + foo.counter
    );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "txt_hotel_acm_confirmation_no" + foo.counter
    );

    $("#" + row.cells[7].childNodes[0].id)
      .select2()
      .trigger("change");
  ...
  if (tableID == "tbl_package_transport_infomration") {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "check-btn-tr-acm-1" + foo.counter
    );

    row.cells[2].childNodes[0].setAttribute(
      "id",
      "vehicle_name1" + foo.counter
    );
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "txt_tsp_from_date" + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute("style", "width: 170px");
    row.cells[3].childNodes[0].setAttribute("class", "form-control");
    row.cells[3].childNodes[0].placeholder = "Start Date/Time";
    row.cells[3].childNodes[0].title = "Start Date/Time";
    dynamic_datetime(row.cells[3].childNodes[0].id);
    ...
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "txt_tsp_end_date" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute("style", "width: 170px");
    row.cells[4].childNodes[0].setAttribute("class", "form-control");
    row.cells[4].childNodes[0].placeholder = "End Date/Time";
    row.cells[4].childNodes[0].title = "End Date/Time";
    dynamic_datetime(row.cells[4].childNodes[0].id);

    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[4].childNodes[0].id + "')"
    );
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      "validate_validDatetime('" + row.cells[3].childNodes[0].id + "',id)"
    );
    ...
    if (row.cells[9]) {
      ...
      row.cells[9].childNodes[0].setAttribute("value", "");
    }
  }

  if (
    tableID == "tbl_package_tour_transport" ||
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "pickup_from" + foo.counter + prefix
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "drop_to" + foo.counter + prefix
    );
  ...
  if (tableID == "tbl_vendor_quotation_transport_entries") {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "transport_agency_id" + foo.counter
    );
    if (row.cells[3]) {
      row.cells[3].innerHTML = "";
    }
  ...
  if (
    ...
    var prefix =
      tableID == "tbl_package_tour_quotation_dynamic_hotel_update" ? "_u" : "";
    ...
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "check_in-" + prefix + foo.counter
    );
    row.cells[6].childNodes[0].placeholder = "*Check-In Date";
    ...
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "check_out-" + prefix + foo.counter
    );
    row.cells[7].childNodes[0].placeholder = "*Check-Out Date";
    dynamic_date(row.cells[7].childNodes[0].id);
    ...
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "hotel_stay_days-" + prefix + foo.counter
    );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "no_of_rooms-" + prefix + foo.counter
    );
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "extra_bed-" + prefix + foo.counter
    );
    row.cells[12].childNodes[0].setAttribute(
      "id",
      "package_name" + prefix + foo.counter
    );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "hotel_cost" + prefix + foo.counter
    );
    row.cells[14].childNodes[0].setAttribute(
      "id",
      "package_id" + prefix + foo.counter
    );
    row.cells[15].childNodes[0].setAttribute(
      "id",
      "extra_bed_cost-" + prefix + foo.counter
    );
    ...
    row.cells[7].childNodes[0].style.width = "150px";
    row.cells[9].style.display = "none";
    ...
    // row.cells[3].childNodes[0].setAttribute('onchange', 'hotel_name_list_load(id);');
    row.cells[6].childNodes[0].setAttribute(
      "onchange",
      "get_auto_to_date(id);get_hotel_cost();"
    );
    row.cells[7].childNodes[0].setAttribute(
      "onchange",
    ...
    row.cells[5].childNodes[0].setAttribute("onchange", "get_hotel_cost();");
    row.cells[10].childNodes[0].setAttribute("onchange", "get_hotel_cost();");
    row.cells[11].childNodes[0].setAttribute("onchange", "get_hotel_cost();");
    row.cells[16].childNodes[0].setAttribute("onchange", "get_hotel_cost();");
  ...
  if (
    tableID == "tbl_package_tour_quotation_dynamic_transport" ||
    ...
    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      fun_name + ";get_to_date(id,'" + row.cells[4].childNodes[0].id + "')"
    );
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      "validate_validDate('" + row.cells[3].childNodes[0].id + "',id)"
    );
    row.cells[5].childNodes[0].setAttribute("onchange", fun_name);
    row.cells[6].childNodes[0].setAttribute("onchange", fun_name);
    row.cells[7].childNodes[0].setAttribute("onchange", fun_name);
    row.cells[8].childNodes[0].setAttribute("onchange", fun_name);
    ...
    dynamic_datetime(row.cells[4].childNodes[0].id);
    jQuery(row.cells[4].childNodes[0])
      .addClass("form-control")
      .datetimepicker({ format: "d-m-Y" });

    $("#" + row.cells[2].childNodes[0].id)
      .select2()
      .trigger("change");
    $("#" + row.cells[5].childNodes[0].id)
      .select2()
      .trigger("change");
    $("#" + row.cells[6].childNodes[0].id)
      .select2()
      .trigger("change");
      $("#" + row.cells[7].childNodes[0].id)
        .select2()
  ...
  if (tableID == "tbl_package_tour_quotation_dynamic_excursion") {
    ...
    row.cells[6].childNodes[0].setAttribute("onchange", function_name);
    row.cells[7].childNodes[0].setAttribute("onchange", function_name);
    row.cells[8].childNodes[0].setAttribute("onchange", function_name);
    row.cells[9].childNodes[0].setAttribute("onchange", function_name);

    row.cells[6].childNodes[0].setAttribute(
      "onchange",
      'validate_pax_count(id,"Adult");' + function_name
    );
    row.cells[7].childNodes[0].setAttribute(
      "onchange",
      'validate_pax_count(id,"ChildWithBed");' + function_name
    );
    row.cells[8].childNodes[0].setAttribute(
      "onchange",
      'validate_pax_count(id,"ChildWithoutBed");' + function_name
    );
    row.cells[9].childNodes[0].setAttribute(
      "onchange",
      'validate_pax_count(id,"Infant");' + function_name
    );

    row.cells[10].style.display = "none";
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "adult_total-" + foo.counter
    );
    row.cells[12].childNodes[0].setAttribute(
      "id",
      "child_total-" + foo.counter
    );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "childwo_total-" + foo.counter
    );
    row.cells[14].childNodes[0].setAttribute(
      "id",
      "infant_total-" + foo.counter
    );
    row.cells[11].style.display = "none";
    row.cells[12].style.display = "none";
    row.cells[13].style.display = "none";
  ...
  if (
    tableID == "tbl_dynamic_exc_booking" ||
    tableID == "tbl_dynamic_exc_booking_update"
  ) {
    var current_counter = foo.counter;
    var prefix = tableID == "tbl_dynamic_exc_booking_update" ? "_u" : "";
    if (prefix != "") {
      var currentRowCount = document.getElementById(
        "tbl_dynamic_exc_booking_update"
      ).rows.length;
    ...
    if (tableID == "tbl_dynamic_exc_booking") {
      ...
      var function_name1 =
        "excursion_amount_calculate(id);calculate_exc_expense('" +
        tableID +
        "')";
    } else {
      var function_name = "get_excursion_update_amount(id);";
      var function_name1 =
        "excursion_amount_calculate(id,'1');calculate_exc_expense('" +
        tableID +
        "','1');get_auto_values('balance_date1','exc_issue_amount1','payment_mode','service_charge1','markup1','update','true','service_charge');";
    }

    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_exc" + prefix + current_counter
    );
    for (var i = row.cells[2].childNodes[0].attributes.length; i-- > 0; )
      row.cells[2].childNodes[0].removeAttributeNode(
        row.cells[2].childNodes[0].attributes[i]
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "exc_date-" + prefix + current_counter
    );
    // row.cells[2].childNodes[0].setAttribute("style", "width: 200px");
    row.cells[2].childNodes[0].placeholder = "Excursion Date";
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "city_name-" + prefix + current_counter
    );
    $(row.cells[3].childNodes[0]).next("span").remove();
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "excursion-" + prefix + current_counter
    );
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "transfer_option-" + prefix + current_counter
    );
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "total_adult-" + prefix + current_counter
    );
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "total_children-" + prefix + current_counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
  ...
  if (tableID == "tbl_package_tour_quotation_dynamic_costing") {
    ...
    $(row.cells[13]).addClass("header_btn");
    $(row.cells[14]).addClass("header_btn");
    // $(row.cells[15]).addClass("header_btn");


    // if (row.cells[16]) {
    //   row.cells[16].style.display = "hidden";
    // }
  ...
  if (tableID == "tbl_vendor_quotation_dmc_entries") {
    ...
    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      'get_to_date(id,"checkout_date"+foo.counter)'
    );
    if (row.cells[8]) {
      row.cells[8].innerHTML = "";
    }
    $(row.cells[0].childNodes[0]).prop("disabled", false);
  }
  ...
  if (
    tableID == "tbl_group_tour_save_dynamic_train" ||
    tableID == "tbl_group_tour_save_dynamic_train_update"
  ) {
    row.cells[0].childNodes[0].setAttribute("id", "chk_train1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "train_from_location1" + foo.counter
    );
  ...
  if (tableID == "tbl_package_tour_quotation_dynamic_train") {
    ...
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "train_departure_date1" + foo.counter
    );
    row.cells[5].childNodes[0].placeholder = "Departure Datetime";
    row.cells[5].childNodes[0].title = "Departure Datetime";
    // row.cells[5].childNodes[0].style.width = "160px";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0;
    var yyyy = today.getFullYear();
    ...
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "train_arrival_date1" + foo.counter
    );
    row.cells[6].childNodes[0].placeholder = "Arrival Datetime";
    row.cells[6].childNodes[0].title = "Arrival Datetime";
    // row.cells[6].childNodes[0].style.width = "160px";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0!
    ...
    row.cells[5].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[6].childNodes[0].id + "')"
    );
    row.cells[6].childNodes[0].setAttribute(
      "onchange",
      "validate_validDatetime('" + row.cells[5].childNodes[0].id + "',id)"
    );

    jQuery(row.cells[5].childNodes[0])
      .addClass("form-control")
      .datetimepicker({ format: "d-m-Y H:i" });
  ...
  if (
    ...
    if (row.cells[6]) {
      row.cells[6].classList.add('hidden'); // Add hidden class to 6th cell
  }
  
  if (row.cells[7]) {
      row.cells[7].classList.add('hidden'); // Add hidden class to 7th cell
  }
  if (row.cells[8]) {
    row.cells[8].classList.add('hidden'); // Add hidden class to 7th cell
}
    event_airport(tableID);
  }
  if (tableID == "tbl_enquiry_flight") {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "check-btn-enq-" + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "travel_datetime-" + foo.counter
    );
    ...
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "preffered_airline-" + foo.counter
    );
    row.cells[6].childNodes[0].setAttribute("id", "class_type-" + foo.counter);
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "total_adults_flight-" + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "total_child_flight-" + foo.counter
    );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "total_infant_flight-" + foo.counter
    );
    ...
    $(row.cells[2].childNodes[0]).datetimepicker({ format: "d-m-Y H:i" });
  }
  if (
    ...
    row.cells[6].childNodes[0].title = "Departure Date & Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0!
    ...
    row.cells[6].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[7].childNodes[0].id + "')"
    );
    row.cells[7].childNodes[0].setAttribute(
      "onchange",
  ...
  if (
    tableID == "tbl_flight_quotation_dynamic_plane" ||
    tableID == "tbl_flight_quotation_dynamic_plane_update"
  ) {
    ...
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "adult-" + prefix + foo.counter
    );
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "child-" + prefix + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "infant-" + prefix + foo.counter
    );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "txt_dapart-" + prefix + foo.counter
    );
    ...
    for (var i = row.cells[10].childNodes[0].attributes.length; i-- > 0; )
      row.cells[10].childNodes[0].removeAttributeNode(
        row.cells[10].childNodes[0].attributes[i]
      );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "txt_arrval-" + prefix + foo.counter
    );
    ...
    row.cells[9].childNodes[0].setAttribute(
      "onchange",
      "get_to_datetime(id,'" + row.cells[10].childNodes[0].id + "')"
    );
    jQuery(row.cells[9].childNodes[0])
      .addClass("form-control")
      .datetimepicker({ format: "d-m-Y H:i" });
    jQuery(row.cells[10].childNodes[0])
      .addClass("form-control")
      .datetimepicker({ format: "d-m-Y H:i" });
    row.cells[10].childNodes[0].setAttribute(
      "onchange",
      "validate_validDatetime('" + row.cells[9].childNodes[0].id + "',id)"
    );
    row.cells[10].childNodes[0].setAttribute("type", "text");
    row.cells[10].childNodes[0].style.width = "160px";
  ...
  if (
    tableID == "tbl_dynamic_cruise" ||
    tableID == "tbl_dynamic_cruise_update"
  ) {
    var prefix = tableID == "tbl_dynamic_cruise_update" ? "_u" : "";
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_cruise1" + prefix + foo.counter
    );

    row.cells[2].childNodes[0].setAttribute(
      "id",
      "route" + prefix + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "cabin" + prefix + foo.counter
    );
  }

  // GIT/FIT Cruise table
  if (
    tableID == "tbl_dynamic_cruise_quotation" ||
    tableID == "tbl_dynamic_cruise_quotation_update"
  ) {
    ...
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "cruise_departure_date" + foo.counter
    );
    row.cells[2].childNodes[0].placeholder = "Departure Date Time";
    row.cells[2].childNodes[0].title = "Departure Date Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0!
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "cruise_arrival_date" + foo.counter
    );
    row.cells[3].childNodes[0].placeholder = "Arrival Date Time";
    row.cells[3].childNodes[0].title = "Arrival Date Time";
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth() + 1; //January is 0!
  ...
  if (tableID == "tbl_dynamic_cruise_package_booking") {
    ...
    row.cells[3].childNodes[0].setAttribute("title", "Arrival Date Time");
    row.cells[3].childNodes[0].setAttribute("style", "width: 156px");
    $(row.cells[3].childNodes[0]).tooltip({ placement: "bottom" });
    $(row.cells[3].childNodes[0]).click(function () {
      $(".tooltip").remove();
    });
    var today = new Date();
    var dd = today.getDate();
    ...
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "txt_cruise_total_seat1" + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "txt_cruise_amount1" + foo.counter
    );
  ...
  if (tableID == "tbl_dynamic_domestic_hotel_vendor") {
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "check_in_date" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "check_out_date" + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute("id", "meal_plan" + foo.counter);
  ...
  if (
    tableID == "tbl_dynamic_car_rental_vehicle_local" ||
    tableID == "tbl_dynamic_car_rental_vehicle_local1"
  ) {
  ...
  if (
    tableID == "tbl_dynamic_car_rental_vehicle_out" ||
    tableID == "tbl_dynamic_car_rental_vehicle_out1"
  ) {
    row.cells[0].childNodes[0].setAttribute("id", "chk_vehicle" + foo.counter);
    row.cells[2].childNodes[0].setAttribute(
      "id",
    ...
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "driver_allowance" + foo.counter
    );
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "permit_charges" + foo.counter
    );

    row.cells[12].childNodes[0].setAttribute(
      "id",
      "toll_parking" + foo.counter
    );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "state_entry_pass" + foo.counter
    );
    row.cells[14].childNodes[0].setAttribute(
      "id",
      "other_charges" + foo.counter
    );
  }
  ...
  if (tableID == "tbl_hotel_booking" || tableID == "tbl_hotel_booking_update") {
    ...
    row.cells[6].childNodes[0].setAttribute(
      "onchange",
      "get_hotel_cost();calculate_total_nights('check_in" +
        foo.counter +
        "', 'check_out" +
        foo.counter +
        "','no_of_nights" +
    ...
    jQuery(row.cells[10].childNodes[0]).addClass("form-control");
    if (row.cells[15]) {
      $(row.cells[15]).addClass("hidden");
    }
  }
  ...
  if (tableID == "tbl_dynamic_visa" || tableID == "tbl_dynamic_visa_update") {
    ...
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_visa" + prefix + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "first_name" + prefix + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "middle_name" + prefix + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "last_name" + prefix + foo.counter
    );
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "birth_date" + prefix + foo.counter
    );
    var yesterday = new Date(new Date().valueOf() - 1000 * 60 * 60 * 24);
    var d = yesterday.getDate();
    var m = yesterday.getMonth() + 1; //Month from 0 to 11
    ...
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "adolescence" + prefix + foo.counter
    );
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "visa_country_name" + prefix + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "visa_type" + prefix + foo.counter
    );
    if (tableID == "tbl_dynamic_visa"){
      row.cells[8].childNodes[0].setAttribute(
        "onchange",
        "reflect_cost(this.id)"
      );
      row.cells[0].childNodes[0].setAttribute(
        "onchange",
        "reflect_cost(this.id)"
    ...
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "passport_id" + prefix + foo.counter
    );
    ...
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "issue_date" + prefix + foo.counter
    );
    row.cells[10].childNodes[0].placeholder = "Issue Date";
    row.cells[10].childNodes[0].setAttribute("title", "Issue Date");
    dynamic_date(row.cells[10].childNodes[0].id);
    var date = new Date();
    var yest = date.setDate(date.getDate() - 1);
    var tom = date.setDate(date.getDate() + 1);
    $(row.cells[10].childNodes[0]).datetimepicker({
      timepicker: false,
      maxDate: yest,
      format: "d-m-Y",
    });
    ...
    for (var i = row.cells[11].childNodes[0].attributes.length; i-- > 0; )
      row.cells[11].childNodes[0].removeAttributeNode(
        row.cells[11].childNodes[0].attributes[i]
      );
    row.cells[11].childNodes[0].setAttribute(
      "id",
      "expiry_date" + prefix + foo.counter
    );
    row.cells[11].childNodes[0].placeholder = "Expiry Date";
    row.cells[11].childNodes[0].setAttribute("title", "Expiry Date");
    dynamic_date(row.cells[11].childNodes[0].id);

    if (tableID == "tbl_dynamic_visa_update") {
      row.cells[11].childNodes[0].setAttribute(
        "onchange",
        'validate_issueDate("issue_date_u"+foo.counter,"expiry_date_u"+foo.counter)'
      );
    } else {
      row.cells[11].childNodes[0].setAttribute(
        "onchange",
        'validate_issueDate("issue_date"+foo.counter,"expiry_date"+foo.counter)'
      );
    }

    row.cells[12].childNodes[0].setAttribute(
      "id",
      "nationality" + prefix + foo.counter
    );
    // row.cells[13].childNodes[0].setAttribute('id', 'received_documents' + prefix + foo.counter);
    for (var i = row.cells[13].childNodes[0].attributes.length; i-- > 0; )
      row.cells[13].childNodes[0].removeAttributeNode(
        row.cells[13].childNodes[0].attributes[i]
      );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "appointment" + prefix + foo.counter
    );
    ...
    var today = dd + "-" + mm + "-" + yyyy;
    row.cells[13].childNodes[0].value = today;
    dynamic_date(row.cells[13].childNodes[0].id);
    var tom = date.setDate(date.getDate() + 1);
    $(row.cells[13].childNodes[0]).datetimepicker({
      timepicker: false,
      minDate: tom,
      format: "d-m-Y",
    });
  ...
  if (
    tableID == "tbl_dynamic_miscellaneous" ||
    tableID == "tbl_dynamic_miscellaneous_update"
  ) {
    ...
    for (var i = row.cells[8].childNodes[0].attributes.length; i-- > 0; )
      row.cells[8].childNodes[0].removeAttributeNode(
        row.cells[8].childNodes[0].attributes[i]
      );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "issue_date" + prefix + foo.counter
    ...
    // row.cells[8].childNodes[0].setAttribute('onchange', 'checkPassportDate(id)');
    for (var i = row.cells[9].childNodes[0].attributes.length; i-- > 0; )
      row.cells[9].childNodes[0].removeAttributeNode(
        row.cells[9].childNodes[0].attributes[i]
      );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "expiry_date" + prefix + foo.counter
  ...
  if (
    tableID == "tbl_dynamic_passport" ||
    tableID == "tbl_dynamic_passport_update"
  ) {
    var prefix = tableID == "tbl_dynamic_passport_update" ? "_u" : "";
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_passport" + prefix + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "honorific" + prefix + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "first_name" + prefix + foo.counter
    ...
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "received_documents" + prefix + foo.counter
    );
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "appointment" + prefix + foo.counter
  ...
  if (tableID == "tbl_dynamic_ticket_master") {
    ...
    row.cells[2].childNodes[0].setAttribute("name", "first_name" + foo.counter);

    row.cells[3].childNodes[0].setAttribute("id", "middle_name" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("name", "middle_name" + foo.counter);

    row.cells[4].childNodes[0].setAttribute("id", "last_name" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("name", "last_name" + foo.counter);
    ...
    row.cells[10].childNodes[0].setAttribute("id", "seat_no" + foo.counter);
    row.cells[11].childNodes[0].setAttribute("id", "meal_plan" + foo.counter);
    row.cells[12].childNodes[0].setAttribute("id", "main_ticket" + foo.counter);

    row.cells[14].childNodes[0].setAttribute("id", "journey_type" + foo.counter);
    row.cells[14].childNodes[0].setAttribute("name", "journey_type" + foo.counter);
    row.cells[14].style.display = "none";

    row.cells[15].childNodes[0].setAttribute("id", "departure_or_arrival" + foo.counter);
    row.cells[15].childNodes[0].setAttribute("name", "departure_or_arrival" + foo.counter);
    row.cells[15].style.display = "none";

    row.cells[16].childNodes[0].setAttribute("id", "flight_duration" + foo.counter);
    row.cells[16].childNodes[0].setAttribute("name", "flight_duration" + foo.counter);
    row.cells[16].style.display = "none";

    row.cells[17].childNodes[0].setAttribute("id", "flight_fair_amount" + foo.counter);
    row.cells[17].childNodes[0].setAttribute("name", "flight_fair_amount" + foo.counter);
    row.cells[17].style.display = "none";

    row.cells[18].childNodes[0].setAttribute("id", "flight_travel_date" + foo.counter);
    row.cells[18].childNodes[0].setAttribute("name", "flight_travel_date" + foo.counter);   
    row.cells[18].style.display = "none";

    row.cells[19].childNodes[0].setAttribute("id", "flight_carrier" + foo.counter);
    row.cells[19].childNodes[0].setAttribute("name", "flight_carrier" + foo.counter);
    row.cells[19].style.display = "none";
   

    row.cells[20].childNodes[0].setAttribute("id", "flight_sector" + foo.counter);
    row.cells[20].childNodes[0].setAttribute("name", "flight_sector" + foo.counter);
    row.cells[20].style.display = "none";

    
    row.cells[21].childNodes[0].setAttribute("id", "selected_portal" + foo.counter);
    row.cells[21].childNodes[0].setAttribute("name", "selected_portal" + foo.counter);
    row.cells[21].style.display = "none";


    row.cells[22].childNodes[0].setAttribute("id", "flight_no_with_operator" + foo.counter);
    row.cells[22].childNodes[0].setAttribute("name", "flight_no_with_operator" + foo.counter);
    row.cells[22].style.display = "none";


    row.cells[23].childNodes[0].setAttribute("id", "fair_amount" + foo.counter);
    row.cells[23].childNodes[0].setAttribute("name", "fair_amount" + foo.counter);
    row.cells[23].style.display = "none";


    row.cells[24].childNodes[0].setAttribute("id", "airline_code" + foo.counter);
    row.cells[24].childNodes[0].setAttribute("name", "airline_code" + foo.counter);
    row.cells[24].style.display = "none";


    row.cells[25].childNodes[0].setAttribute("id", "flight_from" + foo.counter);
    row.cells[25].childNodes[0].setAttribute("name", "flight_from" + foo.counter);
    row.cells[25].style.display = "none";


    row.cells[26].childNodes[0].setAttribute("id", "flight_to" + foo.counter);
    row.cells[26].childNodes[0].setAttribute("name", "flight_to" + foo.counter);
    row.cells[26].style.display = "none";


    row.cells[27].childNodes[0].setAttribute("id", "flight_d_date" + foo.counter);
    row.cells[27].childNodes[0].setAttribute("name", "flight_d_date" + foo.counter);
    row.cells[27].style.display = "none";


    row.cells[28].childNodes[0].setAttribute("id", "flight_d_time" + foo.counter);
    row.cells[28].childNodes[0].setAttribute("name", "flight_d_time" + foo.counter);
    row.cells[28].style.display = "none";


    row.cells[29].childNodes[0].setAttribute("id", "flight_a_date" + foo.counter);
    row.cells[29].childNodes[0].setAttribute("name", "flight_a_date" + foo.counter);
    row.cells[29].style.display = "none";


    row.cells[30].childNodes[0].setAttribute("id", "flight_a_time" + foo.counter);
    row.cells[30].childNodes[0].setAttribute("name", "flight_a_time" + foo.counter);
    row.cells[30].style.display = "none";

    row.cells[31].childNodes[0].setAttribute("id", "flight_status" + foo.counter);
    row.cells[31].childNodes[0].setAttribute("name", "flight_status" + foo.counter);
    row.cells[31].style.display = "none";


    row.cells[32].childNodes[0].setAttribute("id", "flight_class" + foo.counter);
    row.cells[32].childNodes[0].setAttribute("name", "flight_class" + foo.counter);
    row.cells[32].style.display = "none";


    row.cells[33].querySelector('button').setAttribute("id", "flight_search_type" + foo.counter);
    row.cells[33].querySelector('button').setAttribute("onclick", "add_flight_details(this.id, 'save')");


    row.cells[12].childNodes[0].setAttribute(
      "class",
      "form-control main_ticket"
    );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "flight_details" + foo.counter
    );
    $(row.cells[13]).addClass("hidden");
  ...
  // ticket table for update 

   if (tableID == "tbl_dynamic_ticket_master_update") {

    // if (foo.counter === undefined) {
      foo.counter = document.querySelectorAll('#tbl_dynamic_ticket_master_update tbody tr').length;
    // }
    // Increment for the new row
    foo.counter++;

    let idx = foo.counter;
     
    var prefix= '_u';
    row.cells[0].childNodes[0].setAttribute("id", "chk_ticket" + idx + prefix);
    row.cells[2].childNodes[0].setAttribute("id", "first_name" + idx + prefix);
    row.cells[3].childNodes[0].setAttribute("id", "middle_name" + idx + prefix);
    row.cells[4].childNodes[0].setAttribute("id", "last_name" + idx + prefix);
    ...
    row.cells[10].childNodes[0].setAttribute("id", "seat_no" + idx + prefix);
    row.cells[11].childNodes[0].setAttribute("id", "meal_plan" + idx + prefix);
    row.cells[12].childNodes[0].setAttribute("id", "main_ticket" + idx + prefix);
    row.cells[12].childNodes[0].setAttribute(
      "class",
      "form-control main_ticket"
    );
    row.cells[13].childNodes[0].setAttribute(
      "id",
      "flight_details" + idx + prefix
    );
    row.cells[14].childNodes[0].setAttribute("id", "add_trips" + idx + prefix);

    row.cells[14].querySelector('button').setAttribute("onclick", "add_flight_details_1(this.id, 'update')");

    $(row.cells[13]).addClass("hidden");
    if (row.cells[15]) {
      row.cells[15].childNodes[0].setAttribute("value", "");
      $(row.cells[15]).addClass("hidden");
    }
  ...
  if (tableID == "tbl_dynamic_bus_booking") {
    ...
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "date_of_journey" + prefix + foo.counter
    );
    ...
    row.cells[9].childNodes[0].setAttribute(
      "id",
      "reporting_time" + foo.counter
    );
    row.cells[10].childNodes[0].setAttribute(
      "id",
      "boarding_point_access" + foo.counter
    );
  ...
  if (tableID == "tbl_dynamic_daily_activity") {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_tour_group1" + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "activity_date" + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "activity_type" + foo.counter
    );
  ...
  if (tableID == "tbl_customer_tm") {
    ...
    row.cells[5].childNodes[0].setAttribute("id", "entry_id" + foo.counter);
    $(row.cells[5]).addClass("hidden");
  }

  //********checklist-to do entries***//
  if (
    tableID == "tbl_dynamic_tour_name" ||
    tableID == "tbl_dynamic_tour_name_update"
  ) {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_tour_group" + foo.counter
  ...
  if (
    tableID == "table_hotel_tarrif" + quot_table_id ||
    tableID == "table_hotel_tarrif_update"
  ) {
    // var prefix = tableID=="tbl_dynamic_booking_quotation" ? "_u" : "";
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_ticket" + quot_table_id + foo.counter
    );
    ...
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      'get_to_date(id,"to_date"+foo.counter)'
    );
    row.cells[5].childNodes[0].setAttribute(
      "onchange",
      'validate_validDate("from_date"+foo.counter,"to_date"+foo.counter)'
    );
    if (row.cells[21]) {
  ...
  if (tableID == "table_hotel_tarrif_offer") {
    ...
    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      'get_to_date(id,"to_date_h"+foo.counter)'
    );
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
  ...
  if (tableID == "table_transfer_tarrif") {
    ...
    $("#" + row.cells[5].childNodes[0].id).datetimepicker({
      timepicker: false,
      format: "d-m-Y",
    });
    $("#" + row.cells[6].childNodes[0].id).datetimepicker({
      timepicker: false,
      format: "d-m-Y",
    });
    row.cells[5].childNodes[0].setAttribute(
  ...
  if (tableID == "table_exc_tarrif_basic") {
    ...
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "from_date_basic" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute(
      "id",
      "to_date_basic" + foo.counter
    );
    ...
    $("#" + row.cells[4].childNodes[0].id).datetimepicker({
      timepicker: false,
      format: "d-m-Y",
    });
    ...
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      'validate_validDate("' +
        row.cells[3].childNodes[0].id +
        '","' +
        row.cells[4].childNodes[0].id +
        '")'
    );
  ...
  if (tableID == "tbl_similar_hotels" + quot_table_id) {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "chk_hh1" + quot_table_id + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "city_id1" + quot_table_id + foo.counter
    );
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "hotel_id1" + quot_table_id + foo.counter
    );
  }

  if (tableID == "tbl_similar_package_hotels" + quot_table_id) {
    row.cells[0].childNodes[0].setAttribute(
      "id",
      "ochk_plan" + quot_table_id + foo.counter
    );
    row.cells[2].childNodes[0].setAttribute(
      "id",
      "oavail1" + quot_table_id + foo.counter
    );
    // row.cells[2].childNodes[0].selectedIndex = 1;
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "city_id1" + quot_table_id + foo.counter
    );
    ...
    row.cells[5].childNodes[0].setAttribute(
      "id",
      "omobile_no1" + quot_table_id + foo.counter
    );
    row.cells[6].childNodes[0].setAttribute(
      "id",
      "oemail_id1" + quot_table_id + foo.counter
    );
    row.cells[7].childNodes[0].setAttribute(
      "id",
      "oreply_by1" + quot_table_id + foo.counter
    );
    row.cells[8].childNodes[0].setAttribute(
      "id",
      "ospec1" + quot_table_id + foo.counter
    );
  }
  if(tableID == "tbl_cust_users" || tableID == "tbl_cust_users1"){
    row.cells[0].childNodes[0].setAttribute("id", "chk_user1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "user_name" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "mobile_no" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "email_id" + foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "active_flag" + foo.counter);
    if (row.cells[6]) {
      row.cells[6].childNodes[0].setAttribute("id", "entry_id" + foo.counter);
    }
  }
  if (tableID == "tbl_taxes") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_tax1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "reflt1" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "namet1" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "amountt1" + foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "ledgert1" + foo.counter);
    row.cells[6].childNodes[0].setAttribute("id", "namet2" + foo.counter);
    row.cells[7].childNodes[0].setAttribute("id", "amountt2" + foo.counter);
    row.cells[8].childNodes[0].setAttribute("id", "ledgert2" + foo.counter);
  }
  ...
  if (tableID == "tbl_taxe_rule_conditions") {
    ...
    document
      .getElementById("currency" + foo.counter)
      .setAttribute("style", "display:none;");
    document
      .getElementById("amount" + foo.counter)
      .setAttribute("style", "display:none;");
  }

  //sightseeing table
  if (tableID == "tbl_package_tariff") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_ticket1" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "hotel_type" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "min_pax" + foo.counter);
  ...
  if (tableID == "table_package_tarrif_offer") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_offer" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "offer_type" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "from_date_h" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "to_date_h" + foo.counter);
    ...
    row.cells[7].childNodes[0].setAttribute("id", "amount" + foo.counter);
    row.cells[8].childNodes[0].setAttribute("id", "agent_type" + foo.counter);
    row.cells[9].childNodes[0].setAttribute("id", "entry_id" + foo.counter);
  ...
  if (
    tableID == "table_ferry_tarrif" ||
    tableID == "table_ferry_tarrif_update"
  ) {
    row.cells[0].childNodes[0].setAttribute("id", "chk_ferry" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "seats" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "from_date" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "to_date" + foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "pickup_from" + foo.counter);
    row.cells[6].childNodes[0].setAttribute("id", "drop_to" + foo.counter);
    row.cells[7].childNodes[0].setAttribute("id", "dept_date" + foo.counter);
    row.cells[8].childNodes[0].setAttribute("id", "arrival_date" + foo.counter);
    row.cells[9].childNodes[0].setAttribute("id", "category" + foo.counter);
    row.cells[10].childNodes[0].setAttribute("id", "adult_cost" + foo.counter);
    row.cells[11].childNodes[0].setAttribute("id", "child_cost" + foo.counter);
    row.cells[12].childNodes[0].setAttribute("id", "infant_cost" + foo.counter);
    row.cells[13].childNodes[0].setAttribute("id", "markup_in" + foo.counter);
    row.cells[14].childNodes[0].setAttribute("id", "amount" + foo.counter);
    if (tableID == "table_ferry_tarrif_update") {
      row.cells[15].childNodes[0].setAttribute(
        "id",
        "ucurrency_code" + foo.counter
      );
    }
    ...
    $("#" + row.cells[7].childNodes[0].id).datetimepicker({
      timepicker: true,
      format: "d-m-Y H:i",
    });
    $("#" + row.cells[8].childNodes[0].id).datetimepicker({
      timepicker: true,
      format: "d-m-Y H:i",
    });
    row.cells[7].childNodes[0].setAttribute(
      "onchange",
      'get_to_datetime(id,"arrival_date"+foo.counter)'
    );
    row.cells[8].childNodes[0].setAttribute(
      "onchange",
      'validate_validDatetime("dept_date"+foo.counter,"arrival_date"+foo.counter)'
    );
    if (tableID == "table_ferry_tarrif_update") {
      $(row.cells[16]).addClass("hidden");
    } else {
  ...
  if (tableID == "table_bike_tarrif") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_bike" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "city_id" + foo.counter);
    row.cells[3].childNodes[0].setAttribute(
      "id",
      "pickup_location" + foo.counter
    );
    row.cells[4].childNodes[0].setAttribute("id", "from_date" + foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "to_date" + foo.counter);
    row.cells[6].childNodes[0].setAttribute("id", "no_of_bikes" + foo.counter);
    row.cells[7].childNodes[0].setAttribute("id", "costing_type" + foo.counter);
    row.cells[8].childNodes[0].setAttribute("id", "total_cost" + foo.counter);
    row.cells[9].childNodes[0].setAttribute("id", "deposit" + foo.counter);
  ...
  if (tableID == "table_bike_tarrif_offer") {
    row.cells[0].childNodes[0].setAttribute("id", "chk_offer" + foo.counter);
    row.cells[2].childNodes[0].setAttribute("id", "offer_type" + foo.counter);
    row.cells[3].childNodes[0].setAttribute("id", "from_dateo" + foo.counter);
    row.cells[4].childNodes[0].setAttribute("id", "to_dateo" + foo.counter);
    row.cells[5].childNodes[0].setAttribute("id", "offer_in" + foo.counter);
    row.cells[6].childNodes[0].setAttribute("id", "coupon_code" + foo.counter);
    row.cells[7].childNodes[0].setAttribute("id", "offer" + foo.counter);
    row.cells[8].childNodes[0].setAttribute("id", "agent_type" + foo.counter);
    ...
    row.cells[3].childNodes[0].setAttribute(
      "onchange",
      'get_to_date(id,"to_dateo"+foo.counter)'
    );
    row.cells[4].childNodes[0].setAttribute(
      "onchange",
      'validate_validDate("from_dateo"+foo.counter,"to_dateo"+foo.counter)'
    );

...
<section class="landingSec main_block">
  ...
  <div class="col-md-8 no-pad" style="text-align: center;">
    <img src="<?= getFormatImg($app_quot_format, $sq_package_name['dest_id']) ?>" width="680" height="377" class="">
  ...
  <div class="packageDeatailPanel">
    ...
    <div class="landigPageCustomer">
      <h3 class="customerFrom" style="font: size 22px;font-weight:600;">PREPARED FOR</h3>
...
<section class="endPageSection main_block mg_tp_10">
  ...
  <div class="row">
    ...
    <div class="col-md-12 passengerPanel endPagecenter mg_bt_10">
      ...
      ?>
      <h3 class="endingPageTitle text-center no-pad" style="font-size:22px;text-align:cente;font-weight:600;">COSTING DETAILS</h3>
      ...
      if ($sq_quotation['costing_type'] == 1) { ?>
        ...
        // Per Person costing — same breakdown table as PDF
        include_once __DIR__ . '/../pp_costing_doc_block.php';
        gqd_render_pp_costing_for_doc($quotation_id);
      } ?>
      <?php
      // if ($tcs_note_show != '') { 
      ?>

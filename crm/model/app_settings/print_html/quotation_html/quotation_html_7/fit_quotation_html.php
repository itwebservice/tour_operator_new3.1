...
<head>
  ...
  <style>
    .cover::before { background-image: url('<?= o7e($o7_cover_bg) ?>'); }
    .thankyou-section::before { background-image: url('<?= o7e($o7_cover_bg) ?>'); }
    .company-logo-img { max-height: 56px; max-width: 56px; object-fit: contain; }
  </style>
</head>
<body>
<div class="doc">
  ...
  <div class="cover">
    ...
    <div class="cover-sidebar">
      <div class="cover-side-item"><div class="cover-side-icon">🏨</div><div class="cover-side-text">Luxury<br/>Hotels</div></div>
      <div class="cover-side-item"><div class="cover-side-icon">🎯</div><div class="cover-side-text">Exciting<br/>Activities</div></div>
      <?php if ($o7_show_flights) : ?>
      <div class="cover-side-item"><div class="cover-side-icon">✈️</div><div class="cover-side-text">Flights</div></div>
      <?php endif; ?>
      <?php if ($o7_show_vehs) : ?>
      <div class="cover-side-item"><div class="cover-side-icon">🚗</div><div class="cover-side-text">Private<br/>Transfers</div></div>
      <?php endif; ?>
      <div class="cover-side-item"><div class="cover-side-icon">📸</div><div class="cover-side-text">Sightseeing</div></div>
      <div class="cover-side-item"><div class="cover-side-icon">🍽️</div><div class="cover-side-text">Delicious<br/>Meals</div></div>
    </div>
    ...
    <div class="cover-grid" style="height:260px;">
    ...
    <div class="overview-inner">
      ...
      <div class="ov-grid">
        <div class="ov-item">
          ...
          <div class="ov-text"><div class="ov-lbl">Quotation ID</div><div class="ov-val"><?= o7e(o7nv($hero['quotation_code'], '')) ?></div></div>
        </div>
        <div class="ov-item">
          <div class="ov-icon">📅</div>
          <div class="ov-text"><div class="ov-lbl">Travel Date</div><div class="ov-val"><?= o7e($o7_travel_range) ?></div></div>
        </div>
        <div class="ov-item">
          <div class="ov-icon">🏷️</div>
          <div class="ov-text"><div class="ov-lbl">Tour ID</div><div class="ov-val"><?= o7e($o7_tour_id) ?></div></div>
        </div>
        <div class="ov-item">
          <div class="ov-icon">🌙</div>
          <div class="ov-text"><div class="ov-lbl">Duration</div><div class="ov-val"><?= o7e(strtoupper($o7_duration)) ?></div></div>
        </div>
        <div class="ov-item">
          <div class="ov-icon">📆</div>
          <div class="ov-text"><div class="ov-lbl">Quotation Date</div><div class="ov-val"><?= o7e(o7nv($ov['quotation_date'], '')) ?></div></div>
        </div>
        <div class="ov-item">
          <div class="ov-icon">👥</div>
          <div class="ov-text"><div class="ov-lbl">Total Guests</div><div class="ov-val"><?= o7e(o7_guest_label($ov)) ?></div></div>
        </div>
      </div>
      ...
      <div class="ov-grid" style="grid-template-columns:1fr;">
        <div class="ov-item">
          <div class="ov-icon">👑</div>
          <div class="ov-text"><div class="ov-lbl">Package Type</div><div class="ov-val"><?= o7e(strtoupper($o7_pkg_ov)) ?> PACKAGE</div></div>
        </div>
      </div>
      ...
      <div class="prep-card" style="margin-top:8px;">
        ...
        <div class="prep-row"><span class="prep-row-icon">✉️</span> <?= o7e(o7nv($ov['customer_email'], o7nv($hero['user_email_id'], ''))) ?></div>
        <div class="prep-row"><span class="prep-row-icon">📞</span> <?= o7e(o7nv($ov['customer_mobile'], o7nv($hero['user_contact'], ''))) ?></div>
      </div>
    </div>
    ...
    <div class="journey-inner">
        ...
        <div class="ft-inner">
          ...
          <div class="ft-route">
            ...
            <div class="ft-details-row">
              <div class="ft-detail"><div class="fdl">Duration</div><div class="fdv"><?= o7e(o7nv($f['duration'], 'Direct')) ?></div></div>
              <div class="ft-detail"><div class="fdl">Baggage</div><div class="fdv"><?= o7e(o7nv($f['baggage'], '30 KG')) ?></div></div>
            </div>
          </div>
          <div class="ft-right-col">
            <?php if ($flight_lbl !== '') : ?>
            <div class="ft-right-item"><div class="ft-right-lbl">Flight</div><div class="ft-right-val"><?= o7e($flight_lbl) ?></div></div>
            <?php endif; ?>
      ...
      <div class="transport-card" style="margin-bottom:14px;">
        <div class="transport-inner">
          <div class="transport-img"><img src="<?= o7e($o7_transport_img) ?>" alt="<?= o7e($v_name) ?>" /></div>
          <div class="transport-body">
            <div class="transport-name"><?= o7e(strtoupper($v_name)) ?></div>
            <div class="transport-grid">
              <div class="tg-cell"><div class="tg-lbl">Start Date</div><div class="tg-val"><?= o7e($v_start !== '' ? $v_start : '—') ?></div></div>
              <div class="tg-cell"><div class="tg-lbl">End Date</div><div class="tg-val"><?= o7e($v_end !== '' ? $v_end : '—') ?></div></div>
              <div class="tg-cell"><div class="tg-lbl">Duration</div><div class="tg-val"><?= o7e($v_dur) ?></div></div>
            </div>
            <div class="transport-row2">
              <div class="tg-cell" style="border-bottom:none;"><div class="tg-lbl">Pickup</div><div class="tg-val"><?= o7e(o7nv($v['pickup'], 'NA')) ?></div></div>
              <div class="tg-cell" style="border-bottom:none;"><div class="tg-lbl">Drop</div><div class="tg-val"><?= o7e(o7nv($v['drop'], 'NA')) ?></div></div>
              <div class="tg-cell" style="border-bottom:none;"><div class="tg-lbl">Category</div><div class="tg-val"><?= o7e(o7nv($v['vehicle_type'], 'Private Transfer')) ?></div></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="inc-grid">
        <div class="inc-card">
          ...
          <div class="ie-body">
            ...
            <div class="ie-item"><div class="ie-bullet green">✓</div><div class="ie-text"><?= o7e($item) ?></div></div>
            <?php endforeach; ?>
          </div>
        </div>
        <div class="exc-card">
          ...
          <div class="ie-body">
            ...
            <div class="ie-item"><div class="ie-bullet red">✗</div><div class="ie-text"><?= o7e($item) ?></div></div>
            <?php endforeach; ?>
          </div>
        </div>
      </div>
    ...
    <div class="pay-inner">
      <div class="pay-grid">
        <div class="bank-card">
          ...
          <div class="bank-body">
            <div class="bank-field"><div class="bank-lbl">Account Name</div><div class="bank-val"><?= o7e(o7nv($bank['account_name'], 'NA')) ?></div></div>
            <div class="bank-field"><div class="bank-lbl">Account Number</div><div class="bank-val"><?= o7e(o7nv($bank['account_no'], 'NA')) ?></div></div>
            <div class="bank-field"><div class="bank-lbl">Bank Name</div><div class="bank-val"><?= o7e(o7nv($bank['bank_name'], 'NA')) ?></div></div>
            <div class="bank-field"><div class="bank-lbl">Branch</div><div class="bank-val"><?= o7e(o7nv($bank['branch_name'], 'NA')) ?></div></div>
            <div class="bank-field"><div class="bank-lbl">IFSC Code</div><div class="bank-val"><?= o7e(o7nv($bank['ifsc_code'], o7nv($bank['swift_code'], 'NA'))) ?></div></div>
            <?php if (!empty($bank['upi_id'])) : ?>
            <div class="bank-field"><div class="bank-lbl">UPI ID</div><div class="bank-val"><?= o7e($bank['upi_id']) ?></div></div>
            <?php endif; ?>
          </div>
        </div>
        <div class="qr-card">
      ...
      <div class="pay-info-grid">
        <div class="pay-info-card">
          <div class="pay-info-head"><div class="pay-info-head-badge"><span>Payment Policy</span></div></div>
        ...
        <div class="pay-info-card">
          <div class="pay-info-head"><div class="pay-info-head-badge"><span>Important</span></div></div>
          <div class="pay-info-body">
  ...
  <div class="thankyou-section">
    ...
    <div class="ty-bottom-grid">
      <div class="ty-contact-card">
        ...
        <?php endif; ?>
        <div class="ty-contact-row"><span class="ty-ci">📞</span><span class="ty-ct"><?= o7e(o7nv($ty['company_contact'], o7nv($ty['user_mobile'], o7nv($hero['user_contact'], '')))) ?></span></div>
        <div class="ty-contact-row"><span class="ty-ci">✉️</span><span class="ty-ct"><?= o7e(o7nv($ty['company_email'], o7nv($hero['user_email_id'], ''))) ?></span></div>
        <?php if (!empty($ty['website'])) : ?>
        <div class="ty-contact-row"><span class="ty-ci">🌐</span><span class="ty-ct"><?= o7e($ty['website']) ?></span></div>
        <?php endif; ?>
      </div>

        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="landigPageCustomer">
              ...
              <span class="customerMail mg_tp_10"><i class="fa fa-phone"></i> : <?= $sq_quotation['mobile_number'] ?></span><br>
            </div>
          </div>
            ...
            <div class="transportDetails">
              <div class="table-responsive" style="margin-top:1px;margin-right: 1px;">
                <table class="table tableTrnasp no-marg">
                  <thead>
                    <tr class="table-heading-row">
                      <th>VEHICLE</th><th>START_DATE</th><th>END_DATE</th><th>PICKUP</th><th>DROP</th><th>S_DURATION</th><th>VEHICLES</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
...
// tcs
      ...
      $tcs_amount_show = currency_conversion($currency, $sq_quotation['currency_code'], $tcsvalue);
        ...
        <div class="row constingBankingPanelRow">
          <!-- Costing -->
          <h3 class="costBankTitle text-center" style="margin-bottom: 20px;">COSTING DETAILS</h3>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px !important; padding: 8px 15px !important;">
                            <img src="<?= BASE_URL ?>images/quotation/p4/tourCost.png" style="height:20px; margin-right: 5px;"> <?= $newBasic1 ?>
                          </td>
                          <td style="font-size: 14px !important; padding: 8px 20px !important;">
                            <img src="<?= BASE_URL ?>images/quotation/p4/tax.png" style="height:20px; margin-right: 5px;"> <?= str_replace(',', '', $name) . $service_tax_amount_show ?>
                          </td>
                          <td style="font-size: 14px !important; padding: 8px 30px !important;">
                            <img src="<?= BASE_URL ?>images/quotation/p4/tax.png" style="height:20px; margin-right: 5px;">
                            TCS<?php if ($tcsper >= 1) echo " (" . $tcsper . "%)"; ?>: <?= $tcs_amount_show ?>
                          </td>
                          <td style="font-size: 14px !important; padding: 8px 20px !important;">
                            <img src="<?= BASE_URL ?>images/quotation/p4/quotationCost.png" style="height:20px; margin-right: 5px;"> <?= $currency_amount1 ?>
                          </td>
                        </tr>
                      </tbody>
                    </table>
          ...
          <!-- Bank Detail -->
          <div class="col-md-12 constingBankingPanel BankingPanel" style="margin-top: 40px;">

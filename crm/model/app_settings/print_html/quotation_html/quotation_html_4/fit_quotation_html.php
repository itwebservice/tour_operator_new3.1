...
<div class="doc">
  ...
  <div class="cover" style="background: linear-gradient(to bottom,rgba(10,22,50,.35) 0%,rgba(10,22,50,.55) 50%,rgba(10,22,50,.92) 100%), url('<?= o4e($o4_cover_img) ?>') center/cover no-repeat;">
    ...
    <div class="cover-center">
      ...
      <div class="cover-icons">
        <div class="cover-icon-pill"><div class="icon">🏨</div><div class="label">Hotels</div></div>
        <div class="cover-icon-pill"><div class="icon">✈️</div><div class="label">Flights</div></div>
        <div class="cover-icon-pill"><div class="icon">📸</div><div class="label">Activities</div></div>
        <div class="cover-icon-pill"><div class="icon">🚐</div><div class="label">Transfers</div></div>
        <div class="cover-icon-pill"><div class="icon">📍</div><div class="label">Sightseeing</div></div>
        <div class="cover-icon-pill"><div class="icon">🍽️</div><div class="label">Meals</div></div>
      </div>
    </div>
  ...
  <div class="page-section">
    ...
    <div class="ov-grid">
      <div class="ov-card"><div class="icon">#</div><div class="lbl">Quotation ID</div><div class="val"><?= o4e(o4nv($hero['quotation_code'], '')) ?></div></div>
      <div class="ov-card"><div class="icon">🏷️</div><div class="lbl">Tour ID</div><div class="val"><?= o4e($o4_tour_id) ?></div></div>
      <div class="ov-card"><div class="icon">📅</div><div class="lbl">Quotation Date</div><div class="val"><?= o4e(o4nv($ov['quotation_date'], '')) ?></div></div>
    </div>
    <div class="ov-grid" style="margin-bottom:20px;">
      <div class="ov-card"><div class="icon">✈️</div><div class="lbl">Travel Date</div><div class="val"><?= o4e($o4_travel_range !== '' ? $o4_travel_range : ($o4_travel_from . ($o4_travel_to !== '' ? ' – ' . $o4_travel_to : ''))) ?></div></div>
      <div class="ov-card"><div class="icon">⏱️</div><div class="lbl">Duration</div><div class="val"><?= o4e($o4_duration) ?></div></div>
      <div class="ov-card"><div class="icon">👥</div><div class="lbl">Guests</div><div class="val"><?= o4e(o4_guest_label($ov)) ?></div></div>
    </div>
    ...
    <div class="prep-bar">
      ...
      <div class="prep-row">
        ...
        <div class="prep-item"><span class="pi">✉️</span> <?= o4e(o4nv($ov['customer_email'], o4nv($hero['user_email_id'], ''))) ?></div>
        <div class="prep-item"><span class="pi">📞</span> <?= o4e(o4nv($ov['customer_mobile'], o4nv($hero['user_contact'], ''))) ?></div>
      </div>
    </div>
  </div>
      ...
      <div class="hotel-card-inner">
        ...
        <div class="hotel-body">
          ...
          <div class="hotel-dates">
            <div class="date-chip"><div class="dlbl">Check-In</div><div class="dval"><span class="dc-icon">→</span><?= o4e(o4nv($h['check_in'], '')) ?></div></div>
            <div class="date-chip"><div class="dlbl">Check-Out</div><div class="dval"><span class="dc-icon">↩</span><?= o4e(o4nv($h['check_out'], '')) ?></div></div>
          </div>
          <div class="amenities">
  ...
  <div class="page-section">
      ...
      <div class="flight-card-inner">
        ...
        <div class="flight-right">
          ...
          <div class="flight-route">
            <div><div class="flight-code"><?= o4e($from_code) ?></div><div class="flight-city"><?= o4e(o4nv($f['from_city'], '')) ?></div></div>
            <div class="flight-middle">
              <?php if ($duration !== '') : ?><div class="flight-duration"><?= o4e($duration) ?></div><?php endif; ?>
              <div class="flight-arrow-line"><div class="fal"></div><div class="fa-arrow">→</div><div class="fal"></div></div>
              <div class="flight-nonstop"><?= o4e($stop_type) ?></div>
            </div>
            <div style="text-align:right;"><div class="flight-code"><?= o4e($to_code) ?></div><div class="flight-city"><?= o4e(o4nv($f['to_city'], '')) ?></div></div>
          </div>
          <div class="flight-footer">
            <div class="ff-item"><span class="ff-icon">⏰</span><div><div class="ff-lbl">Dep:</div><div class="ff-val"><?= o4e(o4nv($f['departure_datetime'], 'NA')) ?></div></div></div>
            <div class="ff-div"></div>
            <div class="ff-item"><span class="ff-icon">⏰</span><div><div class="ff-lbl">Arr:</div><div class="ff-val"><?= o4e(o4nv($f['arrival_datetime'], 'NA')) ?></div></div></div>
            <div class="ff-div"></div>
            <div class="ff-item"><span class="ff-icon">🧳</span><div><div class="ff-lbl">Baggage</div><div class="ff-val"><?= o4e($baggage) ?></div></div></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="sec-heading">Private Transfers</div>
      ...
      <?php foreach ($vehs as $v) :
        $vimg = o4img(isset($v['vehicle_image']) ? $v['vehicle_image'] : '', $assets . 'vehicle.jpg');
      ...
      <div class="transfer-inner">
        ...
        <div class="transfer-body">
          ...
          <div class="transfer-grid">
            <div class="transfer-item"><div class="tlbl">📍 Pickup</div><div class="tval"><?= o4e(o4nv($v['pickup'], 'NA')) ?></div></div>
            <div class="transfer-item"><div class="tlbl">📍 Drop</div><div class="tval"><?= o4e(o4nv($v['drop'], 'NA')) ?></div></div>
            <div class="transfer-item"><div class="tlbl">📅 Start Date</div><div class="tval"><?= o4e(o4nv($v['date'], '')) ?></div></div>
            <div class="transfer-item"><div class="tlbl">📅 End Date</div><div class="tval"><?= o4e(o4_vehicle_end_date($v)) ?></div></div>
          </div>
    ...
    <div class="itin-day">
      ...
      <div class="itin-day-body">
        ...
        <div class="itin-chips">
          ...
          <div class="itin-chip meal"><div class="itin-chip-icon">🍽️</div><div><div class="itin-chip-lbl">Meal Plan</div><div class="itin-chip-val"><?= o4e($day['meal_plan']) ?></div></div></div>
          <?php endif; ?>
          <?php if (!empty($day['overnight_stay'])) : ?>
          <div class="itin-chip stay"><div class="itin-chip-icon">🌙</div><div><div class="itin-chip-lbl">Overnight Stay</div><div class="itin-chip-val"><?= o4e($day['overnight_stay']) ?></div></div></div>
          <?php endif; ?>
        </div>
      </div>
    </div>
      ...
      ?>
    <div class="itin-day">
      <div class="itin-day-body"><div class="itin-prog">Itinerary details will be shared upon confirmation.</div></div>
    </div>
    <?php endif; ?>
  </div>
  ...
  <div class="page-section">
    ...
    <div class="pricing-note" style="margin-bottom:18px;"><?= o4e(o4nv(isset($incx['note']) ? $incx['note'] : '', 'All figures are per package. Taxes & TCS shown separately.')) ?></div>
    ...
    <div class="pricing-grid">
      ...
      <div class="pricing-card<?= $is_featured ? ' featured' : '' ?>">
        <?php if ($is_featured) : ?><div class="rec-badge">⭐ Recommended</div><?php endif; ?>
        <div class="pricing-name"><?= o4e(o4nv($row['package_type'], 'Package')) ?></div>
        <div class="pricing-row"><span>Tour Cost</span><span><?= o4e(o4nv($row['tour_cost_display'], '0')) ?></span></div>
        <div class="pricing-row"><span>Tax</span><span><?= o4e(o4nv($row['tax_display'], '0')) ?></span></div>
        <div class="pricing-row"><span>TCS</span><span><?= o4e(o4nv($row['tcs_display'], '0')) ?></span></div>
        <div class="pricing-row"><span>Travel Cost</span><span><?= o4e(o4nv($row['travel_display'], '0')) ?></span></div>
  ...
  <div class="page-section">
    ...
    <div class="pay-grid">
      <div class="bank-card">
        ...
        <div class="bank-body">
          <div class="bank-item"><div class="bi-lbl">🏛️ Account Name</div><div class="bi-val"><?= o4e(o4nv($bank['account_name'], 'NA')) ?></div></div>
          <div class="bank-item"><div class="bi-lbl"># Account Number</div><div class="bi-val"><?= o4e(o4nv($bank['account_no'], 'NA')) ?></div></div>
          <div class="bank-item"><div class="bi-lbl">🏦 Bank Name</div><div class="bi-val"><?= o4e(o4nv($bank['bank_name'], 'NA')) ?></div></div>
          <div class="bank-item"><div class="bi-lbl">📍 Branch</div><div class="bi-val"><?= o4e(o4nv($bank['branch_name'], 'NA')) ?></div></div>
          <div class="bank-item"><div class="bi-lbl">🔑 IFSC Code</div><div class="bi-val"><?= o4e(o4nv($bank['ifsc_code'], o4nv($bank['swift_code'], 'NA'))) ?></div></div>
          <?php if (!empty($bank['upi_id'])) : ?>
          <div class="bank-item"><div class="bi-lbl">📱 UPI ID</div><div class="bi-val"><?= o4e($bank['upi_id']) ?></div></div>
          <?php endif; ?>
        </div>
      </div>
      <div class="qr-card">
        ...
        <div class="ty-contact-grid">
          ...
          <div class="ty-contact-right">
            <div class="ty-contact-item">
              ...
              <div class="tc-val"><?= o4e(o4nv($ty['company_contact'], o4nv($ty['user_mobile'], ''))) ?></div>
            </div>
            <div class="ty-contact-item">
              <div class="tc-lbl">🌐 Website</div>
              <div class="tc-val"><?= o4e(o4nv($ty['website'], '')) ?></div>
            </div>
            <div class="ty-contact-item">
              <div class="tc-lbl">✉️ Email</div>
              <div class="tc-val"><?= o4e(o4nv($ty['company_email'], '')) ?></div>
            </div>
          </div>
        </div>

...
<section class="transportDetailsPanel transportDetailsLeftPanel main_block side_pad">
  ...
  ?>
    <h6 class="text-center" style="font-size: 16px !important; font-weight: 400 !important;">OPTION - <?= $option . '&nbsp&nbsp' . $cost ?></h6>
    ...
    <div class="row">
      ...
      <div class="col-md-4 passengerPanel endPagecenter mg_bt_30">
        ...
        <div class="icon">
          ...
          <h4 class="no-marg">CWB/CWOB/Infant : <?= $enquiryDetails['children_with_bed'] + $enquiryDetails['children_without_bed'] + $enquiryDetails['total_infant'] ?></h4>
          <i class="fa fa-plus"></i>
        </div>
        <?php

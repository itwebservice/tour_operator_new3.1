...
<head>
  ...
  <link rel="stylesheet" media="all" href="<?= BASE_URL ?>css/print/printQuotationOne/quotationPrint.php"/>
	<link rel="stylesheet" media="all" href="<?= BASE_URL ?>css/print/printQuotationOne/quotationPdf.css"/>
...
<script type="text/javascript">
  // Wait for images/fonts before print — remote header images often miss on live
  // when print fires too early (same fix used by package fit_quotation_html).
  (function() {
    var printed = false;
    function doPrint() {
      if (printed) return;

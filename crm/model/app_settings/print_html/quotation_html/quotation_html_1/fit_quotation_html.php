...
// ---- helpers ---------------------------------------------------------------
if (!function_exists('o1e'))  { function o1e($v){ return htmlspecialchars((string)$v, ENT_QUOTES); } }
if (!function_exists('o1nv')) { function o1nv($v,$f=''){ return ($v!==null && $v!=='') ? $v : $f; } }
// Image url with local-asset fallback when the data has no image.
if (!function_exists('o1img')) { function o1img($url,$fallback){ return (is_string($url) && trim($url)!=='' && stripos($url,'dummy')===false) ? $url : $fallback; } }
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<img src="<?= o1e(o1img($hero['cover_image'], $assets.'hero-singapore.jpg')) ?>" alt="<?= o1e(o1nv($ov['destination'],'Tour')) ?>" class="absolute inset-0 w-full h-full object-cover"/>
...
<div class="relative z-10 px-12 pt-24 text-cream">
...
<?php
  ...
  $strip = array();
  if (!empty($hotels[0]['hotel_photo'])) { $strip[] = $hotels[0]['hotel_photo']; }
  foreach ($itin as $__d) { if (count($strip) >= 4) break; $img = o1img(isset($__d['image'])?$__d['image']:'', ''); if ($img !== '') { $strip[] = $img; } }
...
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Client &amp; Overview</div>
...
<span class="font-display text-2xl text-[color:var(--gold)]">02</span>
</div>
</div>
</div>
...
<div class="mt-2.5 font-display text-lg text-[color:var(--navy)]"><?php $o1n = (int) o1nv($hero['total_nights'], (int)o1nv($hero['total_days'],0)); echo o1e($o1n.' Nights / '.($o1n+1).' Days'); ?></div>
</div>
<div class="rounded-xl bg-white p-4 border border-[color:var(--gold)]/25" style="box-shadow:var(--shadow-card)">
<div class="flex items-center gap-2.5">
<div class="w-9 h-9 rounded-lg grid place-items-center" style="background:var(--gradient-gold)">
...
<div class="mt-2.5 font-display text-lg text-[color:var(--navy)]"><?php
  ...
  if ($o1ad) { $o1parts[] = $o1ad.' Adult'.($o1ad>1?'s':''); }
  if ($o1ch) { $o1parts[] = $o1ch.' Child'.($o1ch>1?'ren':''); }
  if ($o1in) { $o1parts[] = $o1in.' Infant'.($o1in>1?'s':''); }
...
</svg> <?= o1e(o1nv($ov['customer_email'], o1nv($hero['user_email_id'],''))) ?></div>
<div class="flex items-center gap-2">
...
</svg> <?= o1e(o1nv($ov['customer_mobile'], o1nv($hero['user_contact'],''))) ?></div>
<div class="flex items-center gap-2">
...
</svg> <?= o1e(o1nv($ov['destination'],'Destination')) ?></div>
</div>
</div>
</div>
...
<div class="text-cream text-right">
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Accommodation</div>
<div class="font-display text-sm"><?= o1e($hero['quotation_code']) ?> &middot; <?= o1e(o1nv($ov['destination'], $hero['tour_name'])) ?></div>
</div>
<div class="flex items-center gap-2">
<span class="text-[10px] uppercase tracking-[0.25em] opacity-70 text-cream">Page</span>
<span class="font-display text-2xl text-[color:var(--gold)]">03</span>
</div>
</div>
</div>
<div class="relative px-10 py-8">
...
<span class="text-[color:var(--gold)] mr-2">âœ¦</span>Royal Package</div>
</div>
<hr class="gold-rule mt-3"/>
<div class="mt-6 space-y-4">
<?php
$o1_hotels = is_array($hotels) ? $hotels : array();
if (empty($o1_hotels)) { $o1_hotels = array(); }
$o1_hi = 0;
...
<img src="<?= o1e($o1_hphoto) ?>" alt="<?= o1e(o1nv(isset($h['hotel_name'])?$h['hotel_name']:'','Hotel')) ?>" class="col-span-2 h-56 w-full object-cover" loading="lazy"/>
<div class="col-span-3 p-5">
<div class="flex items-center justify-between">
<div class="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.22em] text-[color:var(--teal)]">
...
</svg> <!-- --><?= o1e(o1nv(isset($h['hotel_city'])?$h['hotel_city']:'','')) ?></div>
...
<div class="text-[9px] uppercase tracking-[0.22em] text-[color:var(--navy)]/60">Check-in</div>
<div class="font-display text-sm text-[color:var(--navy)] mt-0.5"><?= o1e(o1nv(isset($h['check_in'])?$h['check_in']:'','NA')) ?></div>
</div>
<div class="rounded-lg bg-[color:var(--cream)] p-2.5 border border-[color:var(--gold)]/20">
<div class="text-[9px] uppercase tracking-[0.22em] text-[color:var(--navy)]/60">Check-out</div>
...
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/30 text-[color:var(--navy)] border border-[color:var(--gold)]/30">Wi-Fi</span>
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/30 text-[color:var(--navy)] border border-[color:var(--gold)]/30">Breakfast</span>
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/30 text-[color:var(--navy)] border border-[color:var(--gold)]/30">Pool</span>
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/30 text-[color:var(--navy)] border border-[color:var(--gold)]/30">Spa</span>
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/30 text-[color:var(--navy)] border border-[color:var(--gold)]/30">Gym</span>
...
<div class="relative px-10 py-7 space-y-6">
<div>
<div class="flex items-center justify-between">
...
<div class="flex items-center justify-between">
<div>
<div class="font-display text-2xl text-[color:var(--navy)]"><?= o1e(o1nv(isset($f['from_city'])?$f['from_city']:'','From')) ?></div>
<div class="text-[10px] text-[color:var(--ink)]/60 uppercase tracking-wide">Departure</div>
</div>
...
<div class="font-display text-2xl text-[color:var(--navy)]"><?= o1e(o1nv(isset($f['to_city'])?$f['to_city']:'','To')) ?></div>
<div class="text-[10px] text-[color:var(--ink)]/60 uppercase tracking-wide">Arrival</div>
</div>
</div>
...
<div class="font-display text-[13px] text-[color:var(--navy)]"><?= o1e(o1nv(isset($f['departure_datetime'])?$f['departure_datetime']:'','NA')) ?></div>
</div>
<div>
<div class="uppercase tracking-[0.2em] text-[color:var(--navy)]/60">Arrival</div>
<div class="font-display text-[13px] text-[color:var(--navy)]"><?= o1e(o1nv(isset($f['arrival_datetime'])?$f['arrival_datetime']:'','NA')) ?></div>
</div>
</div>
</div>
</div>
...
<img src="<?= o1e($o1_dimg) ?>" alt="<?= o1e($o1_dtitle) ?>" class="w-full h-full object-cover absolute inset-0" loading="lazy"/>
...
</svg> <!-- --><?= o1e(o1nv(isset($d['overnight_stay'])?$d['overnight_stay']:'', $o1_dtitle)) ?></div>
<?php endif; ?>
...
<?php if (!empty($d['special_attraction'])): ?>
<span class="text-[10px] px-2.5 py-1 rounded-full bg-[color:var(--gold-soft)]/40 text-[color:var(--navy)] border border-[color:var(--gold)]/30">&#10022; <?= o1e($d['special_attraction']) ?></span>
<?php endif; ?>
...
</svg> <!-- -->Supertree Grove &amp; Cloud Forest</div>
...
if (empty($o1_included_items)) { $o1_included_items = array('Inclusions will be shared as per final quotation.'); }
...
if (empty($o1_excluded_items)) { $o1_excluded_items = array('Exclusions will be shared as per final quotation.'); }
...
<div class="text-cream text-right">
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Payment</div>
<div class="font-display text-sm"><?= o1e($hero['quotation_code']) ?> &middot; <?= o1e(o1nv($ov['destination'], $hero['tour_name'])) ?></div>
</div>
<div class="flex items-center gap-2">
<span class="text-[10px] uppercase tracking-[0.25em] opacity-70 text-cream">Page</span>
...
<div class="text-cream text-right">
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Reviews</div>
<div class="font-display text-sm"><?= o1e($hero['quotation_code']) ?> &middot; <?= o1e(o1nv($ov['destination'], $hero['tour_name'])) ?></div>
</div>
<div class="flex items-center gap-2">
<span class="text-[10px] uppercase tracking-[0.25em] opacity-70 text-cream">Page</span>
...
<div class="w-20 h-20 rounded-full grid place-items-center text-cream font-display text-2xl" style="background:var(--gradient-navy)"><?= o1e(strtoupper(substr(o1nv(isset($t['name'])?$t['name']:'T','T'),0,1))) ?></div>
<div class="font-display text-sm text-[color:var(--navy)] mt-2 text-center"><?= o1e(o1nv(isset($t['name'])?$t['name']:'','Traveller')) ?></div>
<div class="text-[10px] uppercase tracking-[0.18em] text-[color:var(--teal)]"><?= o1e(o1nv(isset($t['title'])?$t['title']:'','Customer')) ?></div>
</div>
<div class="col-span-5 relative">
<div class="font-display text-6xl text-[color:var(--gold)]/40 absolute -top-4 -left-1 leading-none">&quot;</div>
<p class="font-serif-soft italic text-[15px] text-[color:var(--ink)]/85 pl-6"><?= o1e(o1nv(isset($t['message'])?$t['message']:'','')) ?></p>
...
<div class="text-cream text-right">
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Terms &amp; Conditions</div>
<div class="font-display text-sm"><?= o1e($hero['quotation_code']) ?> &middot; <?= o1e(o1nv($ov['destination'], $hero['tour_name'])) ?></div>
</div>
<div class="flex items-center gap-2">
<span class="text-[10px] uppercase tracking-[0.25em] opacity-70 text-cream">Page</span>
...
<section class="page relative" style="--wm-url:url(assets/globe-watermark.png)">
<div class="watermark" style="background-image:url(assets/globe-watermark.png)">
</div>
<div class="header-strip">
<div class="px-10 py-4 flex items-center justify-between">
...
<div class="text-cream text-right">
<div class="text-[10px] uppercase tracking-[0.3em] opacity-70">Thank You</div>
<div class="font-display text-sm"><?= o1e($hero['quotation_code']) ?> &middot; <?= o1e(o1nv($ov['destination'], $hero['tour_name'])) ?></div>
</div>
<div class="flex items-center gap-2">
<span class="text-[10px] uppercase tracking-[0.25em] opacity-70 text-cream">Page</span>
...
</svg> <?= o1e(o1nv($ty['company_contact'],'')) ?></div>
<div class="flex items-center gap-2">
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-3.5 h-3.5 text-[color:var(--teal)]" aria-hidden="true">
<path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7">
</path>
...
</svg> <?= o1e(o1nv($ty['company_email'],'')) ?></div>
<div class="flex items-center gap-2">
...
</svg> <?= o1e(o1nv($ty['user_mobile'], o1nv($ty['company_contact'],''))) ?></div>
<div class="flex items-center gap-2">
...
// ---------------------------------------------------------------------------
// Auto-print trigger.
// "Download as PDF" loads this page inside a hidden iframe (loadOtherPage in
// footer_scripts.js) and relies on the page calling window.print() itself.
//

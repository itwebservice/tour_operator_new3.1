          ...
          ?>
            <div class="rounded-xl overflow-hidden bg-white border border-[color:var(--gold)]/25 grid grid-cols-5" style="box-shadow:var(--shadow-card)">
              ...
              <div class="col-span-3 p-5">
                ...
                <div class="text-[13px] font-serif-soft italic text-[color:var(--ink)]/70 mt-0.5"><?= o1e(o1nv(isset($h['room_category']) ? $h['room_category'] : '', '')) ?><?php if (!empty($h['package_type']) && count($o1_hotels_by_pkg) <= 1): ?> · <?= o1e($h['package_type']) ?><?php endif; ?></div>

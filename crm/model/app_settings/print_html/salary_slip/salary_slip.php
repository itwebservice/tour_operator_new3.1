		...
		<div class="col-xs-12">
			<div class="print_info_block">
				<ul class="main_block noType">
					<?php $cust_name=mysqli_fetch_assoc(mysqlQuery("select * from emp_master where emp_id='$emp_id'")); ?>
...
<section class="print_sec main_block">
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-right" style="border-right: 1px solid #ddd !important"><?= $sq_salary['phone_allowance']?></td>
			<td></td>
			<td class="text-right" style="border-right: 1px solid #ddd !important"></td>
		</tr>
		<tr>
			<td>Misc Earning</td>
			<td class="text-right" style="border-right: 1px solid #ddd !important"><?= $sq_salary['misc_earning']?></td>
			<td></td>
			<td class="text-right" style="border-right: 1px solid #ddd !important"></td>
		</tr>
	</tbody>

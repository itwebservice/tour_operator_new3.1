         ...
         <div class="table-responsive">
          <table class="table table-bordered no-marg" id="tbl_emp_list">
            ...
            {  
              ...
              $q_transport_info = mysqli_fetch_assoc(mysqlQuery("select * from package_tour_transport_master where booking_id='$row_tr_acc[booking_id]' and transport_bus_id='$row_tr_acc[transport_bus_id]'"));
            ?>
                <tr>

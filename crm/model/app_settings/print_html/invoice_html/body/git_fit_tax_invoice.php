...
$sq_sup_state = mysqli_fetch_assoc(mysqlQuery("select * from state_master where id='$sq_app[state_id]'"));
    ...
    <div class="col-md-4">  
      <div class="inv_rece_header_right text-right">  
        <ul class="no-pad no-marg font_s_12"> 
          ...
          <li style="list-style-type:none;"><p><?php echo ($branch_status=='yes') ? $branch_details['address1'].','.$branch_details['address2'].','.$branch_details['city'] : $app_address ?></p></li>  
          <li style="list-style-type:none;"><i class="fa fa-phone" style="margin-right: 5px;"></i> <?php echo ($branch_status=='yes') ?   
         ...
         <div class="table-responsive">
          <table class="table no-marg gst_invoice" style="padding: 0 !important;">
            <tr>
              ...
              <td class="col-md-8"><?=  ($branch_status=='yes') ? $branch_details['bank_name'] : $bank_name_setting ?></td>
            </tr>
            <tr>
              <td class="text-right col-md-4">Bank A/C No. :</td>
              <td class="col-md-8"><?=  ($branch_status=='yes') ? $branch_details['bank_acc_no'] : $bank_acc_no ?></td>
            </tr>
            <tr>
              <td class="text-right col-md-4">Branch IFSC Code :</td>
              <td class="col-md-8"><?= ($branch_status=='yes') ? $branch_details['ifsc_code'] : $bank_ifsc_code ?></td>
            </tr>
          </table>
         </div>
       </div>

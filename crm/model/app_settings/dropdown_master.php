...
{
  $final_array = array();
  $sq_query = mysqlQuery("select dest_id,dest_name from destination_master where status='Active' order by dest_name asc");
  ?>
...
//Get Train Class dropdown
function get_flight_class_dropdown($class = NULL)
{ ?>

  <option value="">*Class</option>
  <option value="First Class" <?php if(isset($class)){if($class=='First Class'){echo 'selected';}} ?>>First Class</option>
  <option value="Economy" <?php if(isset($class)){if($class=='Economy'){echo 'selected';}} ?>>Economy</option>
  <option value="Premium Economy" <?php if(isset($class)){if($class=='Premium Economy'){echo 'selected';}} ?>>Premium Economy</option>
  <option value="Business" <?php if(isset($class)){if($class=='Business'){echo 'selected';}} ?>>Business</option>
  <option value="Other" <?php if(isset($class)){if($class=='Other'){echo 'selected';}} ?>>Other</option>

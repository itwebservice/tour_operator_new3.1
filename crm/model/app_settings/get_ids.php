...
function get_receipt_payment_id($id,$receipt_type,$year = ''){ global $app_version;
  $trans_id = ($receipt_type == 'Receipt') ? 'RC/'.$year.'/'.$id : 'PM/'.$year.'/'.$id;
  return $trans_id; }
...
function get_booking_id($module,$year = ''){ $booking_id = ""; if($module==""){  } global $app_version;
...
function get_flight_supplier_payment_id($payment_id,$year = ''){ global $app_version;
  $year = ($year == '') ? $app_version : $year;  return 'ASP/'.$year.'/P/'.$payment_id; }

//visa supplier payment ID
function get_visa_supplier_payment_id($payment_id,$year = ''){ global $app_version;
  $year = ($year == '') ? $app_version : $year;  return 'VSP/'.$year.'/P/'.$payment_id; }
...
function get_custadv_payment_id($payment_id,$year = ''){ global $app_version;
  ...
  //customer Advance payment ID
  function get_puradv_payment_id($payment_id,$year = ''){ global $app_version;
    $year = ($year == '') ? $app_version : $year;  return 'PAP/'.$year.'/P/'.$payment_id; }
?>

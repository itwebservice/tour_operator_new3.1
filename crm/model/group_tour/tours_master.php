...

{
  ...
  $seo_slug = mysqlREString($seo_slug);
  $tour_note = mysqlREString($tour_note);  
  ...
  $dest_image = mysqlREString($dest_image); 
   ...
   $sq = mysqlQuery("insert into tour_master(tour_id, tour_name, seo_slug, tour_type,tour_note, adult_cost, child_with_cost,child_without_cost, infant_cost, with_bed_cost,single_person_cost,visa_country_name,company_name, inclusions, exclusions, active_flag,pdf_url,dest_id,dest_image) values('$max_tour_id', '$tour_name', '$seo_slug', '$tour_type', '$tour_note', '$adult_cost', '$child_with_cost','$child_without_cost', '$infant_cost', '$with_bed_cost', '$single_person_cost','$visa_country_name','$company_name', '$inclusions', '$exclusions', '$active_flag','$pdf_url','$dest_name','$dest_image') ");
...

{
  ...
  $txt_tour_note = mysqlREString($txt_tour_note);

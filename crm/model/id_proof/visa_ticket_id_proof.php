...
class visa_ticket_id_proof
{
	...
	public function visa_ticket_pan_card_upload()
	{
		...
		$sq = mysqlQuery("update visa_master_entries set pan_card_url='$id_proof_url', pan_card_url3='$id_proof_url3', pan_card_url4='$id_proof_url4' where entry_id='$entry_id'");
		if($sq){
			echo "ID Proof uploaded successfully!";
			exit;
		}	

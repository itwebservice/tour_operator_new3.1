...
class package_master_tariff{
    ...
    function save(){
        ...
        $offer_from_date_array = isset($_POST['offer_from_date_array'])?$_POST['offer_from_date_array']:[];
        $offer_to_date_array = isset($_POST['offer_to_date_array']) ?$_POST['offer_to_date_array'] : [];
        ...
        $offer_amount_array = isset($_POST['offer_amount_array']) ? $_POST['offer_amount_array'] : [];
        $agent_array = isset($_POST['agent_array']) ? $_POST['agent_array'] : [];
		...
		for($i=0; $i<sizeof($offer_from_date_array); $i++){
			...
			$offer_from_date_array[$i] = $offer_from_date_array[$i];
			$offer_to_date_array[$i] = $offer_to_date_array[$i];
	...
	function update(){
        ...
        $offer_amount_array = isset($_POST['offer_amount_array']) ? $_POST['offer_amount_array'] : [];
        $agent_array = isset($_POST['agent_array']) ? $_POST['agent_array'] : [];
        $offer_id_array = isset($_POST['offer_id_array']) ? $_POST['offer_id_array'] : [];
        $offer_checked_id_array = isset($_POST['offer_checked_id_array']) ? $_POST['offer_checked_id_array'] : [];

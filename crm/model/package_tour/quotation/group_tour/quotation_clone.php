...
public function quotation_master_clone()
{
	...
	$cols=array();
	$result = mysqlQuery("SHOW COLUMNS FROM group_tour_quotation_master"); 
	 while ($r=mysqli_fetch_assoc($result)) {
	   $cols[]= $r["Field"];
	}

	  $result = mysqlQuery("SELECT * FROM group_tour_quotation_master WHERE quotation_id='$quotation_id'");
...
public function clone_train_entries($quotation_id, $quotation_max){
	...
	$result = mysqlQuery("SHOW COLUMNS FROM group_tour_quotation_train_entries"); 
	 while ($r=mysqli_fetch_assoc($result)) {
	   $cols[]= $r["Field"];
	}


	  $result = mysqlQuery("SELECT * FROM group_tour_quotation_train_entries WHERE quotation_id='$quotation_id'");
	  while($r=mysqli_fetch_array($result)) {
...
public function clone_plane_entries($quotation_id, $quotation_max){
	...
	$cols=array();
	$result = mysqlQuery("SHOW COLUMNS FROM group_tour_quotation_plane_entries"); 
	 while ($r=mysqli_fetch_assoc($result)) {
	   $cols[]= $r["Field"];
	}

	  $result = mysqlQuery("SELECT * FROM group_tour_quotation_plane_entries WHERE quotation_id='$quotation_id'");
	  while($r=mysqli_fetch_array($result)) {
...
public function clone_cruise_entries($quotation_id, $quotation_max){
	...
	$result = mysqlQuery("SHOW COLUMNS FROM group_tour_quotation_cruise_entries"); 
	 while ($r=mysqli_fetch_assoc($result)) {
	   $cols[]= $r["Field"];
	}


	  $result = mysqlQuery("SELECT * FROM group_tour_quotation_cruise_entries WHERE quotation_id='$quotation_id'");
	  while($r=mysqli_fetch_array($result)) {

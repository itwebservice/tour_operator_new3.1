...
$txt_tour_note = $_POST['txt_tour_note'];
...
$visa_country_name = isset($_POST['visa_country_name']) ? $_POST['visa_country_name'] : '';
$company_name = isset($_POST['company_name']) ? $_POST['company_name'] : '';
$inclusions = $_POST['inclusions'];
$exclusions = $_POST['exclusions'];
$dest_image = isset($_POST['dest_image']) ? $_POST['dest_image'] : '';

...
class b2b_refund_estimate{
    ...
    function refund_estimate(){
        ...
        $sq_refund = mysqlQuery("update b2b_booking_master set cancel_amount='$cancel_amount', total_refund_amount='$total_refund_amount',estimate_flag='1',`tax_value`='$tax_value', `tax_amount`='$tour_service_tax_subtotal', `cancel_amount_exc`='$cancel_amount_exc'  where booking_id='$booking_id'");

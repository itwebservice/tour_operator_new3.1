...
class miscellaneous_payment_master
{
	...
	public function payment_update_email_notification_send($payment_id)
	{
		...
		$total_amount = $sq_visa_info['misc_total_cost'] + (float)($credit_card_amount);

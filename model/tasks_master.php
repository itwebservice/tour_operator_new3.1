...
public function tasks_master_clone()
{
	...
	$sq_task_update = mysqlQuery("update tasks_master set extra_note='$extra_note', task_status='Closed' where task_id='$reference_task_id'");
...
{
  $sq = mysqlQuery("update tasks_master set task_status='Disabled' where task_id='$task_id'");
  if(!$sq){

...
$sq_cust = mysqli_fetch_assoc(mysqlQuery("select * from customer_master where customer_id='$package_booking_info[customer_id]'"));
...
<section class="print_header main_block" style="margin-bottom: 0 !important;">
  ...
  <div class="col-md-8 no-pad">
    <div class="print_header_contact text-right">
      ...
      <p class="no-marg"><i class="fa fa-phone" style="margin-right: 5px;"></i> <?php echo ($branch_status == 'yes') ? $branch_details['contact_no'] : $app_contact_no ?></p>
      <p><i class="fa fa-envelope" style="margin-right: 5px;"></i> <?php echo ($branch_status == 'yes' && $branch_details['email_id'] != '') ? $branch_details['email_id'] : $app_email_id; ?></p>
    </div>
  </div>
</section>
  ...
  <div class="row">
    <div class="col-md-12 mg_bt_20">
      <ul class="print_info_list no-pad noType">
        ...
        <li><span>CUSTOMER NAME :</span> <?= $cust_name ?></li>
        <li><span>CONTACT NUMBER :</span> <?= $package_booking_info['phone_no'] ?></li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-md-8 mg_bt_20">
      <ul class="print_info_list no-pad noType">
  ...
  <section class="print_sec main_block">
    ...
    <div class="row">
      <div class="col-md-12 mg_bt_10">
        <ul class="print_info_list no-pad noType">
          <li><span>PICKUP LOCATION :</span> <?= $enq_data[0]->pickup_from ?> </li>
        </ul>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 mg_bt_10">
        <ul class="print_info_list no-pad noType">
          <li><span>PICKUP DATE&TIME :</span> <?= $enq_data[0]->pickup_time ?></li>
        </ul>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 mg_bt_10">
        <ul class="print_info_list no-pad noType">
          <li><span>DROPOFF LOCATION :</span> <?= $enq_data[0]->drop_to ?></li>
        </ul>
      </div>
    </div>
  </section>
...
<!-- Note -->
<?php
if (isset($sq_pckg['note']) && $package_booking_info['service'] == 'Holiday') {
?>
  <section class="print_sec main_block">
    <div class="row">
      <div class="col-md-12">

		...
		<div class="col-md-6 pl_sheet">
			<div class="panel panel-default main_block">
				...
				<div class="quadrant main_block">
					...
					$count_d = 1;
					$head_count_d = 1;
					$sq_head = mysqlQuery("select head_name,head_id from head_master where head_id in('1','8','3','6')");
					...
					?>
						...
						?>
								...
								<div class="part_heading main_block">
									<h4 class="main_block">
										<div class="col-md-6 col-md-offset-1 no-pad"><?= $row_subgroup['subgroup_name'] ?></div>
										<div class="col-md-4 no-pad text-right">
										...
										if ($row_q['ledger_id'] == '165') {
											...
											while ($row_balance = mysqli_fetch_assoc($sq_opening_balance)) {
												if ($countp == 0) {
													...
													if ($row_balance['payment_side'] == 'Credit') {
														$total_sub_group_amount_d += $total_amount;
													}
													$countp++;
												}
		...
		<div class="col-md-6 pl_sheet">
			<div class="panel panel-default main_block">
				...
				<div class="quadrant main_block">
					...
					$count = 1;
					$head_count = 1;
					$sq_head = mysqlQuery("select head_id,head_name from head_master where head_id in('2','7') order by head_id desc");
					while ($row_head = mysqli_fetch_assoc($sq_head)) { //1st Head(D1)
					?>
						<!-- List Heading -->
						<div class="list_heading main_block">
							<div class="col-md-8 no-pad">
				...
				<div class="panel-footer main_block"><!-- Total -->
					<div class="row">
						<div class="col-md-8"><strong>Total :</strong></div>

            ...
            <div class="print_info_block">
              <?php for ($i = 0; $i < sizeof($hotel_traveller_arr); $i++) {
                if ($hotel_id == $hotel_traveller_arr[$i]->service->id) { ?>
                  ...
                  ?>
                    <ul class="main_block noType">
                      <li class="col-md-12 mg_tp_10">
                        <h6><?= 'Room ' . ($j + 1) . ' Category : ' . $room_cat ?></h6>
                      </li>
                    </ul>
                    <ul class="main_block noType">
                      <!-- Adults -->
              ...
              <?php if (isset($sq_service_voucher['sp_request'])) { ?>
                <div class="row">
                  <div class="col-md-12">
                    <ul class="main_block noType">
...
if (sizeof($transfer_list_arr) > 0) {
  ...
  ?>
    <div class="repeat_section main_block">
      ...
      <section class="print_sec main_block">
        <div class="row">
          ...
          for ($j = 0; $j < count(array($services)); $j++) {
            ...
            <div class="col-md-6 mg_bt_20">
              <ul class="print_info_list no-pad noType">
                <li><span>SERVICE DURATION :</span> <?= $transfer_list_arr[$i]->service->service_arr[$j]->duration ?></li>
              </ul>
            </div>
          <?php } ?>
        </div>
      ...
      if (isset($sq_canc['cancellation_policy'])) { ?>
        <section class="print_sec main_block">
          <div class="row">
            <div class="col-md-12">
              <div class="section_heding">
...
if (sizeof($activity_list_arr) > 0) {
  for ($i = 0; $i < sizeof($activity_list_arr); $i++) {
    ...
    <!-- Terms and Conditions -->
    <?php
    if (isset($sq_exc['terms_condition'])) { ?>
      <section class="print_sec main_block">
        <div class="row">
          <div class="col-md-12">
            <div class="section_heding">
    ...
    <!-- Booking Policy -->
    <?php
    if (isset($sq_exc['booking_policy'])) { ?>
      <section class="print_sec main_block">
        <div class="row">
          <div class="col-md-12">
            <div class="section_heding">
        ...
        <ul class="print_itinenary main_block no-pad no-marg">
          ...
          ?>
            <li class="singleItinenrary leftItinerary col-md-12 no-pad mg_bt_20">
              <div class="dayCount">
                <h4>Day-<?= $count . ' ' . $day . ' (' . $date_format . ')' ?></h4>
              </div>
...
if (sizeof($group_list_arr) > 0) {
  ...
  for ($i = 0; $i < sizeof($group_list_arr); $i++) {
    ...
    for ($j = 0; $j < count(array($services)); $j++) {
      ...
      $package_id = $group_list_arr[$i]->service->id;
    ...
    ?>
      <div class="repeat_section main_block">
        <img src="<?= BASE_URL ?>Tours_B2B/images/vouchers/holiday-service-voucher.jpg" class="watermark">
        <section class="print_header">
          <div class="col-md-6 no-pad">
            <!-- <span class="title"><i class="fa fa-file-text"></i> GROUP TOUR VOUCHER</span> -->
            <div class="print_header_logo">
              <img src="<?= $company_logo_url ?>" class="img-responsive mg_tp_10">
            </div>
          </div>
        ...
        <section class="print_sec main_block">
          ...
          <div class="row">
            <div class="col-md-12 mg_bt_20">
              <ul class="print_info_list no-pad noType">
                <li><span>TOUR NAME :</span> <?= $group_list_arr[$i]->service->service_arr[$j]->tour_name ?></li>
              </ul>
            </div>
            <div class="col-md-6 mg_bt_20">
              <ul class="print_info_list no-pad noType">
                <li><span>TRAVEL DATE :</span> <?= $tour_group[1] ?></li>
              </ul>
            </div>
            <div class="col-md-6 mg_bt_20">
              <ul class="print_info_list no-pad noType">
                <li><span>TOTAL GUEST :</span> <?= intval($group_list_arr[$i]->service->service_arr[$j]->adult) + intval($group_list_arr[$i]->service->service_arr[$j]->childwo) + intval($group_list_arr[$i]->service->service_arr[$j]->childwo) + intval($group_list_arr[$i]->service->service_arr[$j]->childwi) + intval($group_list_arr[$i]->service->service_arr[$j]->infant) ?></li>
                <li><span>EXTRA BED :</span> <?= intval($group_list_arr[$i]->service->service_arr[$j]->extra_bed) ?></li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="table-responsive">
                  <table width="300px !important;" class="table table-bordered" id="tbl_emp_list">
                    <thead>
                      <tr class="table-heading-row">
                        <th>City</th>
                        <th>Hotel Name</th>
        ...
        <!-- traveling Information -->
        <?php
        $sq_hotelc = mysqli_num_rows(mysqlQuery("select * from group_train_entries where tour_id = '$package_id'"));
        if ($sq_hotelc != 0) { ?>
          <section class="travelingDetails main_block mg_tp_30">
            <div class="section_heding">
              <h2>Train Details</h2>
        ...
        <?php
        $sq_hotelc = mysqli_num_rows(mysqlQuery("select * from group_tour_plane_entries where tour_id = '$package_id'"));
        if ($sq_hotelc != 0) { ?>
          <section class="travelingDetails main_block mg_tp_30">
            <div class="section_heding">
        ...
        <?php
        $sq_hotelc = mysqli_num_rows(mysqlQuery("select * from group_cruise_entries where tour_id = '$package_id'"));
        if ($sq_hotelc != 0) { ?>
          <section class="travelingDetails main_block mg_tp_30">
            <div class="section_heding">
        ...
        <section class="itinerarySec main_block side_pad mg_tp_30">
          ...
          <ul class="print_itinenary main_block no-pad no-marg">
            ...
            while ($row_itinarary = mysqli_fetch_assoc($sq_package_program)) {
              ...
              $day = isset($iti_days[$k]) ? $iti_days[$k] : '';
            ?>
              <li class="singleItinenrary leftItinerary col-md-12 no-pad mg_bt_10">
                <div class="dayCount">
                  <h4>Day-<?= $count . ' ' . $day . ' (' . $date_format . ')' ?></h4>
                </div>
                <div class="itneraryContent col-md-12 no-pad mg_tp_10">

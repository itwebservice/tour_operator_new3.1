...
$sq_cost =  mysqli_fetch_assoc(mysqlQuery("select * from package_tour_quotation_costing_entries where quotation_id = '$quotation_id' order by sort_order"));
...
<body>
    ...
    <section id="3" class="main_block link_page_section">
        ...
        <div class="container">
                                    ...
                                    ?>
                                        <div class="row mg_bt_10">
                                            <ul class="main_block">
                                                ...
                                                <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                                                    <span>Tcs :<?php if ($tcsper >= 1) {
                                                                    echo "(" . $tcsper . "%)";
                                                                } ?>: </span><?= $tcs_amount_show ?>
            ...
            <section id="15" class="main_block link_page_section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 in_ex_tab">
                            ...
                            <ul class="nav nav-tabs responsive" role="tablist">
                                ...
                                <li role="presentation"><a href="#misc_desc" aria-controls="misc_desc" role="tab"
                                        data-toggle="tab">Miscellaneous Description</a></li>
                            </ul>
                            ...
                            <div class="tab-content responsive">
                                ...
                                <div role="tabpanel" class="tab-pane" id="terms">
                                    <pre><?php
                                            $sq_terms_cond_count = mysqli_num_rows(mysqlQuery("select dest_id from terms_and_conditions where type='Package Quotation' and dest_id='$sq_tours_package[dest_id]' and active_flag ='Active'"));
                                            $dest_id = ($sq_terms_cond_count != 0) ? $sq_tours_package['dest_id'] : 0;
                                            $sq_query = mysqli_fetch_assoc(mysqlQuery("select * from terms_and_conditions where type='Package Quotation' and dest_id='$dest_id' and active_flag ='Active'"));
                                            echo isset($sq_query['terms_and_conditions']) ? $sq_query['terms_and_conditions'] : '' ?></pre>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="profile">
                                    <pre><?php echo $sq_quotation['exclusions']; ?></pre>
                                </div>

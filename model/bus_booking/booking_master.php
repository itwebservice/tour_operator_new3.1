...
class booking_master
{
    public function booking_save()
    {
        ...
        $company_name_arr = isset($_POST['company_name_arr']) ? $_POST['company_name_arr'] : [];
        $bus_type_arr = isset($_POST['bus_type_arr']) ? $_POST['bus_type_arr'] : [];
        $bus_type_new_arr = isset($_POST['bus_type_new_arr']) ? $_POST['bus_type_new_arr'] : [];
        $pnr_no_arr = isset($_POST['pnr_no_arr']) ? $_POST['pnr_no_arr'] : [];
        $origin_arr = isset($_POST['origin_arr']) ? $_POST['origin_arr'] : [];
        $destination_arr = isset($_POST['destination_arr']) ? $_POST['destination_arr'] : [];
        $date_of_journey_arr = isset($_POST['date_of_journey_arr']) ? $_POST['date_of_journey_arr'] : [];
        $reporting_time_arr = isset($_POST['reporting_time_arr']) ? $_POST['reporting_time_arr'] : [];
        $boarding_point_access_arr = isset($_POST['boarding_point_access_arr']) ? $_POST['boarding_point_access_arr'] : [];
        ...
        for ($i = 0; $i < sizeof($company_name_arr); $i++) {
            ...
            $company_name_arr[$i] = isset($company_name_arr[$i]) ? $company_name_arr[$i] : '';
            $bus_type_arr[$i] = isset($bus_type_arr[$i]) ? $bus_type_arr[$i] : '';
            $bus_type_new_arr[$i] = isset($bus_type_new_arr[$i]) ? $bus_type_new_arr[$i] : '';
            $pnr_no_arr[$i] = isset($pnr_no_arr[$i]) ? $pnr_no_arr[$i] : '';
            $origin_arr[$i] = isset($origin_arr[$i]) ? $origin_arr[$i] : '';
            $destination_arr[$i] = isset($destination_arr[$i]) ? $destination_arr[$i] : '';
            $date_of_journey_arr[$i] = isset($date_of_journey_arr[$i]) ? $date_of_journey_arr[$i] : '';
            $reporting_time_arr[$i] = isset($reporting_time_arr[$i]) ? $reporting_time_arr[$i] : '';
            $boarding_point_access_arr[$i] = isset($boarding_point_access_arr[$i]) ? $boarding_point_access_arr[$i] : '';
    ...
    function booking_delete()
    {
        ...
        $transaction_master->updated_entries('Bus Sale', $booking_id, $trans_id, $net_total, 0);
...

    {
        ...
        for ($i = 0; $i < sizeof($company_name_arr); $i++) {
            ...
            $e_checkbox_arr[$i] = isset($e_checkbox_arr[$i]) ? $e_checkbox_arr[$i] : '';
        ...
        if ((float)($old_total) != (float)($net_total)) {
            ...
            $trans_id = get_bus_booking_id($booking_id, $year) . ' : ' . $cust_name;
            $transaction_master->updated_entries('Bus Sale', $booking_id, $trans_id, $old_total, $net_total);
        }

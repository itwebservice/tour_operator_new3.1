...
class enquiry_master1{
    ...
    public function homepage_enq(){
        ...
        $model->app_email_send('5',$app_name,$app_email_id, $content,$subject,'1');
	...
	public function actions_enq(){
        ...
        if($type == '1' || $type == '2' || $type == '3' || $type == '6'){
            ...
            if($type == '1' || $type == '2'){
                ...
                array_push($enquiry_content,array("name"=>"visa_country_name","value"=>$country_named),array("name"=>"visa_type","value"=>"$visa_type[0]"),array("name"=>"total_adult","value"=>($adults)),array("name"=>"total_children","value"=>$child),array("name"=>"total_infant","value"=>$infant),array("name"=>"total_members","value"=>$pax),array("name"=>"budget","value"=>""));
            }

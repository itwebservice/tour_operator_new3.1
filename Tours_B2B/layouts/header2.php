...
$credit_amount = isset($_SESSION['credit_amount']) ? $_SESSION['credit_amount'] : 0;
$agent_flag = isset($_SESSION['agent_flag']) ? $_SESSION['agent_flag'] : '';
$user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '';
$full_name = '';
$user_mobile_no = $sq_query['mobile_no'];
if ($agent_flag == '0') {
                ...
                <div class="c-userProf dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <div class="userHeading">
                      ...
                      <h4 class="userName"><?= $sq_query['company_name'] . $full_name ?></h4>

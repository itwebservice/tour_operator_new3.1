            ...
            <div class="cartBody">
                <div class="c-travellerDtls">
                    ...
                    for($i=0;$i<sizeof($group_list_arr);$i++){
                        ...
                        $tour_group = explode('=',$group_list_arr[$i]['service']['service_arr'][0]['tour_group']);
                        $adult = $group_list_arr[$i]['service']['service_arr'][0]['adult'];
                        $childwo = $group_list_arr[$i]['service']['service_arr'][0]['childwo'];
                        $childwi = $group_list_arr[$i]['service']['service_arr'][0]['childwi'];
                        $infant = $group_list_arr[$i]['service']['service_arr'][0]['infant'];
                        $extra_bed = $group_list_arr[$i]['service']['service_arr'][0]['extra_bed'];
                        ?>

                        <div class="title"><?= stripslashes($group_list_arr[$i]['service']['service_arr'][0]['tour_name']).' ('.$tour_group[1].')' ?></div>
                            <!-- Adult -->
                            <?php
                            for($i_room=0;$i_room<intval($adult);$i_room++){
                                ...
                                <div class="row c-infoRow">
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'honorofic'?>" title="Select Honorific" data-toggle="tooltip">
                                                <option value="Mr.">Mr.</option>
                                                <option value="Mrs.">Mrs.</option>
                                                <option value="Ms.">Ms.</option>
                                                <option value="Dr.">Dr.</option>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*First Name" name ="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'fname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'fname'?>" title="Enter First Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Last Name" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'lname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'lname'?>" title="Enter Last Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Birthdate" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'bdate'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'bdate'?>" title="Enter Birthdate" data-toggle="tooltip" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width"  id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'meal'?>" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'adult'.'meal'?>" title="Meal Preference" data-toggle="tooltip">
                                                <option value="">Meal Preference</option>
                                                <option value="Jain Special">Jain Special</option>
                                                <option value="Veg">Veg</option>
                                                <option value="Non Veg">Non Veg</option>
                                ...
                                <script>
                                $('#'+'g'+<?=$group_list_arr[$i]['service']['id']?>+<?=$i_room?>+'adult'+'bdate').datetimepicker({ format:'d/m/Y', timepicker:false});
                                </script>
                                <?php
                            } ?>
                            <!-- Adult End -->
                            ...
                            for($i_room=0;$i_room<intval($childwo);$i_room++){
                                ...
                                <div class="row c-infoRow">
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'honorofic'?>" title="Select Honorific" data-toggle="tooltip">
                                                <option value="Mr.">Mr.</option>
                                                <option value="Mrs.">Mrs.</option>
                                                <option value="Ms.">Ms.</option>
                                                <option value="Dr.">Dr.</option>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*First Name" name ="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'fname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'fname'?>" title="Enter First Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Last Name" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'lname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'lname'?>" title="Enter Last Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Birthdate" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'bdate'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'bdate'?>" title="Enter Birthdate" data-toggle="tooltip" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width"  id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'meal'?>" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwo'.'meal'?>" title="Meal Preference" data-toggle="tooltip">
                                                <option value="">Meal Preference</option>
                                                <option value="Jain Special">Jain Special</option>
                                                <option value="Veg">Veg</option>
                                                <option value="Non Veg">Non Veg</option>
                                ...
                                <script>
                                    $('#'+'g'+<?=$group_list_arr[$i]['service']['id']?>+<?=$i_room?>+'childwo'+'bdate').datetimepicker({ format:'d/m/Y', timepicker:false});
                                </script>
                                <?php
                            } ?>
                            <!-- Child Without End-->
                            ...
                            for($i_room=0;$i_room<intval($childwi);$i_room++){
                                ...
                                <div class="row c-infoRow">
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'honorofic'?>" title="Select Honorific" data-toggle="tooltip">
                                                <option value="Mr.">Mr.</option>
                                                <option value="Mrs.">Mrs.</option>
                                                <option value="Ms.">Ms.</option>
                                                <option value="Dr.">Dr.</option>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*First Name" name ="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'fname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'fname'?>" title="Enter First Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Last Name" name="<?='p'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'lname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'lname'?>" title="Enter Last Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Birthdate" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'bdate'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'bdate'?>" title="Enter Birthdate" data-toggle="tooltip" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width"  id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'meal'?>" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'childwi'.'meal'?>" title="Meal Preference" data-toggle="tooltip">
                                                <option value="">Meal Preference</option>
                                                <option value="Jain Special">Jain Special</option>
                                                <option value="Veg">Veg</option>
                                                <option value="Non Veg">Non Veg</option>
                                ...
                                <script>
                                    $('#'+'g'+<?=$group_list_arr[$i]['service']['id']?>+<?=$i_room?>+'childwi'+'bdate').datetimepicker({ format:'d/m/Y', timepicker:false});
                                </script>
                                <?php
                            } ?>
                            <!-- Child Without End-->
                            <!-- Infant -->
                            <?php
                            for($i_room=0;$i_room<intval($infant);$i_room++){
                            
                                ?>
                                <div class="section">
                                <div class="title">Infant <?= ($i_room+1) ?></div>
                                ...
                                <div class="row c-infoRow">
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'honorofic'?>" title="Select Honorific" data-toggle="tooltip">
                                                <option value="Mr.">Mr.</option>
                                                <option value="Mrs.">Mrs.</option>
                                                <option value="Ms.">Ms.</option>
                                                <option value="Dr.">Dr.</option>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*First Name" name ="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'fname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'fname'?>" title="Enter First Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Last Name" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'lname'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'lname'?>" title="Enter Last Name" data-toggle="tooltip" onkeypress="return blockSpecialChar(event);" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="formField">
                                            <input type="text" class="infoRow_txtbox" placeholder="*Birthdate" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'bdate'?>" id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'bdate'?>" title="Enter Birthdate" data-toggle="tooltip" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                        <div class="formField">
                                            <div class="selector">
                                            <select class="full-width"  id="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'meal'?>" name="<?='g'.$group_list_arr[$i]['service']['id'].$i_room.'infant'.'meal'?>" title="Meal Preference" data-toggle="tooltip">
                                                <option value="">Meal Preference</option>
                                                <option value="Jain Special">Jain Special</option>
                                                <option value="Veg">Veg</option>
                                                <option value="Non Veg">Non Veg</option>
                                ...
                                <script>
                                $('#'+'g'+<?=$group_list_arr[$i]['service']['id']?>+<?=$i_room?>+'infant'+'bdate').datetimepicker({ format:'d/m/Y', timepicker:false});
                                </script>
                                <?php
                            } ?>
                            <!-- Infant End -->
...
$('#credit_button').click(function(e) {
    ...
    var form_valid = $("#frm_traveller_details").valid();
    if(form_valid === false){
            ...
            for(var i=0;i<cart_checkout_data.length;i++){
                ...
                if(cart_checkout_data[i]['service']['name'] == 'Group Tours'){
                    ...
                    for(var i_room=0;i_room<parseInt(adult);i_room++){
                        ...
                        var honorofic = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'adult'+'honorofic').val();
                        var fname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'adult'+'fname').val();
                        var lname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'adult'+'lname').val();
                        var birthdate = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'adult'+'bdate').val();
                        var meal = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'adult'+'meal').val();
                        ...
                        group_adult_arr.push(adult_arr1);
                    }
                    // Child with bed
                    var group_cwb_arr = [];
                    for(var i_room=0;i_room<parseInt(childwi);i_room++){

                        var honorofic = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwi'+'honorofic').val();
                        var fname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwi'+'fname').val();
                        var lname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwi'+'lname').val();
                        var birthdate = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwi'+'bdate').val();
                        var meal = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwi'+'meal').val();
                        ...
                        group_cwb_arr.push(cwb_arr1);
                    }
                    // Child without bed
                    var group_cwob_arr = [];
                    for(var i_room=0;i_room<parseInt(childwo);i_room++){

                        var honorofic = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwo'+'honorofic').val();
                        var fname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwo'+'fname').val();
                        var lname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwo'+'lname').val();
                        var birthdate = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwo'+'bdate').val();
                        var meal = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'childwo'+'meal').val();
                        ...
                        group_cwob_arr.push(cwb_arr1);
                    }
                    // Infant
                    var group_infant_arr = [];
                    for(var i_room=0;i_room<parseInt(infant);i_room++){

                        var honorofic = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'infant'+'honorofic').val();
                        var fname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'infant'+'fname').val();
                        var lname = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'infant'+'lname').val();
                        var birthdate = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'infant'+'bdate').val();
                        var meal = $("#"+'g'+cart_checkout_data[i]['service']['id']+i_room+'infant'+'meal').val();
                        ...
                        group_infant_arr.push(cwb_arr1);
                    }
                    hotel_arr.push({
                        service :{
                            name:'Group Tours',
                            id:cart_checkout_data[i]['service']['id'],
                            adults : group_adult_arr,
                            cwb : group_cwb_arr,
                            cwob : group_cwob_arr,
                            infant : group_infant_arr
                        }
                    });
                }
        ...
        for(var i=0;i<cart_checkout_data.length;i++){
            ...
            if(cart_checkout_data[i]['service']['name'] == 'Ferry'){
                ...
                for(var i_room=0;i_room<parseInt(adult);i_room++){
                    ...
                    if(fname == ''){ 
                        $('#payment_button').prop('disabled',false);return false; }
                    if(lname == ''){ 
                        $('#payment_button').prop('disabled',false);return false; }
                    if(birthdate == ''){ 
                        $('#payment_button').prop('disabled',false);return false; }

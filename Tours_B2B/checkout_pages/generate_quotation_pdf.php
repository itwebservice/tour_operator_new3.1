...
$sq_query = mysqli_fetch_assoc(mysqlQuery("select markup_in,markup_amount,tax_in,tax_amount from b2b_registration where register_id='$register_id'"));
?>
        ...
        <input type="hidden" id="timing_slots" value='<?= json_encode($timing_slots) ?>'/>
            <div class="c-travellerDtls container-iPad">
                ...
                <div class="row c-infoRow">
                    ...
                    <div class="col-md-4 col-sm-6 for-iPad">
                        <div class="form-group">
                            <input type="number" class="infoRow_txtbox" value="<?= $sq_query['markup_amount'] ?>" placeholder="*Markup Amount" id="markup_amount" name="markup_amount" title="Enter Markup Amount" data-toggle="tooltip" required />
                        </div>
                    </div>
                </div>
                <div class="row c-infoRow">
                    ...
                    <div class="col-md-4 col-sm-6 for-iPad">
                        <div class="form-group">
                            <input type="number" class="infoRow_txtbox" placeholder="*Tax Amount" value="<?= $sq_query['tax_amount'] ?>" id="tax_amount" name="tax_amount" title="Enter Tax Amount" data-toggle="tooltip" required />
                        </div>
                    </div>
                </div>
                <div class='text-center loadMoreContainer' id="payment_div">
                    <button id="gpdf" title="Generate PDF" data-toggle="tooltip" class="loadBtn" value="pdf">Generate Quotation</button>
                </div>

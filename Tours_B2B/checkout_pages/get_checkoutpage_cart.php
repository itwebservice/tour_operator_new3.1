...
$grand_total = 0;
$hotel_total = 0;$trans_total = 0; $activity_total = 0; $tours_total = 0; $ferry_total = 0;
?>
      <!-- ********** Component :: Listing  ********** -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-sm-12">
                ...
                <!-- ***** Hotel Listing ***** -->
                  ...
                  <div class="cartBody">
                    ...
                    for($i=0;$i<sizeof($hotel_list_arr);$i++){
                      ...
                      <!-- **** Shopping Cart Item End****  -->
                      <?php
                      $coupon_arr = isset($hotel_list_arr[$i]['service']['hotel_arr']['coupon_info_arr'])?$hotel_list_arr[$i]['service']['hotel_arr']['coupon_info_arr']:[];
              ...
              <?php if(sizeof($group_list_arr)>0){ ?>
                <!-- **** Transfer Listing **** -->
                <div class="c-cartContainer m20-btm">
                    <div class="cartHeading">Group Tour Details</div>
                    <div class="cartBody">
                      <?php
                      $gtours_basic_tottal = 0;
                      $gtours_tax_total = 0;
                      $gtours_total = 0;
                      for($i=0;$i<sizeof($group_list_arr);$i++){
                        $tax_amount = 0;
                        //Transfer costing
                        $taxation_arr = explode(',',$group_list_arr[$i]['service']['service_arr'][0]['taxation']);
                        ...
                        $gtours_basic_tottal += $room_cost1;
                        $gtours_tax_total += $tax_amount1;
                      ...
                      <div class="cartItem">
                        <div class="row">
                          ...
                          <div class="col-3">
                            <div class="cartImage">
                            <img src="<?= $group_list_arr[$i]['service']['service_arr'][0]['image'] ?>" alt="iTours" />
                            </div>
                          </div>
                          <!-- **** Cart Image End **** -->
                          ...
                          <div class="col-9 p0-left">
                            <div class="cartInfo">
                              <!-- **** Cart Header **** -->
                              <div class="cartHeader">
                                <span class="itemTitle"><?= $group_list_arr[$i]['service']['service_arr'][0]['tour_name'] ?></span>
                                <button class="deleteHotel" onclick="remove_item('<?= $group_list_arr[$i]['service']['uuid'] ?>')"></button>
                              
                                <div class="infoSection">
                                <span class="cardInfoLine cust">
                                <i class="icon it itours-calendar"></i>
                                Travel Date: 
                                <strong><?= $tour_group[1] ?></strong>
                                </span>
                                <span class="cardInfoLine cust">
                                <i class="icon it itours-person"></i>
                                Passengers: 
                                <strong><?= intval($group_list_arr[$i]['service']['service_arr'][0]['adult'])+intval($group_list_arr[$i]['service']['service_arr'][0]['childwo'])+intval($group_list_arr[$i]['service']['service_arr'][0]['childwi'])+intval($group_list_arr[$i]['service']['service_arr'][0]['infant'])+intval($group_list_arr[$i]['service']['service_arr'][0]['extra_bed']) ?></strong>
                                </span>
                                </div>
            ...
            <div class="col-md-4 col-sm-12">
              <div class="c-cartContainer cartPricing">
                ...
                <!-- **** Pricing Block **** -->
                <div class="sBlock">
                  <span class="sBlock_title">Group Tours</span>
                  <div class="row sBlock_price">
                    <div class="col-4">
                      <span class="pLabel">Price: </span>
                    </div>
                    <div class="col-8">
                      <span class="pLabel cost"><span class='currency-icon'></span><span class='checkouttsubtotal-currency-price'><?= $gtours_basic_tottal ?></span></span>
                    </div>
                  </div>
                  <div class="row sBlock_price">
                    <div class="col-4">
                    ...
                    <div class="col-8">
                      <span class="pLabel cost"><span class='currency-icon'></span><span class='checkoutttaxtotal-currency-price'><?= $gtours_tax_total ?></span></span>
                    </div>
                  </div>
                  <div class="row sBlock_price cDivider">
                    <div class="col-4">
                    ...
                    <div class="col-8">
                      <span class="pLabel cost colWhite"><span class='currency-icon'></span>
                      <span class='checkouttotal-currency-price'><?= $gtours_total ?></span></span>
                    </div>
                  </div>
                </div>
                <!-- **** Pricing Block End **** -->
                ...
                $grand_total += $hotel_total + $trans_total + $activity_total + $tours_total + $ferry_total + $gtours_total;
                ?>
                <!-- **** Pricing Block **** -->

        ...
        <form id="address_info">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="formField">
                <label>Country</label>
                <select class="form-control txtBox" id='country' title='Country' name='country' style='width:100%;' required disabled>
                  <?php
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="formField">
                ...
                <input type="text" class="txtBox" placeholder="Bank Account Type" id="b_acc_name"

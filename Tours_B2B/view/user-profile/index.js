...
$('#create_user').validate({
    rules:{
        ...
        u_email_id : {required:true},
        u_username : {required:true},
        urepassword : {required:true},
        u_mobile_no : {required:true}
    },
    submitHandler:function(form){
        ...
        var email_id = $('#u_email_id').val();
        var username = $('#u_username').val();
        var password = $('#upassword').val();
        var repassword = $('#urepassword').val();
        var mobile_no = $('#u_mobile_no').val();

        if(password !== repassword){
            error_msg_alert('Password do not match!');
...
$('#create_markup').validate({
    rules:{
        markup_in : {required:true},
        markup_amount : {required:true},
        tax_in : {required:true},

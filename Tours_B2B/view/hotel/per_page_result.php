...
$hotel_results_array = isset($_POST['data']) ?$_POST['data']:[];
...
?>
    ...
    aria-controls="collapseExample">
        ...
        <?php if(isset($hotel_results_array[$hotel_i]['hotel_type'])){?>
        ...
        <div class="dividerSection type-1 noborder">
            ...
            <div class="infoSection">
                <?php if(isset($hotel_results_array[$hotel_i]['hotel_address'])){?>
            ...
            <div class="c-tagSection">
                <?php if(isset($hotel_results_array[$hotel_i]['meal_plan'])){ ?>
            ...
            <div class="c-aminityListBlock">
                <ul>
                <?php if(isset($hotel_results_array[$hotel_i]['amenity'][0])){ ?>
                <script>
                ...
                <?php } if(isset($hotel_results_array[$hotel_i]['amenity'][1])){ ?>
                <script>
                ...
                <?php } if(isset($hotel_results_array[$hotel_i]['amenity'][2])){ ?>
                <script>
                ...
                <?php } ?>
                <?php
                $hotel_amenity = (isset($hotel_results_array[$hotel_i]['amenity']))?$hotel_results_array[$hotel_i]['amenity']:[];
    ...
    <div class="collapse" id="collapseExample<?=$hotel_results_array[$hotel_i]['hotel_id'] ?>">
        ...
        <div class="c-compTabs">
            ...
            >
                ...
                <!-- **** Amenities **** -->
                <?php
                $hotel_ame = (isset($hotel_results_array[$hotel_i]['amenity']))?$hotel_results_array[$hotel_i]['amenity']:[];

...
$star_category_arr = isset($hotel_array[0]->star_category_arr) ? $hotel_array[0]->star_category_arr : [];
          ...
          <div class="clearfix">
            ...
            <div class="sortSection">
              <span class="sortTitle st-search">
                ...
                <?php echo $adults_count;
                echo ($adults_count <= '1') ? ' Adult' : ' Adults'; ?>, <?php echo $child_count;
                                                                                                  echo ($child_count <= '1') ? ' Child' : ' Children'; ?>
              </span>
            </div>
...
<script>
  ...
  function get_price_filter_data_result(final_arr) {
    var base_url = $('#base_url').val();
    $.post(base_url + 'Tours_B2B/view/hotel/hotel_results.php', {
      final_arr: final_arr
    }, function(data) {

...
if (sizeof($visa_results_array) > 0) {
    ...
    for ($visa_i = 0; $visa_i < sizeof($visa_results_array); $visa_i++) {
        ...
        $pax = $visa_results_array[$visa_i]['pax'];
        $agent_flag = $visa_results_array[$visa_i]['agent_flag'];
        $user_id = $visa_results_array[$visa_i]['user_id'];
?>
<!-- ***** Visa Card ***** -->
<div class="c-cardList type-hotel">
    <div class="c-cardListTable" role="button" data-toggle="collapse"
        ...
        <div class="cardList-info" role="button">
            ...
            <div class="dividerSection type-1 noborder">
                <div class="divider s1">
                    <h4 class="cardTitle" id='country_name-<?= $visa_results_array[$visa_i]['country_id'] ?>'><?php echo $visa_results_array[$visa_i]['country_name']; ?></h4>
            ...
            <div class="c-compTabs">
                ...
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="c-cardListTable type-2" role="button">
                                ...
                                <label class="cardList-info"
                                    ...
                                    <div class="flexGrid">
                                        ...
                                        <div class="gridItem">
                                            <div class="infoCard">
                                                <span class="infoCard_data"><?php echo $visa_types[$v]['visa_type']; ?></span>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="type<?= $visa_results_array[$visa_i]['country_id'] . $v ?>"
                        ...
                        <h3 class="c-heading">
                            Form-5
                            <a href="<?php echo $newUrl; ?>" download title="Download Form-5"><i class="fa fa-file-text"></i></a>
                        </h3>
                        <?php } ?>
                        <!-- **** all End **** -->
                    </div>
                ...
                <div class="clearfix text-right">
                    <button type="button" class="c-button md" id='<?= $visa_results_array[$visa_i]['country_id'] ?>'
                        onclick='enq_to_action_page(<?= $pax ?>,this.id,<?= $agent_flag ?>,<?= $user_id ?>)'><i

...
if(sizeof($transfer_results_array)>0){
    for($transfer_i=0;$transfer_i<sizeof($transfer_results_array);$transfer_i++){
        ...
        $service_duration = $transfer_results_array[$transfer_i]['service_duration'];
        $row = mysqli_fetch_assoc(mysqlQuery("select duration from service_duration_master where entry_id='$service_duration'"));
?>
<!-- ***** Car Card ***** -->
    ...
    <div class="cardList-info">
        ...
        <div class="divider s1">
            ...
            <span class="cardInfoLine cust">
                ...
                Service Duration: <strong id="service_duration"><?= $row['duration'] ?></strong>
            </span>
            </div>
